...
const ContentWrapper = class {
    ...
    render() {
        const contentWrapperClasses = index$1.cx(index$1.prefix('content-wrapper'), index$1.prefix(`content-wrapper--${this.width}`));
        return (index.h("div", { class: contentWrapperClasses }, index.h("slot", null)));
    }
};
