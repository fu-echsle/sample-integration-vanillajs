export declare const getElementMap: (element: HTMLElement) => Map<any, any>;
export declare const getNodeToPrependTo: (rootNode: Document | HTMLElement) => HTMLElement;
/**
 ...
 * @returns void
 */
export declare const insertSlottedStyles: (element: HTMLElement, css: string) => void;
