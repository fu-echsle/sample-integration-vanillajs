            ...
            paginationModel.forEach((pageModel) => {
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    ...
                    return (prevItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }),
                        h("span", { class: paginationPrevClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: () => {
                                this.onClick(pageModel.value);
                            }, onKeyDown: (e) => {
                                this.onKeyDown(e, pageModel.value);
                            }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": this.allyLabelPrev },
                ...
                if (pageModel.type === itemTypes.PAGE) {
                    ...
                    pageItems.push(h("li", Object.assign({}, pageModel, { class: paginationItemClasses }),
                        h("span", { class: paginationGoToClasses, role: 'button', tabIndex: pageModel.isActive ? null : 0, "aria-disabled": pageModel.isActive && 'true', onClick: () => {
                                this.onClick(pageModel.value);
                            }, onKeyDown: (e) => {
                                this.onKeyDown(e, pageModel.value);
                ...
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    ...
                    return (nextItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }),
                        h("span", { class: paginationNextClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: () => {
                                this.onClick(pageModel.value);
                            }, onKeyDown: (e) => {
                                this.onKeyDown(e, pageModel.value);
                            }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": this.allyLabelNext },
