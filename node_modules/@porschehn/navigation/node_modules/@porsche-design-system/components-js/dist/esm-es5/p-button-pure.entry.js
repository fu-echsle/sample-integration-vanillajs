...
import { t as transitionListener, c as cx, p as prefix, m as mapBreakpointPropToPrefixedClasses, a as calcLineHeightForElement } from './index-4c11fe51.js';
...
var ButtonPure = /** @class */ (function () {
    ...
    ButtonPure.prototype.render = function () {
        ...
        return (h("button", { class: buttonPureClasses, type: this.type, disabled: this.isDisabled(), tabindex: this.tabbable ? 0 : -1, ref: function (el) { return _this.buttonTag = el; }, "aria-busy": this.loading && 'true' }, this.loading ? (h("p-spinner", { class: iconClasses, size: 'inherit', theme: this.theme, ref: function (el) { return _this.iconTag = el; } })) : (h("p-icon", { class: iconClasses, color: 'inherit', size: 'inherit', name: this.icon, source: this.iconSource, ref: function (el) { return _this.iconTag = el; }, "aria-hidden": 'true' })), h("p-text", { class: labelClasses, tag: 'span', color: 'inherit', size: 'inherit', weight: this.weight }, h("slot", null))));
    };
