...
var Link = /** @class */ (function () {
    ...
    Link.prototype.render = function () {
        ...
        var linkClasses = cx(prefix('link'), prefix("link--" + this.variant), mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']), prefix("link--theme-" + this.theme));
        var iconClasses = prefix('link__icon');
        var labelClasses = prefix('link__label');
        return (h(TagType, Object.assign({ class: linkClasses }, (TagType === 'a' ? {
            href: this.href,
            target: "" + this.target,
            download: this.download,
            rel: this.rel
        } : null)), h("p-icon", { class: iconClasses, size: 'inherit', name: this.icon, source: this.iconSource, color: 'inherit', "aria-hidden": 'true' }), h("p-text", { tag: 'span', color: 'inherit', class: labelClasses }, h("slot", null))));
    };
