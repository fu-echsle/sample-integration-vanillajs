...
var Button = /** @class */ (function () {
    ...
    Button.prototype.componentDidLoad = function () {
        ...
        improveButtonHandlingForCustomElement(this.element, function () { return _this.type; }, function () { return _this.isDisabled(); });
    };
    Button.prototype.render = function () {
        var buttonClasses = cx(prefix('button'), prefix("button--" + this.variant), mapBreakpointPropToPrefixedClasses('button-', this.hideLabel, ['without-label', 'with-label']), prefix("button--theme-" + this.theme));
        var iconClasses = prefix('button__icon');
        var labelClasses = prefix('button__label');
