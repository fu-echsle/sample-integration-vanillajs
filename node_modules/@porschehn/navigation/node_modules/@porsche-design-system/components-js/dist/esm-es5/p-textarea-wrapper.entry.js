import { r as registerInstance, h, H as Host, g as getElement } from './index-1d2895d7.js';
import { r as randomString, c as cx, p as prefix, m as mapBreakpointPropToPrefixedClasses, t as transitionListener, i as insertSlottedStyles } from './index-4c11fe51.js';
...
var TextareaWrapper = /** @class */ (function () {
    ...
    TextareaWrapper.prototype.render = function () {
        var _this = this;
        var labelClasses = cx(prefix('textarea-wrapper__label'));
        var labelTextClasses = cx(prefix('textarea-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__label-text--disabled'));
        var fakeTextareaClasses = cx(prefix('textarea-wrapper__fake-textarea'), prefix("textarea-wrapper__fake-textarea--" + this.state), this.disabled && prefix('textarea-wrapper__fake-textarea--disabled'), this.readonly && prefix('textarea-wrapper__fake-textarea--readonly'));
        var messageClasses = cx(prefix('textarea-wrapper__message'), prefix("textarea-wrapper__message--" + this.state));
        return (h(Host, null, h("label", { class: labelClasses, id: this.state === 'error' && this.labelId }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, color: 'inherit', tag: 'span', onClick: function () { return _this.labelClick(); } }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), h("span", { class: fakeTextareaClasses }, h("slot", null))), this.isMessageVisible &&
    ...
    TextareaWrapper.prototype.setState = function () {
        this.disabled = this.textarea.disabled;
        this.readonly = this.textarea.readOnly;
    };
    TextareaWrapper.prototype.labelClick = function () {
        this.textarea.focus();
    };
    TextareaWrapper.prototype.bindStateListener = function () {
        var _this = this;
        transitionListener(this.textarea, 'border-top-color', function () {
            _this.setState();
        });
    };
...
export { TextareaWrapper as p_textarea_wrapper };
