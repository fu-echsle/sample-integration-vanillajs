...
export const createPaginationModel = (options) => {
    // exception tests
    if (options == null) {
...
export const getCurrentActivePage = (activePage, totalPages) => {
    // exception tests
...
export const getTotalPages = (totalItemsCount, itemsPerPage) => {
    // exception test
