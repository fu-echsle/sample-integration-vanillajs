...
const TextFieldWrapper = class {
    ...
    render() {
        ...
        return (h(Host, null, h("span", { class: containerClasses }, h("label", { class: labelClasses, id: this.state === 'error' && this.labelId }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: () => this.labelClick() }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), h("span", { class: fakeInputClasses }, h("slot", null))), this.isPasswordToggleable &&
            h("button", { type: 'button', class: buttonClasses, onClick: () => this.togglePassword(), disabled: this.disabled }, h("p-icon", { name: this.showPassword ? 'view-off' : 'view', color: 'inherit' }))), this.isMessageVisible &&
