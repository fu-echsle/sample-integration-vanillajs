...
const ButtonPure = class {
    ...
    render() {
        ...
        return (h("button", { class: buttonPureClasses, type: this.type, disabled: this.isDisabled(), tabindex: this.tabbable ? 0 : -1, ref: el => this.buttonTag = el, "aria-busy": this.loading && 'true' }, this.loading ? (h("p-spinner", { class: iconClasses, size: 'inherit', theme: this.theme, ref: el => this.iconTag = el })) : (h("p-icon", { class: iconClasses, color: 'inherit', size: 'inherit', name: this.icon, source: this.iconSource, ref: el => this.iconTag = el, "aria-hidden": 'true' })), h("p-text", { class: labelClasses, tag: 'span', color: 'inherit', size: 'inherit', weight: this.weight }, h("slot", null))));
    }
    isDisabled() {
