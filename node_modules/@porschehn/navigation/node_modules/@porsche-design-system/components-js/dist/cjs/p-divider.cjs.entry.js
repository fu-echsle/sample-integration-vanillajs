...
const Divider = class {
    ...
    render() {
        const dividerClasses = index$1.cx(index$1.prefix('divider'), index$1.prefix(`divider--color-${this.color}`), index$1.prefix(`divider--theme-${this.theme}`), index$1.mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
        return (index.h("hr", { class: dividerClasses }));
    }
};
