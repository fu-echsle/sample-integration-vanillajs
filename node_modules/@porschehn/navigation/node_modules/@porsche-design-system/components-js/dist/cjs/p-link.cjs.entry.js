...
const Link = class {
    ...
    render() {
        ...
        const linkClasses = index$1.cx(index$1.prefix('link'), index$1.prefix(`link--${this.variant}`), index$1.mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']), index$1.prefix(`link--theme-${this.theme}`));
        const iconClasses = index$1.prefix('link__icon');
        const labelClasses = index$1.prefix('link__label');
        return (index.h(TagType, Object.assign({ class: linkClasses }, (TagType === 'a' ? {
            href: this.href,
            target: `${this.target}`,
            download: this.download,
            rel: this.rel
        } : null)), index.h("p-icon", { class: iconClasses, size: 'inherit', name: this.icon, source: this.iconSource, color: 'inherit', "aria-hidden": 'true' }), index.h("p-text", { tag: 'span', color: 'inherit', class: labelClasses }, index.h("slot", null))));
    }
