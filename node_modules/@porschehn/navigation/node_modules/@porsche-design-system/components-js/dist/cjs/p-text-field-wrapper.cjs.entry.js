...
const TextFieldWrapper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("span", { class: containerClasses }, index.h("label", { class: labelClasses, id: this.state === 'error' && this.labelId }, this.isLabelVisible &&
            index.h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: () => this.labelClick() }, this.label ? this.label : index.h("span", null, index.h("slot", { name: 'label' }))), index.h("span", { class: fakeInputClasses }, index.h("slot", null))), this.isPasswordToggleable &&
            index.h("button", { type: 'button', class: buttonClasses, onClick: () => this.togglePassword(), disabled: this.disabled }, index.h("p-icon", { name: this.showPassword ? 'view-off' : 'view', color: 'inherit' }))), this.isMessageVisible &&
