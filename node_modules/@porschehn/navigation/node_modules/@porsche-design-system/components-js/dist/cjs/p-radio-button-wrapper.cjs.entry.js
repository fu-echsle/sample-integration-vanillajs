...
const RadioButtonWrapper = class {
    ...
    render() {
        const labelClasses = index$1.cx(index$1.prefix('radio-button-wrapper__label'));
        const fakeRadioButtonClasses = index$1.cx(index$1.prefix('radio-button-wrapper__fake-radio-button'), this.checked && index$1.prefix(`radio-button-wrapper__fake-radio-button--checked`), this.disabled && index$1.prefix(`radio-button-wrapper__fake-radio-button--disabled`), this.state !== 'none' && index$1.prefix(`radio-button-wrapper__fake-radio-button--${this.state}`));
        const labelTextClasses = index$1.cx(index$1.prefix('radio-button-wrapper__label-text'), index$1.mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index$1.prefix('radio-button-wrapper__label-text--disabled'));
        const messageClasses = index$1.cx(index$1.prefix('radio-button-wrapper__message'), this.state !== 'none' && index$1.prefix(`radio-button-wrapper__message--${this.state}`));
        return (index.h(index.Host, null, index.h("label", { class: labelClasses, id: this.state === 'error' && this.labelId }, this.isLabelVisible &&
            index.h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: (e) => this.labelClick(e) }, this.label ? this.label : index.h("span", null, index.h("slot", { name: 'label' }))), index.h("span", { class: fakeRadioButtonClasses }, index.h("slot", null))), this.isMessageVisible &&
