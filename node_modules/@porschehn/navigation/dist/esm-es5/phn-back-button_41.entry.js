...
var DEFAULT_ACCESSIBILITY_STATEMENT = null;
var DEFAULT_FURTHER_LINKS = null;
...
var FEATURE_NEW_LEVEL2 = 'homenav_1297_newLevel2';
var FEATURE_ACCESSIBILITY_STATEMENT = 'homenav_1312_accessibilityStatement';
var MAX_M_VIEWPORT_WIDTH = 1299;
var FOCUSABLE_ELEMENTS_SELECTOR = 'a, button, [tabindex]:not([tabindex="-1"]), phn-p-link-pure, phn-p-button-pure, phn-p-link';
...
var carFrontshotCss = ".frontshot.sc-phn-car-frontshot{width:100%}@media (min-width: 1300px) and (max-width: 1759px){.frontshot.sc-phn-car-frontshot{padding-bottom:1.5625rem}}";
var CarFrontshot = /** @class */ (function () {
    function CarFrontshot(hostRef) {
        registerInstance(this, hostRef);
    }
    CarFrontshot.prototype.render = function () {
        var path = getAssetPath(config(navContentStore.get('env')).ASSETS_URL + "/frontshot-assets");
    ...
    Object.defineProperty(CarFrontshot, "assetsDirs", {
        get: function () { return ["frontshot-assets"]; },
        enumerable: false,
        configurable: true
    });
    return CarFrontshot;
...
var carFurtherLinksCss = "@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center}}.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{border-bottom:1px solid #e3e4e5;margin-bottom:3.75rem}@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{border-top:1px solid #e3e4e5;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;margin-bottom:unset}}.car-further-links-item.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;font-weight:normal;-ms-flex-align:center;align-items:center;border-top:1px solid #e3e4e5;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:1rem;padding:15px 0}.car-further-links-item.sc-phn-car-further-links:first-child{border-top:0}@media (min-width: 760px) and (max-width: 999px){.car-further-links-item.sc-phn-car-further-links{font-size:1.125rem;padding:18px 0}}@media (min-width: 1300px){.car-further-links-item.sc-phn-car-further-links{height:1.5rem;padding:0.875rem 0.625rem;border-top:0;-webkit-box-sizing:unset;box-sizing:unset}.car-further-links-item.sc-phn-car-further-links:first-child{margin-right:0.25rem}}";
var CarFurtherLinks = /** @class */ (function () {
    ...
    CarFurtherLinks.prototype.renderItem = function (item) {
        var _this_1 = this;
        return (h("phn-p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(item); }, role: "button" }, item.Text));
    };
...
var carFurtherLinksV2Css = ".car-further-links.sc-phn-car-further-links-v2{border-top:1px solid #e3e4e5}@media (min-width: 1300px) and (max-width: 1759px){.car-further-links.sc-phn-car-further-links-v2{margin-bottom:-5rem}}@media (min-width: 1760px){.car-further-links.sc-phn-car-further-links-v2{margin-bottom:-6rem}}.car-further-links.sc-phn-car-further-links-v2 .limit-stretch.sc-phn-car-further-links-v2{width:calc(100vw - 7vw * 2);max-width:96rem;margin-left:auto;margin-right:auto;-webkit-box-sizing:content-box;box-sizing:content-box}@media (min-width: 1760px){.car-further-links.sc-phn-car-further-links-v2 .limit-stretch.sc-phn-car-further-links-v2{width:calc(100vw - 10vw * 2)}}@media (min-width: 1000px){.car-further-links.sc-phn-car-further-links-v2 .limit-stretch.sc-phn-car-further-links-v2{padding-left:calc(100vw - 100%)}}.car-further-links.sc-phn-car-further-links-v2 .car-further-links-item.sc-phn-car-further-links-v2{padding:1.125rem 0 1.125rem 0.8125rem;display:-ms-flexbox;display:flex}";
var CarFurtherLinksV2 = /** @class */ (function () {
    function CarFurtherLinksV2(hostRef) {
        registerInstance(this, hostRef);
    ...
    CarFurtherLinksV2.prototype.resizeHandler = function () {
        this.isDesktop = isDesktop();
    };
    CarFurtherLinksV2.prototype.componentWillLoad = function () {
        this.isDesktop = isDesktop();
    };
    CarFurtherLinksV2.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "car-further-links" }, h("div", { class: this.isDesktop ? 'limit-stretch' : '' }, h("phn-p-grid", { direction: "row-reverse" }, h("phn-p-grid-item", { size: "{base: 12, l:3}" }, h("phn-p-link-pure", { href: this.furtherLinks.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(_this_1.furtherLinks); } }, this.furtherLinks.Text))))));
    };
    return CarFurtherLinksV2;
}());
...
var CarMetaFunctionalities = /** @class */ (function () {
    ...
    CarMetaFunctionalities.prototype.renderItem = function (source, contentItem, analyticsEvent) {
        return (h("phn-p-link-pure", { href: contentItem.Link, icon: source, size: "inherit", onClick: function () { return analyticsEvent(contentItem); }, class: "car-meta-functionalities-item" }, contentItem.Text));
    };
    CarMetaFunctionalities.prototype.render = function () {
        var _this_1 = this;
        return isFeatureEnabled(FEATURE_MODEL_META) ? (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map(function (item) { return (h("phn-p-link-pure", { href: item.Link, icon: item.Icon, onClick: function () { return _this_1.sendModelMetaFunctionAnalyticsEvent(item); }, size: "inherit", class: "car-meta-functionalities-item" }, item.Text)); })))) : (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    };
    return CarMetaFunctionalities;
}());
CarMetaFunctionalities.style = carMetaFunctionalitiesCss;
var carMetaFunctionalitiesV2Css = "@media (min-width: 1300px){.car-meta-functionalities.sc-phn-car-meta-functionalities-v2{padding-top:3.5rem}}@media (min-width: 1760px){.car-meta-functionalities.sc-phn-car-meta-functionalities-v2{padding-top:5rem}}@media (min-width: 1760px){.car-meta-functionalities.sc-phn-car-meta-functionalities-v2{padding-top:5rem}}.car-meta-functionalities.sc-phn-car-meta-functionalities-v2 .car-meta-functionalities-wrapper.sc-phn-car-meta-functionalities-v2{border-top:1px solid #e3e4e5}@media (min-width: 0) and (max-width: 1299px){.car-meta-functionalities.sc-phn-car-meta-functionalities-v2 .car-meta-functionalities-wrapper.sc-phn-car-meta-functionalities-v2{border:0}}@media (min-width: 1300px){.car-meta-functionalities.sc-phn-car-meta-functionalities-v2 .car-meta-functionalities-wrapper.sc-phn-car-meta-functionalities-v2{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-pack:left;justify-content:left}}.car-meta-functionalities-item.sc-phn-car-meta-functionalities-v2{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;border-bottom:1px solid #e3e4e5;padding:0.9375rem 0 0.9375rem 0;font-size:1rem}@media (min-width: 760px) and (max-width: 1299px){.car-meta-functionalities-item.sc-phn-car-meta-functionalities-v2{width:100%;font-size:1.125rem;padding:1.125rem 0 1.125rem 0}}@media (min-width: 0) and (max-width: 1299px){.car-meta-functionalities-item.sc-phn-car-meta-functionalities-v2{padding-left:0.75rem;-webkit-box-sizing:border-box;box-sizing:border-box}}";
var CarMetaFunctionalitiesV2 = /** @class */ (function () {
    function CarMetaFunctionalitiesV2(hostRef) {
        var _this_1 = this;
        registerInstance(this, hostRef);
        this.items = [
            { PhraseId: '', Text: '', Link: '' },
...
var CarModelListV2 = /** @class */ (function () {
    ...
    CarModelListV2.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "car-model-list" }, this.series.Models.map(function (model) { return (h("phn-p-link", { variant: "tertiary", href: model.Link, icon: 'arrow-head-right', size: "inherit", class: "car-model-list-item", onClick: function () { return _this_1.sendModelClickAnalyticsEvent(model); } }, model.Name)); })));
    };
    return CarModelListV2;
}());
CarModelListV2.style = carModelListV2Css;
/* istanbul ignore file */
var getSrcPath = function (image) {
    var path = getAssetPath(config(navContentStore.get('env')).ASSETS_URL + "/series-assets");
    var imageFileEnding = 'jpg';
...
var carSeriesModelOverviewV2Css = ".series-headline.sc-phn-car-series-model-overview-v2{border-bottom:1px solid #0e1418}@media (min-width: 0) and (max-width: 759px){.series-headline.sc-phn-car-series-model-overview-v2{padding-bottom:0.5625rem}}@media (min-width: 760px) and (max-width: 999px){.series-headline.sc-phn-car-series-model-overview-v2{padding-bottom:0.8125rem}}@media (min-width: 1000px) and (max-width: 1299px){.series-headline.sc-phn-car-series-model-overview-v2{padding-bottom:0.875rem}}.limit-stretch.sc-phn-car-series-model-overview-v2{width:calc(100vw - 7vw * 2);max-width:96rem;margin-left:auto;margin-right:auto;-webkit-box-sizing:content-box;box-sizing:content-box}@media (min-width: 1760px){.limit-stretch.sc-phn-car-series-model-overview-v2{width:calc(100vw - 10vw * 2)}}@media (min-width: 1000px){.limit-stretch.sc-phn-car-series-model-overview-v2{padding-left:calc(100vw - 100%)}}";
var CarSeriesModelOverviewV2 = /** @class */ (function () {
    function CarSeriesModelOverviewV2(hostRef) {
        registerInstance(this, hostRef);
        this.isMobile = true;
        this.series = EMPTY_SERIES;
    }
    CarSeriesModelOverviewV2.prototype.resizeHandler = function () {
        this.isDesktop = isDesktop();
    };
    CarSeriesModelOverviewV2.prototype.triggerDesktopAnalyticsEvent = function (event) {
        if (event.detail.includes(this.series.Name)) {
            ...
            var analyticsEvent = new ModelRangeOverlayLoadEvent(analyticsSetup, this.series.Name, this.series);
            pagData.push(analyticsEvent.event());
        }
    };
    CarSeriesModelOverviewV2.prototype.componentWillLoad = function () {
        this.isDesktop = isDesktop();
    };
    CarSeriesModelOverviewV2.prototype.render = function () {
    ...
    return CarSeriesModelOverviewV2;
}());
...
var Crest = /** @class */ (function () {
    ...
    Crest.prototype.render = function () {
        var _this_1 = this;
        var hiddenStyle = { display: 'none' };
        return (h(Host, null, h("a", { class: "crest", style: this.contentLoaded() ? {} : hiddenStyle, onClick: function () { return _this_1.sendCrestClickAnalyticsEvent(); }, href: this.getCrestLink() }, h("phn-p-marque", { class: "marque" })), h("div", { class: "marque-bone", style: this.contentLoaded() ? hiddenStyle : {} }, h("span", { class: "crest-bone" }), h("span", { class: "label-bone" }))));
    };
...
var DealerSearch = /** @class */ (function () {
    ...
    DealerSearch.prototype.render = function () {
        var _this_1 = this;
        var hiddenStyle = { display: 'none' };
        return (h(Host, { class: "dealer-search" }, h("phn-p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, href: this.dealerSearchLink, size: "inherit", icon: "pin", class: 'dealer-search-link', onClick: function () {
                var linkItem = {
    ...
    DrawerShopsAndMore.prototype.render = function () {
        ...
        return (h("div", { class: "drawer-shops-and-more" }, h("div", { class: "drawer-container" }, h("phn-headline", { text: this.headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map(function (item, index) {
                return (h("div", null, h("phn-list-item", { item: item, onClick: function () { return _this_1.showDrawer(item, index); }, class: 'drawer-shops-and-more-item drawer-shops-and-more-item-' + index })));
            }))));
    };
...
var Header = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.addFocus = function () {
            var skipContentElement = _this_1.el.shadowRoot.querySelector('phn-p-button.skip-content');
...
var ListItem = /** @class */ (function () {
    ...
    ListItem.prototype.renderLinkItem = function (linkItem) {
        var _this_1 = this;
        return (h(Host, null, h("div", { class: "list-item-link" }, h("a", { href: linkItem.Link, onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(linkItem); } }, linkItem.Text))));
    };
    ListItem.prototype.renderTextItem = function (textItem) {
        var _this_1 = this;
        return (h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(textItem); }, cancelTabIndex: false }, h("span", { class: "list-item-text" }, textItem.Text)));
    };
...
var MegaFlyOutOverlay = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("div", { class: "mega-fly-out-overlay" }, h("button", { class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown, onClick: this.handleClick, "aria-expanded": this.active === 'active' ? 'true' : 'false', "aria-haspopup": "true", id: this.screenReaderId }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: function (el) { return (_this_1.containerElement = el); }, onKeyDown: this.handleKeyDownContainer, "aria-labelledby": this.screenReaderId, "aria-hidden": this.active === 'active' ? 'false' : 'true', role: "region" }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: function (el) { return (_this_1.backdropElement = el); } }))));
    };
...
_numWithUnitExp = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _complexStringNumExp = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, 
...
_renderZeroDurationTween = function _renderZeroDurationTween(tween, totalTime, suppressEvents, force) {
    var prevRatio = tween.ratio, ratio = totalTime < 0 || !totalTime && (!tween._start && _parentPlayheadIsBeforeStart(tween) || (tween._ts < 0 || tween._dp._ts < 0) && tween.data !== "isFromStart" && tween.data !== "isStart") ? 0 : 1, 
...
var menuDesktopLevel1Css = ".menu-desktop-level-1.sc-phn-menu-desktop-level-1{display:-ms-flexbox;display:flex;-ms-flex:1;flex:1;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:justify;justify-content:space-between}@media (min-width: 1300px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1{padding-top:1.625rem}}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1{padding-top:1.3125rem}}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-series-shop-and-more.sc-phn-menu-desktop-level-1{display:-ms-inline-flexbox;display:inline-flex}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-separator.sc-phn-menu-desktop-level-1{width:1px;height:2.375rem;background-color:#e3e4e5;margin-top:0.875rem}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-separator.sc-phn-menu-desktop-level-1{height:3rem;margin-top:1.0625rem}}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:1.3125rem}@media (-ms-high-contrast: none) and (min-width: 1300px) and (max-width: 1759px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{-ms-flex:1;flex:1}}@media (min-width: 1300px) and (max-width: 1759px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:0}}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:1.6875rem}}";
    ...
    function MenuDesktopLevel1(hostRef) {
        ...
        this.showOverlayHandler = function (overlayElement) {
            ...
            _this_1.analyticsCaptureTimeout = setTimeout(function () {
                ...
                var megaMenuButtonActive = megaMenuSelected.querySelector('.mega-fly-out-overlay-button-active');
                if (megaMenuButtonActive !== null) {
                    ...
                    if (openOverlay !== null) {
                        ...
                        _this_1.overlayEvent.emit(megaMenuButtonActive.getAttribute('id'));
                    }
                }
            }, 500);
        ...
        this.keyboardShowOverlayHandler = function (overlayElement) {
            ...
            if (openOverlay !== null) {
                ...
                _this_1.overlayEvent.emit(megaMenuSelected.querySelector('button').getAttribute('id'));
            }
        };
...
var MenuDrawer = /** @class */ (function () {
    function MenuDrawer(hostRef) {
        ...
        this.initFirstAndLastFocusableElements = function () {
            var focusableElements = _this_1.el.querySelectorAll('button, a, phn-p-link-pure, phn-p-link,  phn-p-button-pure, [tabindex]:not([tabindex="-1"])');
    ...
    MenuDrawer.prototype.render = function () {
        ...
        return (h(Host, { class: "drawer-trigger", tabindex: "-1" }, h("div", { class: "menu-drawer" }, h("div", { class: "menu-drawer-container", onClick: this.close }, h("div", { class: "menu-drawer-content", onClick: this.stopClickEvent }, h("div", { class: "menu-drawer-content-wrapper", role: "dialog", "aria-modal": "true" }, h("span", { ref: function (el) { return (_this_1.firstKeyboardAnchor = el); }, "aria-hidden": "true", tabindex: "-1" }), h("div", { class: backAndCloseClass }, !this.isFirstDrawer && (h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), h("phn-p-button-pure", { class: "close-button", icon: "close", hideLabel: "true", "aria-label": "close dialog", size: "small", onClick: this.close }, "Close Dialog")), h("slot", { name: "content" }), h("span", { ref: function (el) { return (_this_1.lastKeyboardAnchor = el); }, "aria-hidden": "true", tabindex: "-1" })))))));
    };
...
var messagesLinkCss = ".sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:1rem;border-bottom:1px solid #e3e4e5}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link:hover{color:#d5001c;cursor:pointer}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{font-size:1.125rem}}@media (min-width: 1300px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{border-bottom:0;padding-left:0}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{text-decoration:none;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-align:center;align-items:center;width:100%;padding:0.875rem 0 0.875rem 0.625rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{padding-top:1.125rem;padding-bottom:1.125rem}}@media (min-width: 1300px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{padding-bottom:0}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link{height:1rem;margin-left:0.5rem;padding:0 0.3125rem;background-color:#d5001c;border-radius:8px;font-size:0.75rem;color:#fff;line-height:1rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link{height:1.125rem;font-size:0.875rem;line-height:1.125rem}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link:hover{color:#fff}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.hidden.sc-phn-messages-link{display:none}";
...
var MobileCarSeriesList = /** @class */ (function () {
    ...
    MobileCarSeriesList.prototype.showDrawer = function (_, series, index) {
        if (isFeatureEnabled(FEATURE_NEW_LEVEL2)) {
            var phnCarSeriesModelOverviewV2 = {
    ...
    MobileCarSeriesList.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map(function (series, index) { return (h("div", { class: "mobile-car-series", key: index }, h("button", { class: "car-series-button", onClick: function (event) { return _this_1.showDrawer(event, series, index); } }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image })))); })));
    };
...
var MobileLayout = /** @class */ (function () {
    ...
    MobileLayout.prototype.showMobileLevel1 = function () {
        var drawer = { content: h("phn-menu-mobile-level-1", { slot: "content" }) };
        navStateStore.set('drawerContentStack', [drawer]);
    };
    MobileLayout.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("phn-burger-button", { class: "burger-button", onClick: this.showMobileLevel1 }), navStateStore.get('drawerContentStack').map(function (drawer, index, array) {
            var isTopmostDrawer = array.length - 1 === index;
            return (h("phn-menu-drawer", { key: index, backButton: drawer.backButton, mobileLayout: _this_1.mobileLayoutElement, isTopmostDrawer: isTopmostDrawer ? 'true' : '' }, drawer.content));
        })));
    };
...
var mobileShopsAndMoreCss = ".sc-phn-mobile-shops-and-more-h{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-direction:column;flex-direction:column;border-top:1px solid #e3e4e5;margin-top:1.5rem}@media (min-width: 760px) and (max-width: 1299px){.sc-phn-mobile-shops-and-more-h{margin-top:3rem}}";
...
var Myporsche = /** @class */ (function () {
    ...
    Myporsche.prototype.renderLoggedOutComponent = function () {
        var _this_1 = this;
        return (h("phn-p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-logged-out", href: this.myporscheLink, onClick: function () {
                var linkItem = {
    ...
    function MyPorscheDrawer(hostRef) {
        ...
        this.openDrawer = function () {
            var phnMyporscheItemsDrawer = {
                content: h("phn-myporsche-items-drawer", { slot: "content", myPorscheText: _this_1.myPorscheText })
            };
...
var MyPorscheFlyout = /** @class */ (function () {
    ...
    MyPorscheFlyout.prototype.render = function () {
        ...
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("phn-p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, "aria-label": "open myporsche flyout" }, this.myPorscheText, h("phn-p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: function () { return _this_1.myPorscheCloseHandler(); } }))) : null));
    };
    ...
    function MyPorscheItems(hostRef) {
        ...
        this.displayListItems = function (item, index) {
            if (item.PhraseId === MYPORSCHE_PHRASE_ID + ".messages") {
                if (index === 0) {
                    return (h("li", null, h("phn-messages-link", { class: "myporsche-list-item", item: item, onKeyDown: _this_1.handlePressShiftTabKey })));
                }
                return (h("li", null, h("phn-messages-link", { class: "myporsche-list-item", item: item })));
            }
            if (index === 0) {
                return (h("li", null, h("phn-list-item", { class: "myporsche-list-item", item: item, onKeyDown: _this_1.handlePressShiftTabKey })));
            }
...
var ShopsAndMore = /** @class */ (function () {
    ...
    ShopsAndMore.prototype.render = function () {
        var _this_1 = this;
        var items = this.getItems();
        return (h("div", { class: "shops-and-more" }, items.map(function (item) {
            return (h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: _this_1.showOverlayHandler, hideOverlayHandler: _this_1.hideOverlayHandler, keyboardShowOverlayHandler: _this_1.keyboardShowOverlayHandler, keyboardHideOverlayHandler: _this_1.keyboardHideOverlayHandler }, h("phn-desktop-shop-and-more-item", { slot: "button", itemText: item.Text, class: "desktop-shop-and-more-item" }), h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    };
    return ShopsAndMore;
}());
...
var ShopsAndMoreOverview = /** @class */ (function () {
    ...
    class_4.prototype.renderLinkGroup = function (_items, _title) {
        return (h("div", { class: "link-group" }, h("phn-headline", { role: "heading", "aria-level": "2", text: _title, class: "head-line" }), h("ul", { class: "list-item-group" }, _items.map(function (linkItem) {
