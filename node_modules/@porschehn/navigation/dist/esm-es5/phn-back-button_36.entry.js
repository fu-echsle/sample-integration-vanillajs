...
var CarFurtherLinks = /** @class */ (function () {
    ...
    CarFurtherLinks.prototype.renderItem = function (item) {
        var _this_1 = this;
        return (h("p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(item); }, role: "button" }, item.Text));
    };
...
var CarMetaFunctionalities = /** @class */ (function () {
    ...
    CarMetaFunctionalities.prototype.render = function () {
        var _this_1 = this;
        return isFeatureEnabled(FEATURE_MODEL_META) ? (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map(function (item) { return (h("p-link-pure", { href: item.Link, icon: item.Icon, onClick: function () { return _this_1.sendModelMetaFunctionAnalyticsEvent(item); }, size: "inherit", class: "car-meta-functionalities-item" }, item.Text)); })))) : (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    };
...
var Crest = /** @class */ (function () {
    ...
    Crest.prototype.render = function () {
        var _this_1 = this;
        var hiddenStyle = { display: 'none' };
        return (h(Host, null, h("a", { class: "crest", style: this.contentLoaded() ? {} : hiddenStyle, onClick: function () { return _this_1.sendCrestClickAnalyticsEvent(); }, href: this.getCrestLink() }, h("p-marque", { class: "marque" })), h("div", { class: "marque-bone", style: this.contentLoaded() ? hiddenStyle : {} }, h("span", { class: "crest-bone" }), h("span", { class: "label-bone" }))));
    };
...
var DealerSearch = /** @class */ (function () {
    ...
    DealerSearch.prototype.render = function () {
        var _this_1 = this;
        var hiddenStyle = { display: 'none' };
        return (h(Host, { class: "dealer-search" }, h("p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, href: this.dealerSearchLink, size: "inherit", icon: "pin", class: 'dealer-search-link', onClick: function () {
                var linkItem = {
...
var ListItem = /** @class */ (function () {
    ...
    ListItem.prototype.renderLinkItem = function (linkItem) {
        var _this_1 = this;
        return (h(Host, null, h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: linkItem.Link, onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(linkItem); } }, linkItem.Text))));
    };
...
var Myporsche = /** @class */ (function () {
    ...
    Myporsche.prototype.renderLoggedOutComponent = function () {
        var _this_1 = this;
        return (h("p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-logged-out", href: this.myporscheLink, onClick: function () {
                var linkItem = {
...
var MyPorscheFlyout = /** @class */ (function () {
    ...
    MyPorscheFlyout.prototype.render = function () {
        ...
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button", "aria-label": "open myporsche flyout" }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: function () { return _this_1.myPorscheCloseHandler(); } }))) : null));
    };
