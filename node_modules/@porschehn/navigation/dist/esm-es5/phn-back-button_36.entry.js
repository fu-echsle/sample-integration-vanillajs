...
var MobileLayout = /** @class */ (function () {
    ...
    MobileLayout.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("phn-burger-button", { class: "burger-button", onClick: this.showMobileLevel1 }), navStateStore.get('drawerContentStack').map(function (drawer, index) {
            return (h("phn-menu-drawer", { key: index, backButton: drawer.backButton, mobileLayout: _this_1.mobileLayoutElement }, drawer.content));
        })));
    };
...
var MyPorscheFlyout = /** @class */ (function () {
    ...
    MyPorscheFlyout.prototype.render = function () {
        ...
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button" }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: function () { return _this_1.myPorscheCloseHandler(); } }))) : null));
    };
