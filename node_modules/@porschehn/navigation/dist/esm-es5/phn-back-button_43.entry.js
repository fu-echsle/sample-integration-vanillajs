...
var AnalyticsEvent = /** @class */ (function () {
    ...
    AnalyticsEvent.prototype.initContext = function () {
        var _a;
        this.context = (_a = {},
            _a[ContextCollectionDimensions.ApplicationId] = undefined,
            _a[ContextCollectionDimensions.Language] = undefined,
    ...
    AnalyticsEvent.prototype.initVisitor = function () {
        var _a;
        this.visitor = (_a = {},
            _a[VisitorCollectionDimensions.DeviceBrowserWidth] = undefined,
            _a[VisitorCollectionDimensions.DeviceBrowserHeight] = undefined,
            _a[VisitorCollectionDimensions.DeviceBrowserBreakpoint] = undefined,
            _a[VisitorCollectionDimensions.DeviceBrowserOrientation] = undefined,
            _a);
    };
    AnalyticsEvent.prototype.initPageExperience = function () {
        var _a;
        this.pageExperience = (_a = {},
            _a[PageExperienceCollectionDimensions.PageId] = undefined,
            _a[PageExperienceCollectionDimensions.PageName] = undefined,
            _a);
    };
...
var MenuBackClickEvent = /** @class */ (function (_super_1) {
    ...
    MenuBackClickEvent.prototype.initComponentClick = function () {
        var _a;
        this.componentClick = (_a = {},
            _a[ComponentClickCollectionDimension.ClickElementId] = undefined,
            _a[ComponentClickCollectionDimension.ClickElementName] = undefined,
            _a[ComponentClickCollectionDimension.ClickElementType] = undefined,
            _a[ComponentClickCollectionDimension.TargetUrl] = undefined,
            _a);
    };
...
var BackButton = /** @class */ (function () {
    ...
    BackButton.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", onClick: function () { return _this_1.sendMenuBackClickEventAnalyticsEvent(); } }, this.text)));
    };
    return BackButton;
}());
...
var BurgerButton = /** @class */ (function () {
    ...
    BurgerButton.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { class: "burger-button", onClick: function () { return _this_1.sendMoreClickAnalyticsEvent(); } }, h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    };
    return BurgerButton;
}());
...
var CarFurtherLinks = /** @class */ (function () {
    ...
    CarFurtherLinks.prototype.renderItem = function (item) {
        var _this_1 = this;
        return (h("p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(item); } }, item.Text));
    };
...
var ModelAnalyticsEvent = /** @class */ (function (_super_1) {
    ...
    ModelAnalyticsEvent.prototype.initCar = function () {
        var _a;
        this.car = (_a = {},
            _a[CarCollectionDimensions.ModelRangeCode] = undefined,
            _a[CarCollectionDimensions.ModelRangeName] = undefined,
            _a[CarCollectionDimensions.ModelSeriesName] = undefined,
            _a[CarCollectionDimensions.ModelSeriesCode] = undefined,
            _a[CarCollectionDimensions.ModelName] = undefined,
            _a[CarCollectionDimensions.Bodytype] = undefined,
            _a);
    };
...
var CarMetaFunctionalities = /** @class */ (function () {
    ...
    CarMetaFunctionalities.prototype.renderItem = function (source, contentItem, analyticsEvent) {
        return (h("p-link-pure", { href: contentItem.Link, icon: source, size: "inherit", onClick: function () { return analyticsEvent(contentItem); }, class: "car-meta-functionalities-item" }, contentItem.Text));
    };
...
var CarSeriesList = /** @class */ (function () {
    ...
    CarSeriesList.prototype.render = function () {
        ...
        return (h(Host, null, carSeries.map(function (series) { return (h("phn-mega-fly-out-overlay", { class: "car-series-fly-out-overlay overlay-trigger " + series.PhraseId, showOverlayHandler: _this_1.showOverlayHandler, hideOverlayHandler: _this_1.hideOverlayHandler, keyboardShowOverlayHandler: _this_1.keyboardShowOverlayHandler, keyboardHideOverlayHandler: _this_1.keyboardHideOverlayHandler }, h("phn-car-series", { slot: "button", text: series.Name, image: series.Image }), h("phn-car-series-model-overview", { slot: "content", series: series }))); })));
    };
...
var Crest = /** @class */ (function () {
    ...
    Crest.prototype.render = function () {
        var _this_1 = this;
        return (h("a", { class: "crest", onClick: function () { return _this_1.sendCrestClickAnalyticsEvent(); }, href: this.getCrestLink() }, h("p-marque", { class: "marque" })));
    };
    return Crest;
}());
...
var DealerSearch = /** @class */ (function () {
    ...
    DealerSearch.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("p-link-pure", { href: this.dealerSearchLink, size: "inherit", icon: "pin", onClick: function () {
                var linkItem = {
...
var DrawerShopsAndMore = /** @class */ (function () {
    ...
    DrawerShopsAndMore.prototype.render = function () {
        ...
        return (h("div", { class: "drawer-shops-and-more drawer-level-" + this.level + "-item-scroll drawer-level-" + this.level + "-item" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", onClick: function () { return _this_1.hideDrawer(); }, buttonId: buttonId, text: buttonText }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: _headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map(function (item, index, arr) {
                var isLastItem = arr.length === index + 1;
                var innerOverlayEl;
                return (h("div", null, h("phn-list-item", { item: item, onClick: function () { return _this_1.showDrawer(item, innerOverlayEl); }, onKeyDown: function (event) { return _this_1.handleKeyDown(event, item, innerOverlayEl, isLastItem); }, class: 'shops-and-more-item shops-and-more-item-' + index }), item.Link || !item.Items ? null : (h("phn-drawer-shops-and-more", { headline: item.Text, ref: function (el) { return (innerOverlayEl = el); }, item: item, level: _this_1.level + 1, class: 'drawer-level-2 drawer-level-2-' + index, backButtonText: _this_1.item.Text, backButtonId: _this_1.item.PhraseId, closeActiveDrawer: _this_1.closeActiveDrawer, setActiveDrawer: _this_1.setActiveDrawer }))));
            }))));
    };
...
var DrawerShopsAndMore$1 = /** @class */ (function () {
    ...
    DrawerShopsAndMore$1.prototype.showDrawer = function (item, index) {
        var phnDrawerCarSeriesModelOverview2 = (h("phn-drawer-shops-and-more-2", { headline: item.Text, item: item, class: 'shops-and-more-drawer-level-2 drawer-level-2 drawer-level-2-' + index, slot: "content" }));
                ...
                recieveMessage = function (event) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                authorizationRequestResponse = _a.sent();
...
var Header = /** @class */ (function () {
    ...
    Header.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "header-container" }, this.skipContentEnabled && (h("p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onKeyDown: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content")), h("div", { class: "header limit-stretch" }, h("div", { class: "crest-burger-btn-container" }, h("phn-crest", { class: "crest" }), this.drawerRestructureEnabled ? (h("phn-mobile-layout", null)) : (h("phn-burger-button", { tabindex: "0", class: "burger-button", onClick: function () { return _this_1.menuDrawerLevel1.show(); }, onKeyDown: this.keyDownHandler }))), h("div", { class: "menu-container" }, h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), !this.drawerRestructureEnabled && (h("phn-menu-drawer-level-1", { ref: function (el) { return (_this_1.menuDrawerLevel1 = el); } }))), h("div", { class: "header-border" }), this.env === 'preview' && h("phn-preview-badge", { versionString: "Header " + VERSION + " - PP content" }), h("div", { id: "main", tabindex: "-1", class: "main-content", onBlur: this.mainContentTab })));
    };
...
var ListItem = /** @class */ (function () {
    ...
    ListItem.prototype.renderLinkItem = function (linkItem) {
        var _this_1 = this;
        return (h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: linkItem.Link, onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(linkItem); } }, linkItem.Text)));
    };
...
var MegaFlyOutOverlay = /** @class */ (function () {
    ...
    MegaFlyOutOverlay.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("div", { class: "mega-fly-out-overlay" }, h("div", { tabindex: "0", class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: function (el) { return (_this_1.containerElement = el); }, onKeyDown: this.handleKeyDownContainer }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: function (el) { return (_this_1.backdropElement = el); } }))));
    };
...
var MenuDrawerLevel1 = /** @class */ (function () {
    ...
    MenuDrawerLevel1.prototype.render = function () {
        ...
        return (h("div", { class: "menu-drawer-level-1 drawer-level-1-item", onClick: this.clickBackground }, h("div", { class: "drawer-level-1 drawer-level-1-item-scroll", onClick: this.clickMenu }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-close" }, h("phn-close-button", { class: "close-button" })), h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list", { ref: function (el) { return (_this_1.mobileCarSeriesListElement = el); }, class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-mobile-shops-and-more", { class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    };
...
var MessagesLink = /** @class */ (function () {
    ...
    MessagesLink.prototype.render = function () {
        ...
        return (h(Host, null, h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: this.item.Link, onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(); } }, h("span", { class: "link-text" }, this.item.Text), h("span", { class: unreadMessagesCount > 0 ? 'unread-messages-count' : 'unread-messages-count hidden' }, unreadMessagesCount)))));
    };
    return MessagesLink;
}());
...
var MobileCarSeriesList = /** @class */ (function () {
    ...
    MobileCarSeriesList.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map(function (series, index) { return (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, tabindex: "0", onClick: function () { return _this_1.showCarSubnavigation(index); }, onKeyDown: function (event) { return _this_1.handlePressEnterKey(event, index); } }), h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index, closeActiveDrawer: _this_1.closeActiveDrawer }))); })));
    };
...
var MobileCarSeriesList$1 = /** @class */ (function () {
    ...
    MobileCarSeriesList$1.prototype.showDrawer = function (_, series, index) {
        var phnDrawerCarSeriesModelOverview2 = (h("phn-drawer-car-series-model-overview-2", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index, slot: "content" }));
        var parent = navStateStore.get('activeDrawerContent');
        var currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerCarSeriesModelOverview2);
        navStateStore.set('parentDrawerContent', __spreadArrays([parent], currentParent));
    ...
    MobileCarSeriesList$1.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map(function (series, index) { return (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, tabindex: "0", onClick: function (event) { return _this_1.showDrawer(event, series, index); }, onKeyDown: function (event) { return _this_1.keyDownHandler(event, series, index); } }))); })));
    };
...
var MobileShopsAndMore = /** @class */ (function () {
    ...
    MobileShopsAndMore.prototype.render = function () {
        ...
        return (h(Host, { class: "mobile-shops-and-more" }, items.map(function (item) {
            var overlayRef;
            return (h("div", { class: "shops-and-more-container" }, h("phn-shops-and-more-item", { item: item, class: "shops-and-more-item", tabindex: "0", onClick: function () { return _this_1.showActiveDrawer(overlayRef, item); }, onKeyDown: function (event) { return _this_1.handlePressEnterKey(event, overlayRef, item); } }), h("phn-drawer-shops-and-more", { headline: item.Items && item.Items.length === 1 ? item.Text : '', item: item.Items && item.Items.length === 1 ? item.Items[0] : item, class: "shops-and-more-overlay", setActiveDrawer: _this_1.setActiveDrawer, closeActiveDrawer: _this_1.closeActiveDrawer, ref: function (el) { return (overlayRef = el); } })));
        })));
    };
...
var MobileShopsAndMore$1 = /** @class */ (function () {
    ...
    MobileShopsAndMore$1.prototype.showDrawer = function (_, item, index) {
        var phnDrawerShopsAndMore2 = (h("phn-drawer-shops-and-more-2", { headline: item.Text, item: item.Items && item.Items.length === 1 ? item.Items[0] : item, slot: "content", class: "shops-and-more-drawer-level-1" }));
        var parent = navStateStore.get('activeDrawerContent');
        var currentParent = navStateStore.get('parentDrawerContent');
    ...
    MobileShopsAndMore$1.prototype.render = function () {
        ...
        return (h(Host, { class: "mobile-shops-and-more" }, items.map(function (item, index) {
            return (h("div", { class: "shops-and-more-container" }, h("phn-shops-and-more-item", { item: item, class: 'shops-and-more-item shops-and-more-item-' + index, tabindex: "0", onClick: function (event) { return _this_1.showDrawer(event, item, index); }, onKeyDown: function (event) { return _this_1.handleKeyDown(event, item, index); } })));
        })));
    };
...
var Myporsche = /** @class */ (function () {
    ...
    Myporsche.prototype.renderLoggedOutComponent = function () {
        var _this_1 = this;
        return (h("p-link-pure", { class: "myporsche-logged-out", href: this.myporscheLink, onClick: function () {
                var linkItem = {
    ...
    Myporsche.prototype.renderLoggedInComponent = function () {
        ...
        var myPorscheDrawer = drawerRestructure ? (h("phn-myporsche-drawer-2", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })) : (h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, unreadMessagesCount: unreadMessagesCount }));
        return [
            myPorscheDrawer,
...
var MyPorscheDrawer = /** @class */ (function () {
    ...
    MyPorscheDrawer.prototype.render = function () {
        var _this_1 = this;
        var drawerRef;
        return (h(Host, null, h("phn-button-extended", { class: "drawer-trigger", icon: "arrow-head-right", onClick: function () { return _this_1.openDrawer(drawerRef); }, onKeyDown: function (event) { return _this_1.handlePressEnterKey(event, drawerRef); }, cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-icon", { name: "user", size: "small" }), h("span", { class: "drawer-trigger-label" }, this.myPorscheText, h("p-text", { class: "login-status", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus))), h("phn-myporsche-items-drawer", { class: "drawer--closed", ref: function (el) { return (drawerRef = el); }, closeActiveDrawer: this.closeActiveDrawer })));
    };
...
var MyPorscheDrawer$1 = /** @class */ (function () {
    ...
    MyPorscheDrawer$1.prototype.openDrawer = function () {
        var phnDrawerCarSeriesModelOverview2 = (h("phn-myporsche-items-drawer-2", { slot: "content", myPorscheText: this.myPorscheText }));
        var parent = navStateStore.get('activeDrawerContent');
        var currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerCarSeriesModelOverview2);
        navStateStore.set('parentDrawerContent', __spreadArrays([parent], currentParent));
    ...
    MyPorscheDrawer$1.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: function () { return _this_1.openDrawer(); }, cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
...
var MyPorscheFlyout = /** @class */ (function () {
    ...
    MyPorscheFlyout.prototype.render = function () {
        ...
        return (h(Host, null, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, tabindex: "0", onKeyDown: this.keyDownHandler }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items" }, h("phn-myporsche-items", { myPorscheCloseHandler: function () { return _this_1.myPorscheCloseHandler(); } }))) : null));
    };
...
var ShopsAndMore = /** @class */ (function () {
    ...
    ShopsAndMore.prototype.render = function () {
        ...
        return (h("div", { class: "shops-and-more" }, items.map(function (item) {
            return (h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: _this_1.showOverlayHandler, hideOverlayHandler: _this_1.hideOverlayHandler, keyboardShowOverlayHandler: _this_1.keyboardShowOverlayHandler, keyboardHideOverlayHandler: _this_1.keyboardHideOverlayHandler }, h("phn-shops-and-more-item", { slot: "button", item: item, class: "shops-and-more-item" }), h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    };
    return ShopsAndMore;
}());
...
var ShopsAndMoreOverview = /** @class */ (function () {
    ...
    ShopsAndMoreOverview.prototype.renderLinkGroup = function (_items, _title) {
        return (h("div", { class: "link-group" }, h("phn-headline", { text: _title, class: "head-line" }), h("div", { class: "list-item-group" }, _items.map(function (linkItem) {
