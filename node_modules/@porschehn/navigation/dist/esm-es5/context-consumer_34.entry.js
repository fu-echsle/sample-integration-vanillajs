...
var MyPorscheFlyout = /** @class */ (function () {
    ...
    MyPorscheFlyout.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { tabindex: "0" }, h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items" }, h("phn-myporsche-items", { myPorscheCloseHandler: function () { return _this_1.myPorscheCloseHandler(); } }))) : null));
    };
