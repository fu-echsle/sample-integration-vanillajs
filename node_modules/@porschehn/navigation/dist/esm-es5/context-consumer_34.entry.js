...
var FEATURE_FEATURE1 = 'homenav_feature1';
...
var BurgerButton = /** @class */ (function () {
    ...
    BurgerButton.prototype.render = function () {
        var _this_1 = this;
        var text = this.menu && this.menu.length > 0 ? this.menu[0].Text : '';
        return (h(Host, { class: "burger-button", onClick: function () { return _this_1.sendMoreClickAnalyticsEvent(); } }, h("p-text", { size: "inherit", class: "burger-button-text" }, text), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    };
    return BurgerButton;
}());
...
var CarSeries = /** @class */ (function () {
    ...
    CarSeries.prototype.render = function () {
        var path = getAssetPath(config(this.env).ASSETS_URL + "/series-assets");
...
var CloseButton = /** @class */ (function () {
    ...
    CloseButton.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "close-button-wrapper", onClick: function (e) {
...
var Crest = /** @class */ (function () {
    ...
    Crest.prototype.render = function () {
        var _this_1 = this;
        return (h("a", { class: "crest", onClick: function () { return _this_1.sendCrestClickAnalyticsEvent(); }, href: "//www.porsche.com/swiss/de/" }, h("p-marque", { class: "marque" })));
    };
    return Crest;
}());
...
var DrawerCarSeriesModelOverview = /** @class */ (function () {
    ...
    DrawerCarSeriesModelOverview.prototype.hasMenu = function () {
        return this.menu && this.menu.length > 0;
    };
    DrawerCarSeriesModelOverview.prototype.render = function () {
        var backButtonText = this.hasMenu() ? this.menu[0].Text : '';
        var backButtonId = this.hasMenu() ? this.menu[0].PhraseId : '';
...
var DrawerShopsAndMore = /** @class */ (function () {
    ...
    DrawerShopsAndMore.prototype.render = function () {
        var _this_1 = this;
        this.hide();
        var buttonText = this.backButtonText ? this.backButtonText : this.menu && this.menu[0] ? this.menu[0].Text : '';
        var buttonId = this.backButtonId ? this.backButtonId : this.menu && this.menu[0] ? this.menu[0].PhraseId : '';
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                getToken_1 = function (authorizationRequestResponse) { return __awaiter(void 0, void 0, void 0, function () {
                    var extras, requestToken, tokenResponse;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                extras = { prompt: 'none' };
                ...
                recieveMessage = function (event) { return __awaiter(void 0, void 0, void 0, function () {
                    var authorizationRequestResponse, tokenResponse, e_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 4:
                                e_3 = _a.sent();
                                errorLogRequest('silent_auth', "Something really bad happened: " + JSON.stringify(e_3.message), env);
                                errorHandler();
                                return [3 /*break*/, 5];
...
var Header = /** @class */ (function () {
    ...
    class_2.prototype.render = function () {
        ...
        return (h("div", { class: "header-container" }, h("div", { class: "header limit-stretch" }, h("div", { class: "crest-burger-btn-container" }, h("phn-crest", { class: "crest" }), h("phn-burger-button", { class: "burger-button", onClick: function () { return menuDrawerLevel1.show(); } })), h(StateTunnel.Provider, { state: this.appData }, h("div", { class: "menu-container" }, h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), h("phn-menu-drawer-level-1", { ref: function (el) { return (menuDrawerLevel1 = el); } }))), h("div", { class: "header-border" }), this.env === 'preview' && h("phn-preview-badge", { versionString: "Header " + VERSION + " - PP content" }), this.isFeature1Enabled && (h("div", null, h("br", null), h("br", null), "Booyah!!! Enabled feature 1!!!"))));
    };
...
var ListItem = /** @class */ (function () {
    ...
    ListItem.prototype.renderTextItem = function (textItem) {
        var _this_1 = this;
        return (h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(textItem); } }, h("span", { class: "list-item-text" }, textItem.Text)));
    };
...
var megaFlyOutOverlayCss = ".backdrop.sc-phn-mega-fly-out-overlay{position:fixed;z-index:200;left:0;right:0;background:rgba(0, 0, 0, 0.5);pointer-events:none;height:100vh;margin-top:1px}@media (min-width: 1300px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button.sc-phn-mega-fly-out-overlay{border-bottom:2px solid transparent}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay{border-bottom:2px solid #d5001c}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay:hover{color:#d5001c}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{display:block;visibility:hidden;width:100%;position:absolute;left:0;z-index:300;max-height:0;overflow:hidden}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:117px}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:123px}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{background-color:#fff;border-top:1px solid #c9cacb}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:5rem}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:6rem}}";
var MegaFlyOutOverlay = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { onKeyDown: this.handlePressEnterKey }, h("div", { class: "mega-fly-out-overlay" }, h("div", { tabindex: "0", onFocus: this.handleFocus, class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: function (el) { return (_this_1.containerElement = el); } }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: function (el) { return (_this_1.backdropElement = el); } }))));
    };
...
var MenuDrawerLevel1 = /** @class */ (function () {
    ...
    class_4.prototype.render = function () {
        ...
        var seriesList = !this.seriesList ? DEFAULT_SERIES_LIST : this.seriesList;
        var items = this.getItems();
        return (h("div", { class: "menu-drawer-level-1 drawer-level-1-item" }, h("div", { class: "drawer-level-1 drawer-level-1-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-close" }, h("phn-close-button", { class: "close-button" })), h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list", { ref: function (el) { return (_this_1.mobileCarSeriesListElement = el); }, class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-mobile-shops-and-more", { items: items, class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    };
...
var MobileCarSeriesList = /** @class */ (function () {
    ...
    class_5.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map(function (series, index) { return (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, onClick: function () { return _this_1.showCarSubnavigation(index); } }), h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index, closeActiveDrawer: _this_1.closeActiveDrawer }))); })));
    };
...
var MyPorscheItemsDrawer = /** @class */ (function () {
    ...
    MyPorscheItemsDrawer.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { class: "drawer-level-2-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", buttonId: this.menu[0].PhraseId, text: this.menu[0].Text, onClick: function () { return _this_1.hide(); } }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: "My Porsche", class: "drawer-headline" }), h("phn-myporsche-items", null))));
    };
...
var ShopsAndMore = /** @class */ (function () {
    ...
    ShopsAndMore.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "shops-and-more" }, this.items.map(function (item) {
            return (h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: _this_1.showOverlayHandler, hideOverlayHandler: _this_1.hideOverlayHandler }, h("phn-shops-and-more-item", { slot: "button", item: item, class: "shops-and-more-item" }), h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    };
    return ShopsAndMore;
}());
...
var ShopsAndMoreItem = /** @class */ (function () {
    ...
    ShopsAndMoreItem.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("phn-button-extended", { class: "shops-and-more-item-drawer", icon: "arrow-head-right", onClick: function () { return _this_1.sendNavigationClickAnalyticsEvent(_this_1.item); } }, this.item.Text), h("phn-button-extended", { class: "shops-and-more-item-mega-menu" }, this.item.Text)));
    };
