...
const index = require('./index-99c3a302.js');
...
const EMPTY_SERIES = { PhraseId: '', Name: '', Image: '', Models: [], Further: [], Meta: [] };
...
const SLOT_UPDATED_EVENT = 'slotUpdated';
...
const FEATURE_KEYBOARD = 'homenav_732_keyboard';
const FEATURE_SKIPCONTENT = 'homenav_skipcontent';
const FEATURE_UNREAD_MESSAGES_COUNT = 'homenav_628_messages_count';
const FEATURE_DRAWER_RESTRUCTURE = 'homenav_drawer_restructure';
const MAX_M_VIEWPORT_WIDTH = 1299;
const FOCUSABLE_ELEMENTS_SELECTOR = 'a, [tabindex]:not([tabindex="-1"]), p-link-pure, p-button-pure';
...
class BackButton {
    ...
    sendMenuBackClickEventAnalyticsEvent() {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", onClick: () => this.sendMenuBackClickEventAnalyticsEvent() }, this.text)));
    }
}
...
const burgerButtonCss = ".sc-phn-burger-button-h{color:#000;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}.sc-phn-burger-button-h:hover{color:#d5001c;cursor:pointer}@media (min-width: 1300px){.sc-phn-burger-button-h{display:none}}.sc-phn-burger-button-h .burger-button-text.sc-phn-burger-button{font-size:1rem;padding:0 0.5rem 0 0}@media (min-width: 760px) and (max-width: 999px){.sc-phn-burger-button-h .burger-button-text.sc-phn-burger-button{font-size:1.125rem}}";
...
class BurgerButton {
    ...
    render() {
        return (index.h(index.Host, { class: "burger-button", onClick: () => this.sendMoreClickAnalyticsEvent() }, index.h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), index.h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    }
}
...
class ButtonExtended {
    ...
    render() {
        return (index.h("button", { tabindex: this.cancelTabIndex ? -1 : 0 }, index.h("p-text", { color: "inherit", size: "inherit", tag: "div" }, index.h("slot", null)), this.icon ? index.h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
}
...
const carFurtherLinksCss = "@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center}}.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{border-bottom:1px solid #c9cacb;margin-bottom:3.75rem}@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{border-top:1px solid #c9cacb;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;margin-bottom:unset}}.car-further-links-item.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;font-weight:normal;-ms-flex-align:center;align-items:center;border-top:1px solid #c9cacb;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:1rem;padding:15px 0}.car-further-links-item.sc-phn-car-further-links:first-child{border-top:0}@media (min-width: 760px) and (max-width: 999px){.car-further-links-item.sc-phn-car-further-links{font-size:1.125rem;padding:18px 0}}@media (min-width: 1300px){.car-further-links-item.sc-phn-car-further-links{height:1.5rem;padding:0.875rem 0.625rem;border-top:0;-webkit-box-sizing:unset;box-sizing:unset}.car-further-links-item.sc-phn-car-further-links:first-child{margin-right:0.25rem}}";

class CarFurtherLinks {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.items = [
            { PhraseId: '', Text: '', Link: '' },
    ...
    renderItem(item) {
        return (index.h("p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: () => this.sendNavigationClickAnalyticsEvent(item) }, item.Text));
    }
    render() {
        return (index.h("div", { class: "car-further-links" }, index.h("div", { class: "car-further-links-wrapper" }, this.renderItem(this.items[0]), this.renderItem(this.items[1]))));
    }
}
...
class CarMetaFunctionalities {
    ...
    renderItem(source, contentItem, analyticsEvent) {
        return (index.h("p-link-pure", { href: contentItem.Link, icon: source, size: "inherit", onClick: () => analyticsEvent(contentItem), class: "car-meta-functionalities-item" }, contentItem.Text));
    }
    render() {
        return (index.h("div", { class: "car-meta-functionalities" }, index.h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    }
}
...
class CarModel {
    ...
    render() {
        const path = index.getAssetPath(`${config(navContentStore.get('env')).ASSETS_URL}/model-assets`);
        return (index.h("a", { class: "car-model", href: this.link }, index.h("picture", { class: "model-pic" }, index.h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), index.h("img", { alt: this.text })), index.h("div", { class: "model-text" }, this.text)));
    }
...
class CarSeries {
    ...
    render() {
        const path = index.getAssetPath(`${config(navContentStore.get('env')).ASSETS_URL}/series-assets`);
        return (index.h(index.Host, { class: "car-series" }, index.h("picture", null, index.h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), index.h("img", { alt: this.text })), index.h("p", { class: "car-series-text" }, this.text)));
    }
    static get assetsDirs() { return ["series-assets"]; }
}
CarSeries.style = carSeriesCss;

const carSeriesListCss = ".sc-phn-car-series-list-h{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;margin-top:1.75rem}@media (min-width: 760px) and (max-width: 1299px){.sc-phn-car-series-list-h{margin-top:1.875rem}}@media (min-width: 1300px){.sc-phn-car-series-list-h{-ms-flex-wrap:nowrap;flex-wrap:nowrap;margin-top:0}}@media (min-width: 1300px) and (max-width: 1759px){.sc-phn-car-series-list-h{margin-left:0.5625rem}}@media (min-width: 1760px){.sc-phn-car-series-list-h{margin-left:1.25rem}}@media (min-width: 1300px) and (max-width: 1759px){.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list{padding:0 0.3125rem}.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list:first-of-type{padding-left:0.9375rem}.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list:last-of-type{padding-right:0.9375rem}}@media (min-width: 1760px){.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list{padding:0 0.5625rem}.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list:first-of-type{padding-left:1.25rem}.sc-phn-car-series-list-h .car-series-fly-out-overlay.sc-phn-car-series-list:last-of-type{padding-right:1.25rem}}";
...
class CarSeriesList {
    ...
    render() {
        ...
        return (index.h(index.Host, null, carSeries.map((series) => (index.h("phn-mega-fly-out-overlay", { class: `car-series-fly-out-overlay overlay-trigger ${series.PhraseId}`, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }, index.h("phn-car-series", { slot: "button", text: series.Name, image: series.Image }), index.h("phn-car-series-model-overview", { slot: "content", series: series }))))));
    }
}
...
class CarSeriesModelOverview {
    ...
    render() {
        return (index.h("div", { class: "car-series-model-overview" }, index.h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta }), index.h("phn-car-model-list", { series: this.series }), index.h("phn-car-further-links", { items: this.series.Further })));
    }
}

const closeButtonCss = ".sc-phn-close-button-h{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center}@media (min-width: 760px){.sc-phn-close-button-h{height:3rem;width:3rem}}.sc-phn-close-button-h:focus{outline-width:2px;outline-style:solid;outline-offset:1px;outline-color:#00d5b9}.sc-phn-close-button-h:hover{color:#d5001c;cursor:pointer}";
...
class CloseButton {
    ...
    render() {
        return (index.h(index.Host, { class: "close-button-wrapper", tabindex: "0", onClick: this.closeEventfun, onKeyDown: this.handlePressEnterKey }, index.h("p-icon", { class: "close-button close-button-icon", name: "close", size: "small" })));
    }
}
...
class DealerSearch {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-link-pure", { href: this.dealerSearchLink, size: "inherit", icon: "pin", onClick: () => {
                const linkItem = {
...
class DrawerShopsAndMore {
    ...
    render() {
        ...
        return (index.h("div", { class: `drawer-shops-and-more drawer-level-${this.level}-item-scroll drawer-level-${this.level}-item` }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-back-and-close" }, index.h("phn-back-button", { class: "back-button", onClick: () => this.hideDrawer(), buttonId: buttonId, text: buttonText }), index.h("phn-close-button", { class: "close-button" })), index.h("phn-headline", { text: _headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index$1, arr) => {
                const isLastItem = arr.length === index$1 + 1;
                let innerOverlayEl;
                return (index.h("div", null, index.h("phn-list-item", { item: item, onClick: () => this.showDrawer(item, innerOverlayEl), onKeyDown: (event) => this.handleKeyDown(event, item, innerOverlayEl, isLastItem), class: 'shops-and-more-item shops-and-more-item-' + index$1 }), item.Link || !item.Items ? null : (index.h("phn-drawer-shops-and-more", { headline: item.Text, ref: (el) => (innerOverlayEl = el), item: item, level: this.level + 1, class: 'drawer-level-2 drawer-level-2-' + index$1, backButtonText: this.item.Text, backButtonId: this.item.PhraseId, closeActiveDrawer: this.closeActiveDrawer, setActiveDrawer: this.setActiveDrawer }))));
            }))));
    }
    get mainEl() { return index.getElement(this); }
}
...
navStateStore.onChange('activeDrawerContent', (_) => {
    const slotUpdatedEvent = new CustomEvent(SLOT_UPDATED_EVENT);
    const headerElement = document.querySelector('phn-header');
    if (headerElement) {
        const menuDrawer = headerElement.shadowRoot.querySelector('.drawer-trigger');
        menuDrawer.dispatchEvent(slotUpdatedEvent);
    }
});

const drawerShopsAndMoreCss$1 = ".drawer-shops-and-more.sc-phn-drawer-shops-and-more-2{padding-bottom:3.125rem}";

class DrawerShopsAndMore$1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.item = EMPTY_ITEM;
    }
    showDrawer(item, index$1) {
        const phnDrawerCarSeriesModelOverview2 = (index.h("phn-drawer-shops-and-more-2", { headline: item.Text, item: item, class: 'shops-and-more-drawer-level-2 drawer-level-2 drawer-level-2-' + index$1, slot: "content" }));
        if (!item.Link && item.Items) {
            ...
            navStateStore.set('accessibilityMarker', `.shops-and-more-drawer-level-1 .drawer-shops-and-more-item-${index$1}`);
            navStateStore.set('backButtonText', this.item.Text);
        }
    }
    render() {
        return (index.h("div", { class: `drawer-shops-and-more` }, index.h("div", { class: "drawer-container" }, index.h("phn-headline", { text: this.headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index$1) => {
                return (index.h("div", null, index.h("phn-list-item", { item: item, onClick: () => this.showDrawer(item, index$1), class: 'drawer-shops-and-more-item drawer-shops-and-more-item-' + index$1 })));
            }))));
    }
}
...
class NoHashQueryStringUtils extends query_string_utils_1 {
...
const fetchAccessToken = async (tokenReceivedHandler, errorHandler, env) => {
    ...
    const fetchRequestor = new xhr_3();
    try {
        authorizationServiceConfiguration = await authorization_service_configuration_1.fetchFromIssuer(envConfig.LOGIN_BASE_URL, fetchRequestor);
        ...
        const getToken = async (authorizationRequestResponse) => {
            ...
            const requestToken = new token_request_3({
        ...
        const request = new authorization_request_1({
            client_id: envConfig.CLIENT_ID,
            redirect_uri: envConfig.LOGIN_REDIRECT_URL,
            scope: 'openid',
...
class Header {
    constructor(hostRef) {
        ...
        this.accessTokenExpired = index.createEvent(this, "accessTokenExpired", 7);
    ...
    render() {
        return (index.h("div", { class: "header-container" }, this.skipContentEnabled && (index.h("p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onKeyDown: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content")), index.h("div", { class: "header limit-stretch" }, index.h("div", { class: "crest-burger-btn-container" }, index.h("phn-crest", { class: "crest" }), this.drawerRestructureEnabled ? (index.h("phn-mobile-layout", null)) : (index.h("phn-burger-button", { tabindex: "0", class: "burger-button", onClick: () => this.menuDrawerLevel1.show(), onKeyDown: this.keyDownHandler }))), index.h("div", { class: "menu-container" }, index.h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), !this.drawerRestructureEnabled && (index.h("phn-menu-drawer-level-1", { ref: (el) => (this.menuDrawerLevel1 = el) }))), index.h("div", { class: "header-border" }), this.env === 'preview' && index.h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), index.h("div", { id: "main", tabindex: "-1", class: "main-content", onBlur: this.mainContentTab })));
    }
...
class ListItem {
    ...
    renderLinkItem(linkItem) {
        return (index.h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, index.h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text)));
    }
    renderTextItem(textItem) {
        return (index.h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(textItem), cancelTabIndex: false }, index.h("span", { class: "list-item-text" }, textItem.Text)));
    }
    render() {
...
const megaFlyOutOverlayCss = ".backdrop.sc-phn-mega-fly-out-overlay{position:fixed;z-index:200;left:0;right:0;background:rgba(0, 0, 0, 0.5);pointer-events:none;height:100vh;margin-top:1px}@media (min-width: 1300px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button.sc-phn-mega-fly-out-overlay{border-bottom:2px solid transparent}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button.sc-phn-mega-fly-out-overlay:focus{outline-width:2px;outline-style:solid;outline-offset:1px;outline-color:#00d5b9}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay{border-bottom:2px solid #d5001c}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay:hover{color:#d5001c}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{display:block;visibility:hidden;width:100%;position:absolute;left:0;z-index:300;max-height:0;overflow:hidden}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:117px}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:123px}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{background-color:#fff;border-top:1px solid #c9cacb}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:5rem}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:6rem}}";

class MegaFlyOutOverlay {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.active = '';
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "mega-fly-out-overlay" }, index.h("div", { tabindex: "0", class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown }, index.h("slot", { name: "button" })), index.h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el), onKeyDown: this.handleKeyDownContainer }, index.h("div", { class: "mega-fly-out-overlay-content" }, index.h("slot", { name: "content" }))), this.active && index.h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
const menuDesktopLevel1Css = ".menu-desktop-level-1.sc-phn-menu-desktop-level-1{display:-ms-flexbox;display:flex;-ms-flex:1;flex:1;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:justify;justify-content:space-between}@media (min-width: 1300px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1{padding-top:1.625rem}}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1{padding-top:1.3125rem}}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-series-shop-and-more.sc-phn-menu-desktop-level-1{display:-ms-inline-flexbox;display:inline-flex}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-separator.sc-phn-menu-desktop-level-1{width:1px;height:2.375rem;background-color:#c9cacb;margin-top:0.875rem}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .menu-separator.sc-phn-menu-desktop-level-1{height:3rem;margin-top:1.0625rem}}.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:1.3125rem}@media (-ms-high-contrast: none) and (min-width: 1300px) and (max-width: 1759px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{-ms-flex:1;flex:1}}@media (min-width: 1300px) and (max-width: 1759px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:0}}@media (min-width: 1760px){.menu-desktop-level-1.sc-phn-menu-desktop-level-1 .metafunctionalities.sc-phn-menu-desktop-level-1{padding-top:1.6875rem}}";

class MenuDesktopLevel1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    ...
    render() {
        return (index.h("div", { class: "menu-desktop-level-1" }, index.h("div", { class: "menu-series-shop-and-more", onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave() }, index.h("phn-car-series-list", { showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }), index.h("phn-shops-and-more", { showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler })), index.h("div", { class: "menu-separator" }), index.h("phn-meta-functionalities", { class: "metafunctionalities" })));
    }
}
...
class MenuDrawerAnimation {
    constructor() {
        ...
        this.slideInMenuDrawer = (element) => {
        ...
        this.slideOutMenuDrawer = (element) => {
            gsapWithCSS.to(element.querySelector('.menu-drawer-content'), {
                right: '-100%',
                duration: 0.24,
                ease: 'sine.inOut',
...
class MenuDrawerLevel1 {
    constructor(hostRef) {
        ...
        this.menuOverlayOpen = index.createEvent(this, "menuOverlayOpen", 7);
        this.menuOverlayClose = index.createEvent(this, "menuOverlayClose", 7);
    }
    async show() {
    ...
    render() {
        ...
        return (index.h("div", { class: "menu-drawer-level-1 drawer-level-1-item", onClick: this.clickBackground }, index.h("div", { class: "drawer-level-1 drawer-level-1-item-scroll", onClick: this.clickMenu }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-close" }, index.h("phn-close-button", { class: "close-button" })), index.h("div", { class: "drawer-content" }, index.h("phn-mobile-car-series-list", { ref: (el) => (this.mobileCarSeriesListElement = el), class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), index.h("phn-mobile-shops-and-more", { class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), index.h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return index.getElement(this); }
}
MenuDrawerLevel1.style = menuDrawerLevel1Css;

class MenuMobileLevel1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    render() {
        const seriesList = navContentStore.get('seriesList');
        return (index.h("div", { class: "menu-mobile-level-1 mobile-level-1-item" }, index.h("div", { class: "mobile-level-1 mobile-level-1-item-scroll" }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-content" }, index.h("phn-mobile-car-series-list-2", { class: "mobile-car-series-list", carSeries: seriesList }), index.h("phn-mobile-shops-and-more-2", null), index.h("phn-meta-functionalities", { class: "meta-functionalities" }))))));
    }
}

const messagesLinkCss = ".sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:1rem;border-bottom:1px solid #c9cacb}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link:hover{color:#d5001c;cursor:pointer}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{font-size:1.125rem}}@media (min-width: 1300px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link{border-bottom:0;padding-left:0}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{text-decoration:none;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-align:center;align-items:center;width:100%;padding:0.875rem 0 0.875rem 0.625rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{padding-top:1.125rem;padding-bottom:1.125rem}}@media (min-width: 1300px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link a.sc-phn-messages-link{padding-bottom:0}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link{height:1rem;margin-left:0.5rem;padding:0 0.3125rem;background-color:#d5001c;border-radius:8px;font-size:0.75rem;color:#fff;line-height:1rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link{height:1.125rem;font-size:0.875rem;line-height:1.125rem}}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.sc-phn-messages-link:hover{color:#fff}.sc-phn-messages-link-h .list-item-link.sc-phn-messages-link .unread-messages-count.hidden.sc-phn-messages-link{display:none}";
...
class MessagesLink {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, index.h("a", { href: this.item.Link, onClick: () => this.sendNavigationClickAnalyticsEvent() }, index.h("span", { class: "link-text" }, this.item.Text), index.h("span", { class: unreadMessagesCount > 0 ? 'unread-messages-count' : 'unread-messages-count hidden' }, unreadMessagesCount)))));
    }
}
...
class MobileCarSeriesList {
    ...
    render() {
        return (index.h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index$1) => (index.h("div", { class: "mobile-car-series" }, index.h("phn-car-series", { class: 'car-series car-series-' + index$1, text: series.Name, image: series.Image, tabindex: "0", onClick: () => this.showCarSubnavigation(index$1), onKeyDown: (event) => this.handlePressEnterKey(event, index$1) }), index.h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index$1, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return index.getElement(this); }
}
MobileCarSeriesList.style = mobileCarSeriesListCss;

const mobileCarSeriesListCss$1 = ".mobile-car-series-list.sc-phn-mobile-car-series-list-2{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.mobile-car-series-list.sc-phn-mobile-car-series-list-2 .mobile-car-series.sc-phn-mobile-car-series-list-2{width:50%}@media (min-width: 760px) and (max-width: 1299px){.mobile-car-series-list.sc-phn-mobile-car-series-list-2 .mobile-car-series.sc-phn-mobile-car-series-list-2{margin-top:0.625rem}}";

class MobileCarSeriesList$1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.carSeries = DEFAULT_SERIES_LIST;
    ...
    showDrawer(_, series, index$1) {
        const phnDrawerCarSeriesModelOverview2 = (index.h("phn-drawer-car-series-model-overview-2", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index$1, slot: "content" }));
        const parent = navStateStore.get('activeDrawerContent');
        const currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerCarSeriesModelOverview2);
        navStateStore.set('parentDrawerContent', [parent, ...currentParent]);
        navStateStore.set('accessibilityMarker', `.car-series-${index$1}`);
        navStateStore.set('backButtonText', null);
        this.sendNavigationClickAnalyticsEvent(series);
    }
    render() {
        return (index.h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index$1) => (index.h("div", { class: "mobile-car-series" }, index.h("phn-car-series", { class: 'car-series car-series-' + index$1, text: series.Name, image: series.Image, tabindex: "0", onClick: (event) => this.showDrawer(event, series, index$1), onKeyDown: (event) => this.keyDownHandler(event, series, index$1) }))))));
    }
}
MobileCarSeriesList$1.style = mobileCarSeriesListCss$1;

const mobileLayoutCss = ".sc-phn-mobile-layout-h .burger-button.sc-phn-mobile-layout{height:100%}";
...
class MobileLayout {
    constructor(hostRef) {
        ...
        this.slotUpdated = index.createEvent(this, "slotUpdated", 7);
    }
    showDrawer(event) {
        navStateStore.set('activeDrawerContent', index.h("phn-menu-mobile-level-1", { slot: "content" }));
    ...
    render() {
        return (index.h(index.Host, null, index.h("phn-burger-button", { tabindex: "0", class: "burger-button", onClick: this.showDrawer, onKeyDown: this.keyDownHandler }), index.h("phn-menu-drawer", null, navStateStore.get('activeDrawerContent'))));
    }
}
MobileLayout.style = mobileLayoutCss;

const mobileShopsAndMoreCss = ".sc-phn-mobile-shops-and-more-h{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-direction:column;flex-direction:column;border-top:1px solid #c9cacb;margin-top:1.5rem}@media (min-width: 760px) and (max-width: 1299px){.sc-phn-mobile-shops-and-more-h{margin-top:3rem}}";

class MobileShopsAndMore {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.env = DEFAULT_ENVIRONMENT;
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "mobile-shops-and-more" }, items.map((item) => {
            let overlayRef;
            return (index.h("div", { class: "shops-and-more-container" }, index.h("phn-shops-and-more-item", { item: item, class: "shops-and-more-item", tabindex: "0", onClick: () => this.showActiveDrawer(overlayRef, item), onKeyDown: (event) => this.handlePressEnterKey(event, overlayRef, item) }), index.h("phn-drawer-shops-and-more", { headline: item.Items && item.Items.length === 1 ? item.Text : '', item: item.Items && item.Items.length === 1 ? item.Items[0] : item, class: "shops-and-more-overlay", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, ref: (el) => (overlayRef = el) })));
        })));
    }
}
MobileShopsAndMore.style = mobileShopsAndMoreCss;

const mobileShopsAndMoreCss$1 = ".sc-phn-mobile-shops-and-more-2-h{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-direction:column;flex-direction:column;border-top:1px solid #c9cacb;margin-top:1.5rem}@media (min-width: 760px) and (max-width: 1299px){.sc-phn-mobile-shops-and-more-2-h{margin-top:3rem}}";

class MobileShopsAndMore$1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    ...
    showDrawer(_, item, index$1) {
        const phnDrawerShopsAndMore2 = (index.h("phn-drawer-shops-and-more-2", { headline: item.Text, item: item.Items && item.Items.length === 1 ? item.Items[0] : item, slot: "content", class: "shops-and-more-drawer-level-1" }));
        const parent = navStateStore.get('activeDrawerContent');
        const currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerShopsAndMore2);
        navStateStore.set('parentDrawerContent', [parent, ...currentParent]);
        navStateStore.set('accessibilityMarker', `.shops-and-more-item-${index$1}`);
        navStateStore.set('backButtonText', null);
        this.sendNavigationClickAnalyticsEvent(item);
    }
    sendNavigationClickAnalyticsEvent(item) {
...
class Myporsche {
    ...
    renderLoggedOutComponent() {
        return (index.h("p-link-pure", { class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                const linkItem = {
                ...
                this.sendMetaFunctionClickAnalyticsEvent(linkItem);
            }, size: "inherit", icon: "user" }, this.myporscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.getSubTextForUser())));
    }
    renderLoadingComponent() {
        return (index.h("p-button-pure", { loading: "true", size: "inherit" }, this.myporscheText));
    }
    renderLoggedInComponent() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        const drawerRestructure = isFeatureEnabled(FEATURE_DRAWER_RESTRUCTURE, navContentStore.get('env'));
        const myPorscheDrawer = drawerRestructure ? (index.h("phn-myporsche-drawer-2", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })) : (index.h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, unreadMessagesCount: unreadMessagesCount }));
        return [
            myPorscheDrawer,
            index.h("phn-myporsche-flyout", { class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })
        ];
    }
    render() {
        const loggedInState = navContentStore.get('loggedInState');
        return (index.h(index.Host, null, loggedInState === LOGGED_OUT_USER_STATUS
...
class MyPorscheDrawer {
    constructor(hostRef) {
        ...
        this.handlePressEnterKey = (event, drawerRef) => {
            if (isFeatureEnabled(FEATURE_KEYBOARD, this.env)) {
                if (event.key === 'Enter') {
    ...
    openDrawer(myPorscheItems) {
        myPorscheItems.style.display = 'block';
        this.setActiveDrawer(myPorscheItems, 2);
    }
    render() {
        let drawerRef;
        return (index.h(index.Host, null, index.h("phn-button-extended", { class: "drawer-trigger", icon: "arrow-head-right", onClick: () => this.openDrawer(drawerRef), onKeyDown: (event) => this.handlePressEnterKey(event, drawerRef), cancelTabIndex: false }, index.h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-icon", { name: "user", size: "small" }), index.h("span", { class: "drawer-trigger-label" }, this.myPorscheText, index.h("p-text", { class: "login-status", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus))), index.h("phn-myporsche-items-drawer", { class: "drawer--closed", ref: (el) => (drawerRef = el), closeActiveDrawer: this.closeActiveDrawer })));
    }
}
MyPorscheDrawer.style = myporscheDrawerCss;

const myporscheDrawerCss$1 = ".sc-phn-myporsche-drawer-2-h{display:block}.sc-phn-myporsche-drawer-2-h .login-status.sc-phn-myporsche-drawer-2{margin-top:-0.25rem;font-size:0.75rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-myporsche-drawer-2-h .login-status.sc-phn-myporsche-drawer-2{margin-top:-0.1875rem}}@media (min-width: 1300px){.sc-phn-myporsche-drawer-2-h .login-status.sc-phn-myporsche-drawer-2{margin-top:unset}}.sc-phn-myporsche-drawer-2-h .myporsche-drawer-trigger.sc-phn-myporsche-drawer-2:focus-within{outline-width:2px;outline-style:solid;outline-offset:1px;outline-color:#00d5b9}.sc-phn-myporsche-drawer-2-h .myporsche-drawer-trigger-label.sc-phn-myporsche-drawer-2{display:-ms-inline-flexbox;display:inline-flex;-ms-flex-direction:column;flex-direction:column;padding-left:0.25rem}.sc-phn-myporsche-drawer-2-h .myporsche-unread-messages-indicator.sc-phn-myporsche-drawer-2{position:absolute;width:0.375rem;height:0.375rem;border-radius:50%;background-color:#d5001c;left:1.0625rem;top:0.0625rem}.sc-phn-myporsche-drawer-2-h .myporsche-unread-messages-indicator.hidden.sc-phn-myporsche-drawer-2{display:none}";

class MyPorscheDrawer$1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.unreadMessagesCount = 0;
    }
    openDrawer() {
        const phnDrawerCarSeriesModelOverview2 = (index.h("phn-myporsche-items-drawer-2", { slot: "content", myPorscheText: this.myPorscheText }));
        const parent = navStateStore.get('activeDrawerContent');
        const currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerCarSeriesModelOverview2);
        navStateStore.set('parentDrawerContent', [parent, ...currentParent]);
    ...
    render() {
        return (index.h(index.Host, null, index.h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: () => this.openDrawer(), cancelTabIndex: false }, index.h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-icon", { name: "user", size: "small" }), index.h("span", { class: "myporsche-drawer-trigger-label" }, this.myPorscheText, index.h("p-text", { class: "login-status", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)))));
    }
}
...
class MyPorscheFlyout {
    ...
    render() {
        return (index.h(index.Host, null, index.h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, tabindex: "0", onKeyDown: this.keyDownHandler }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (index.h("div", { class: "myporsche-items" }, index.h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
}
MyPorscheFlyout.style = myporscheFlyoutCss;

const myporscheItemsCss = ".sc-phn-myporsche-items-h{display:block}.sc-phn-myporsche-items-h hr.sc-phn-myporsche-items{display:none}@media (min-width: 1300px){.sc-phn-myporsche-items-h hr.sc-phn-myporsche-items{display:block;height:1px;border:none;background-color:#c9cacb;margin:0.875rem 0 0 0;text-align:center}}";

class MyPorscheItems {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
...
class MyPorscheItemsDrawer {
    ...
    render() {
        return (index.h(index.Host, { class: "drawer-level-2-item-scroll" }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-back-and-close" }, index.h("phn-back-button", { class: "back-button", buttonId: this.getValueForField(PHRASEID_FIELD_NAME), text: this.getValueForField(TEXT_FIELD_NAME), onClick: () => this.hide() }), index.h("phn-close-button", { class: "close-button" })), index.h("phn-headline", { text: "My Porsche", class: "drawer-headline" }), index.h("phn-myporsche-items", null))));
    }
    get hostElement() { return index.getElement(this); }
}
MyPorscheItemsDrawer.style = myporscheItemsDrawerCss;

const myporscheItemsDrawerCss$1 = ".sc-phn-myporsche-items-drawer-2-h{padding-bottom:3.125rem}";

class MyPorscheItemsDrawer$1 {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "drawer-container" }, index.h("phn-headline", { text: this.myPorscheText, class: "drawer-headline" }), index.h("phn-myporsche-items", null))));
    }
}
...
class PreviewBadge {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-text", { theme: "dark", size: "x-small" }, this.versionString)));
    }
}
...
class ShopsAndMoreOverview {
    ...
    renderLinkGroup(_items, _title) {
        return (index.h("div", { class: "link-group" }, index.h("phn-headline", { text: _title, class: "head-line" }), index.h("div", { class: "list-item-group" }, _items.map((linkItem) => {
            return index.h("phn-list-item", { item: linkItem });
        }))));
    }
    ...
    render() {
        return (index.h("div", { class: "shops-and-more-overview" }, index.h("div", { class: "shops-and-more-overview-content" }, hasLinkItemChild(this.item)
...
exports.phn_close_button = CloseButton;
...
exports.phn_drawer_car_series_model_overview_2 = DrawerCarSeriesModelOverview$1;
exports.phn_drawer_shops_and_more = DrawerShopsAndMore;
exports.phn_drawer_shops_and_more_2 = DrawerShopsAndMore$1;
...
exports.phn_menu_drawer_level_1 = MenuDrawerLevel1;
...
exports.phn_myporsche_items_drawer_2 = MyPorscheItemsDrawer$1;
exports.phn_preview_badge = PreviewBadge;
exports.phn_shops_and_more = ShopsAndMore;
exports.phn_shops_and_more_item = ShopsAndMoreItem;
