...
const BurgerButton = class {
    ...
    getText() {
        ...
        if (this.menu && this.menu.length > 0) {
            const menuItem = this.menu.find((m) => m.PhraseId === MENU_PHRASE_ID);
...
const ButtonExtended = class {
    ...
    render() {
        return (index.h("button", { tabindex: "-1" }, index.h("p-text", { color: "inherit", size: "inherit", tag: "div" }, index.h("slot", null)), this.icon ? index.h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
};
...
const CarSeries = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "car-series" }, index.h("picture", null, index.h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), index.h("img", { alt: this.text })), index.h("p", { class: "car-series-text" }, this.text)));
    }
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (index.h(index.Host, { tabindex: "0" }, index.h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (index.h("div", { class: "myporsche-items" }, index.h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
