...
const index = require('./index-93ca480e.js');
...
const FOCUSABLE_ELEMENTS_SELECTOR = 'a, button, [tabindex]:not([tabindex="-1"]), p-link-pure, p-button-pure';
...
const BackButton = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", "aria-label": "Back to Menu", onClick: this.sendMenuBackClickEventAnalyticsEvent }, this.text)));
    }
};
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: "burger-button", onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null, "aria-haspopup": "dialog" }, index.h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), index.h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines", role: "img", "aria-label": "burger button" }), hasUnreadMessages && index.h("span", { class: "myporsche-unread-messages-indicator" })), index.h("div", { style: navStateStore.get('crestLoaded') ? this.hiddenStyle : {}, class: "burger-button-skeleton" })));
    }
};
...
const CarFurtherLinks = class {
    ...
    renderItem(item) {
        return (index.h("p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: () => this.sendNavigationClickAnalyticsEvent(item), role: "button" }, item.Text));
    }
    render() {
...
const CarMetaFunctionalities = class {
    ...
    render() {
        return isFeatureEnabled(FEATURE_MODEL_META) ? (index.h("div", { class: "car-meta-functionalities" }, index.h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map((item) => (index.h("p-link-pure", { href: item.Link, icon: item.Icon, onClick: () => this.sendModelMetaFunctionAnalyticsEvent(item), size: "inherit", class: "car-meta-functionalities-item" }, item.Text)))))) : (index.h("div", { class: "car-meta-functionalities" }, index.h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    }
};
...
const CarModel = class {
    ...
    render() {
        ...
        return (index.h("a", { class: "car-model", href: this.link }, index.h("picture", { class: "model-pic", "aria-hidden": "true" }, index.h("source", { type: `image/${imageType}`, media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.${imageFileEnding}, ${path}/1920/${this.image}@2x.${imageFileEnding} 2x` }), index.h("source", { type: `image/${imageType}`, media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.${imageFileEnding}, ${path}/1366/${this.image}@2x.${imageFileEnding} 2x` }), index.h("source", { type: `image/${imageType}`, media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.${imageFileEnding}, ${path}/1024/${this.image}@2x.${imageFileEnding} 2x` }), index.h("source", { type: `image/${imageType}`, media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.${imageFileEnding}, ${path}/768/${this.image}@2x.${imageFileEnding} 2x` }), index.h("source", { type: `image/${imageType}`, media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.${imageFileEnding}, ${path}/375/${this.image}@2x.${imageFileEnding} 2x` }), index.h("source", { type: `image/${imageType}`, media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.${imageFileEnding}, ${path}/320/${this.image}@2x.${imageFileEnding} 2x` }), index.h("img", { alt: this.text })), index.h("div", { class: "model-text" }, this.text)));
    }
...
const CarSeries = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "car-series" }, index.h("p", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, class: "car-series-text", "aria-label": `Porsche Model Series ${this.text}` }, this.text), index.h("div", { style: navStateStore.get('navigationLoaded') ? hiddenStyle : {}, class: "car-series-skeleton" })));
    }
...
const CarSeriesModelOverview = class {
    ...
    render() {
        return (index.h("div", { class: "car-series-model-overview" }, index.h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta, modelMetaItems: this.series.ModelMeta }), index.h("phn-car-model-list", { series: this.series }), index.h("phn-car-further-links", { items: this.series.Further })));
    }
};
...
const DealerSearch = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (index.h(index.Host, { class: "dealer-search" }, index.h("p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, href: this.dealerSearchLink, size: "inherit", icon: "pin", class: 'dealer-search-link', onClick: () => {
                const linkItem = {
            ...
            } }, this.dealerSearchText), index.h("div", { class: "dealer-search-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
    get el() { return index.getElement(this); }
};
...
const DesktopShopAndMoreItem = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (index.h(index.Host, null, index.h("p-text", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, class: "desktop-shop-and-more-item-text", color: "inherit", size: "inherit", tag: "div" }, this.itemText), index.h("div", { class: "desktop-shop-and-more-item-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
};
...
const DrawerCarSeriesModelOverview = class {
    ...
    render() {
        return (index.h("div", { class: "drawer-car-series-model-overview" }, index.h("div", { class: "drawer-container drawer-level-2-item-scroll" }, index.h("phn-headline", { text: this.series.Name }), index.h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta, modelMetaItems: this.series.ModelMeta }), index.h("phn-car-model-list", { class: "car-model-list", series: this.series }), index.h("phn-car-further-links", { items: this.series.Further }))));
    }
};
...
const DrawerShopsAndMore = class {
    ...
    showDrawer(item, index$1) {
        const phnDrawerShopsAndMore = {
            ...
            content: (index.h("phn-drawer-shops-and-more", { headline: item.Text, item: item, class: 'shops-and-more-drawer-level-2 drawer-level-2 drawer-level-2-' + index$1, slot: "content" }))
        };
...
const Header = class {
    ...
    render() {
        return (index.h("header", { class: "header-container" }, index.h("p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onClick: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content"), index.h("div", { class: "header limit-stretch" }, index.h("div", { class: "crest-burger-btn-container" }, index.h("phn-crest", { class: "crest" }), index.h("phn-mobile-layout", null)), index.h("nav", { class: "menu-container" }, index.h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" }))), index.h("div", { class: "header-border" }), this.env === 'preview' && index.h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), index.h("div", { id: "main", tabindex: "-1", class: "main-content", onBlur: this.mainContentTab })));
    }
...
const Headline = class {
    ...
    render() {
        return index.h("h1", { class: "headline" }, this.text);
    }
};
...
const ListItem = class {
    ...
    renderLinkItem(linkItem) {
        return (index.h(index.Host, null, index.h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, index.h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text))));
    }
...
const MegaFlyOutOverlay = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "mega-fly-out-overlay" }, index.h("button", { class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown, onClick: this.handleClick, "aria-expanded": this.active === 'active' ? 'true' : 'false', "aria-haspopup": "true", id: this.screenReaderId }, index.h("slot", { name: "button" })), index.h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el), onKeyDown: this.handleKeyDownContainer, "aria-labelledby": this.screenReaderId, "aria-hidden": this.active === 'active' ? 'false' : 'true', role: "region" }, index.h("div", { class: "mega-fly-out-overlay-content" }, index.h("slot", { name: "content" }))), this.active && index.h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
const MenuDrawer = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.closeAllDrawers = index.createEvent(this, "closeAllDrawers", 7);
        ...
        this.initFirstAndLastFocusableElements = () => {
            const focusableElements = this.el.querySelectorAll('button, a, p-link-pure, p-button-pure, [tabindex]:not([tabindex="-1"])');
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "drawer-trigger", tabindex: "-1" }, index.h("div", { class: "menu-drawer" }, index.h("div", { class: "menu-drawer-container", onClick: this.close }, index.h("div", { class: "menu-drawer-content", onClick: this.stopClickEvent }, index.h("div", { class: "menu-drawer-content-wrapper", role: "dialog", "aria-modal": "true" }, index.h("span", { ref: (el) => (this.firstKeyboardAnchor = el), "aria-hidden": "true", tabindex: "-1" }), index.h("div", { class: backAndCloseClass }, !this.isFirstDrawer && (index.h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), index.h("p-button-pure", { class: "close-button", icon: "close", hideLabel: "true", role: "button", "aria-label": "close dialog", size: "small", onClick: this.close }, "Close Dialog")), index.h("slot", { name: "content" }), index.h("span", { ref: (el) => (this.lastKeyboardAnchor = el), "aria-hidden": "true", tabindex: "-1" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const MenuMobileLevel1 = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "menu-mobile-level-1 mobile-level-1-item" }, index.h("div", { class: "mobile-level-1 mobile-level-1-item-scroll" }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-content" }, index.h("phn-mobile-car-series-list", { class: "mobile-car-series-list", carSeries: seriesList }), index.h("phn-mobile-shops-and-more", null), index.h("phn-meta-functionalities", { class: "meta-functionalities" }))))));
    }
};
...
const MobileCarSeriesList = class {
    ...
    showDrawer(_, series, index$1) {
        const phnDrawerCarSeriesModelOverview = {
            content: (index.h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index$1, slot: "content" }))
        };
    ...
    render() {
        return (index.h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index$1) => (index.h("div", { class: "mobile-car-series", key: index$1 }, index.h("button", { class: "car-series-button", onClick: (event) => this.showDrawer(event, series, index$1) }, index.h("phn-car-series", { class: 'car-series car-series-' + index$1, text: series.Name, image: series.Image })))))));
    }
};
...
const MobileShopAndMoreItem = class {
    ...
    render() {
        return (index.h(index.Host, { class: "mobile-shop-and-more-item" }, index.h("phn-button-extended", { class: "mobile-shop-and-more-item-drawer", icon: "arrow-head-right" }, this.item.Text)));
    }
};
...
const MobileShopsAndMore = class {
    constructor(hostRef) {
        ...
        this.showDrawer = (_, item) => {
            const phnDrawerShopsAndMore = {
                content: (index.h("phn-drawer-shops-and-more", { headline: item.Text, item: item.Items && item.Items.length === 1 ? item.Items[0] : item, slot: "content", class: "shops-and-more-drawer-level-1" }))
            };
            navStateStore.set('drawerContentStack', [...navStateStore.get('drawerContentStack'), phnDrawerShopsAndMore]);
            this.sendNavigationClickAnalyticsEvent(item);
        };
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "mobile-shops-and-more" }, items.map((item, index$1) => {
            return (index.h("div", { class: "shops-and-more-container" }, index.h("phn-mobile-shop-and-more-item", { item: item, class: 'mobile-shop-and-more-item mobile-shop-and-more-item-' + index$1, tabindex: "0", onClick: (event) => this.showDrawer(event, item), onKeyDown: (event) => this.handleKeyDown(event, item) })));
        })));
    }
};
...
const Myporsche = class {
    ...
    renderLoggedOutComponent() {
        return (index.h("p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                const linkItem = {
    ...
    renderLoadingComponent() {
        return (index.h("p-button-pure", { class: "myporsche-loading", loading: "true", size: "inherit", "aria-label": "myporsche loading", style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle }, this.myporscheText));
    }
    renderLoggedInFlyout() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        return (index.h("phn-myporsche-flyout", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount }));
    }
    renderLoggedInDrawer() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        return (index.h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount }));
    }
    componentWillLoad() {
        this.isDesktop = isDesktop();
    }
    render() {
        const loggedInState = navContentStore.get('loggedInState');
        const hiddenStyle = { display: 'none' };
        return (index.h(index.Host, { class: "myporsche" }, this.renderMyPorsche(loggedInState), index.h("div", { class: "myporsche-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
    get el() { return index.getElement(this); }
};
...
const MyPorscheDrawer = class {
    constructor(hostRef) {
        ...
        this.openDrawer = () => {
            const phnMyporscheItemsDrawer = {
                content: index.h("phn-myporsche-items-drawer", { slot: "content", myPorscheText: this.myPorscheText })
            };
    ...
    render() {
        return (index.h(index.Host, null, index.h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: this.openDrawer, cancelTabIndex: false }, index.h("span", { class: this.unreadMessagesCount > 0
                ...
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-icon", { color: "inherit", name: "user", size: "small" }), index.h("span", { class: "myporsche-drawer-trigger-label" }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)))));
    }
};
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button", "aria-label": "open myporsche flyout" }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (index.h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, index.h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
...
const MyPorscheItems = class {
    constructor(hostRef) {
        ...
        this.displayListItems = (item, index$1) => {
            if (item.PhraseId === `${MYPORSCHE_PHRASE_ID}.messages`) {
                if (index$1 === 0) {
                    return (index.h("li", null, index.h("phn-messages-link", { class: "myporsche-list-item", item: item, onKeyDown: this.handlePressShiftTabKey })));
                }
                return (index.h("li", null, index.h("phn-messages-link", { class: "myporsche-list-item", item: item })));
            }
            if (index$1 === 0) {
                return (index.h("li", null, index.h("phn-list-item", { class: "myporsche-list-item", item: item, onKeyDown: this.handlePressShiftTabKey })));
            }
            return (index.h("li", null, index.h("phn-list-item", { class: "myporsche-list-item", item: item })));
        };
    }
    ...
    render() {
        if (navContentStore.get('metafunctionalities').length > 0) {
            ...
            return (index.h("ul", null, nonStaticItems.map(this.displayListItems), index.h("hr", { "aria-hidden": "true" }), index.h("li", null, index.h("phn-list-item", { class: "myporsche-list-item logout", item: this.getMyPorscheItemFromTemplateAsLinkItem('logout'), onKeyDown: this.handlePressTabKey }))));
        }
        return null;
    }
};
...
const ShopsAndMore = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "shops-and-more" }, items.map((item) => {
            return (index.h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }, index.h("phn-desktop-shop-and-more-item", { slot: "button", itemText: item.Text, class: "desktop-shop-and-more-item" }), index.h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    }
};
...
const ShopsAndMoreOverview = class {
    ...
    renderLinkGroup(_items, _title) {
        return (index.h("div", { class: "link-group" }, index.h("phn-headline", { role: "heading", "aria-level": "2", text: _title, class: "head-line" }), index.h("ul", { class: "list-item-group" }, _items.map((linkItem) => {
            return (index.h("li", null, index.h("phn-list-item", { item: linkItem })));
        }))));
    }
