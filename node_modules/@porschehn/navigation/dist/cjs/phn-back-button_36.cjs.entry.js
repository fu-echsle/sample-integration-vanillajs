...
const index = require('./index-7a9e7c76.js');
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: `burger-button ${isDrawerOpen ? 'hide-button' : ''}`, onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null }, index.h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), index.h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" }), hasUnreadMessages && index.h("span", { class: "myporsche-unread-messages-indicator" })), index.h("div", { style: navStateStore.get('crestLoaded') ? this.hiddenStyle : {}, class: "burger-button-skeleton" })));
    }
};
...
const MenuDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "drawer-trigger", tabindex: "-1" }, index.h("div", { class: "menu-drawer" }, index.h("div", { class: "menu-drawer-container", onClick: this.close }, index.h("div", { class: "menu-drawer-content", onClick: this.stopClickEvent }, index.h("div", { class: "menu-drawer-content-wrapper" }, index.h("div", { class: backAndCloseClass }, !this.isFirstDrawer && (index.h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), index.h("p-button-pure", { class: "close-button", icon: "close", hideLabel: "true", size: "small", onClick: this.close })), index.h("slot", { name: "content" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const MobileLayout = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("phn-burger-button", { class: "burger-button", onClick: this.showMobileLevel1 }), navStateStore.get('drawerContentStack').map((drawer, index$1) => {
            return (index.h("phn-menu-drawer", { key: index$1, backButton: drawer.backButton, mobileLayout: this.mobileLayoutElement }, drawer.content));
        })));
    }
...
const Myporsche = class {
    ...
    renderLoadingComponent() {
        return (index.h("p-button-pure", { class: "myporsche-loading", loading: "true", size: "inherit", style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle }, this.myporscheText));
    }
    renderLoggedInComponent() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        return [
            index.h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount }),
            index.h("phn-myporsche-flyout", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })
        ];
    }
    render() {
        const loggedInState = navContentStore.get('loggedInState');
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), index.h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button" }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (index.h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, index.h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
