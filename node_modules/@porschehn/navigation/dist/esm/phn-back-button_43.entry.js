import { g as getRenderingRef, f as forceUpdate, r as registerInstance, h, H as Host, c as getAssetPath, d as createEvent, e as getElement } from './index-b5926612.js';
...
class BackButton {
    ...
    render() {
        return (h(Host, null, h("p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", onClick: () => this.sendMenuBackClickEventAnalyticsEvent() }, this.text)));
    }
}
...
class BurgerButton {
    ...
    render() {
        return (h(Host, { class: "burger-button", onClick: () => this.sendMoreClickAnalyticsEvent() }, h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    }
}
...
class ButtonExtended {
    ...
    render() {
        return (h("button", { tabindex: this.cancelTabIndex ? -1 : 0 }, h("p-text", { color: "inherit", size: "inherit", tag: "div" }, h("slot", null)), this.icon ? h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
}
...
class CarMetaFunctionalities {
    ...
    renderItem(source, contentItem, analyticsEvent) {
        return (h("p-link-pure", { href: contentItem.Link, icon: source, size: "inherit", onClick: () => analyticsEvent(contentItem), class: "car-meta-functionalities-item" }, contentItem.Text));
    }
    render() {
        return (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    }
}
...
class CarModel {
    ...
    render() {
        ...
        return (h("a", { class: "car-model", href: this.link }, h("picture", { class: "model-pic" }, h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), h("img", { alt: this.text })), h("div", { class: "model-text" }, this.text)));
    }
...
class CarSeries {
    ...
    render() {
        ...
        return (h(Host, { class: "car-series" }, h("picture", null, h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), h("img", { alt: this.text })), h("p", { class: "car-series-text" }, this.text)));
    }
...
class CarSeriesModelOverview {
    ...
    render() {
        return (h("div", { class: "car-series-model-overview" }, h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta }), h("phn-car-model-list", { series: this.series }), h("phn-car-further-links", { items: this.series.Further })));
    }
}
...
class CloseButton {
    ...
    render() {
        return (h(Host, { class: "close-button-wrapper", tabindex: "0", onClick: this.closeEventfun, onKeyDown: this.handlePressEnterKey }, h("p-icon", { class: "close-button close-button-icon", name: "close", size: "small" })));
    }
}
...
class Crest {
    ...
    render() {
        return (h("a", { class: "crest", onClick: () => this.sendCrestClickAnalyticsEvent(), href: this.getCrestLink() }, h("p-marque", { class: "marque" })));
    }
}
...
class DealerSearch {
    ...
    render() {
        return (h(Host, null, h("p-link-pure", { href: this.dealerSearchLink, size: "inherit", icon: "pin", onClick: () => {
                const linkItem = {
...
class DrawerCarSeriesModelOverview {
    ...
    render() {
        ...
        return (h("div", { class: "drawer-car-series-model-overview" }, h("div", { class: "drawer-container drawer-level-2-item-scroll" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", onClick: this.handleClick, buttonId: backButtonId, text: backButtonText }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: this.series.Name }), h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta }), h("phn-car-model-list", { class: "car-model-list", series: this.series }), h("phn-car-further-links", { items: this.series.Further }))));
    }
...
class DrawerCarSeriesModelOverview$1 {
    ...
    render() {
        return (h("div", { class: "drawer-car-series-model-overview" }, h("div", { class: "drawer-container drawer-level-2-item-scroll" }, h("phn-headline", { text: this.series.Name }), h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta }), h("phn-car-model-list", { class: "car-model-list", series: this.series }), h("phn-car-further-links", { items: this.series.Further }))));
    }
}
...
class DrawerShopsAndMore {
    ...
    render() {
        ...
        return (h("div", { class: `drawer-shops-and-more drawer-level-${this.level}-item-scroll drawer-level-${this.level}-item` }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", onClick: () => this.hideDrawer(), buttonId: buttonId, text: buttonText }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: _headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index, arr) => {
                const isLastItem = arr.length === index + 1;
                let innerOverlayEl;
                return (h("div", null, h("phn-list-item", { item: item, onClick: () => this.showDrawer(item, innerOverlayEl), onKeyDown: (event) => this.handleKeyDown(event, item, innerOverlayEl, isLastItem), class: 'shops-and-more-item shops-and-more-item-' + index }), item.Link || !item.Items ? null : (h("phn-drawer-shops-and-more", { headline: item.Text, ref: (el) => (innerOverlayEl = el), item: item, level: this.level + 1, class: 'drawer-level-2 drawer-level-2-' + index, backButtonText: this.item.Text, backButtonId: this.item.PhraseId, closeActiveDrawer: this.closeActiveDrawer, setActiveDrawer: this.setActiveDrawer }))));
            }))));
    }
    get mainEl() { return getElement(this); }
}
...
class DrawerShopsAndMore$1 {
    ...
    showDrawer(item, index) {
        const phnDrawerCarSeriesModelOverview2 = (h("phn-drawer-shops-and-more-2", { headline: item.Text, item: item, class: 'shops-and-more-drawer-level-2 drawer-level-2 drawer-level-2-' + index, slot: "content" }));
...
class Header {
    ...
    render() {
        return (h("div", { class: "header-container" }, this.skipContentEnabled && (h("p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onKeyDown: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content")), h("div", { class: "header limit-stretch" }, h("div", { class: "crest-burger-btn-container" }, h("phn-crest", { class: "crest" }), this.drawerRestructureEnabled ? (h("phn-mobile-layout", null)) : (h("phn-burger-button", { tabindex: "0", class: "burger-button", onClick: () => this.menuDrawerLevel1.show(), onKeyDown: this.keyDownHandler }))), h("div", { class: "menu-container" }, h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), !this.drawerRestructureEnabled && (h("phn-menu-drawer-level-1", { ref: (el) => (this.menuDrawerLevel1 = el) }))), h("div", { class: "header-border" }), this.env === 'preview' && h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), h("div", { id: "main", tabindex: "-1", class: "main-content", onBlur: this.mainContentTab })));
    }
...
class Headline {
    ...
    render() {
        return h("div", { class: "headline" }, this.text);
    }
}
...
class ListItem {
    ...
    renderLinkItem(linkItem) {
        return (h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text)));
    }
...
class MegaFlyOutOverlay {
    ...
    render() {
        return (h(Host, null, h("div", { class: "mega-fly-out-overlay" }, h("div", { tabindex: "0", class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el), onKeyDown: this.handleKeyDownContainer }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
class MenuDrawer {
    ...
    render() {
        ...
        return (h(Host, { class: "drawer-trigger" }, h("div", { class: "menu-drawer" }, h("div", { class: 'menu-drawer-container', onClick: this.clickBackground }, h("div", { class: "menu-drawer-content", onClick: this.clickMenu }, h("div", { class: "menu-drawer-content-wrapper" }, h("div", { class: backAndCloseClass }, hasParent && (h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), h("phn-close-button", { class: "close-button", onClick: this.handleClose, onKeyDown: this.keyDownHandler })), h("slot", { name: "content" })))))));
    }
    get el() { return getElement(this); }
}
...
class MenuDrawerLevel1 {
    constructor(hostRef) {
        ...
        this.menuOverlayClose = createEvent(this, "menuOverlayClose", 7);
    }
    async show() {
    ...
    render() {
        ...
        return (h("div", { class: "menu-drawer-level-1 drawer-level-1-item", onClick: this.clickBackground }, h("div", { class: "drawer-level-1 drawer-level-1-item-scroll", onClick: this.clickMenu }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-close" }, h("phn-close-button", { class: "close-button" })), h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list", { ref: (el) => (this.mobileCarSeriesListElement = el), class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-mobile-shops-and-more", { class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return getElement(this); }
}
...
class MenuMobileLevel1 {
    ...
    render() {
        const seriesList = navContentStore.get('seriesList');
        return (h("div", { class: "menu-mobile-level-1 mobile-level-1-item" }, h("div", { class: "mobile-level-1 mobile-level-1-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list-2", { class: "mobile-car-series-list", carSeries: seriesList }), h("phn-mobile-shops-and-more-2", null), h("phn-meta-functionalities", { class: "meta-functionalities" }))))));
    }
}
...
class MessagesLink {
    ...
    render() {
        ...
        return (h(Host, null, h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: this.item.Link, onClick: () => this.sendNavigationClickAnalyticsEvent() }, h("span", { class: "link-text" }, this.item.Text), h("span", { class: unreadMessagesCount > 0 ? 'unread-messages-count' : 'unread-messages-count hidden' }, unreadMessagesCount)))));
    }
}
...
class MobileCarSeriesList {
    ...
    render() {
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index) => (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, tabindex: "0", onClick: () => this.showCarSubnavigation(index), onKeyDown: (event) => this.handlePressEnterKey(event, index) }), h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return getElement(this); }
}
...
class MobileCarSeriesList$1 {
    ...
    render() {
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index) => (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, tabindex: "0", onClick: (event) => this.showDrawer(event, series, index), onKeyDown: (event) => this.keyDownHandler(event, series, index) }))))));
    }
}
...
class MobileLayout {
    constructor(hostRef) {
        ...
        this.slotUpdated = createEvent(this, "slotUpdated", 7);
    }
    showDrawer(event) {
    ...
    render() {
        return (h(Host, null, h("phn-burger-button", { tabindex: "0", class: "burger-button", onClick: this.showDrawer, onKeyDown: this.keyDownHandler }), h("phn-menu-drawer", null, navStateStore.get('activeDrawerContent'))));
    }
}
...
class MobileShopsAndMore {
    ...
    render() {
        ...
        return (h(Host, { class: "mobile-shops-and-more" }, items.map((item) => {
            let overlayRef;
            return (h("div", { class: "shops-and-more-container" }, h("phn-shops-and-more-item", { item: item, class: "shops-and-more-item", tabindex: "0", onClick: () => this.showActiveDrawer(overlayRef, item), onKeyDown: (event) => this.handlePressEnterKey(event, overlayRef, item) }), h("phn-drawer-shops-and-more", { headline: item.Items && item.Items.length === 1 ? item.Text : '', item: item.Items && item.Items.length === 1 ? item.Items[0] : item, class: "shops-and-more-overlay", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, ref: (el) => (overlayRef = el) })));
        })));
    }
}
...
class MobileShopsAndMore$1 {
    ...
    render() {
        ...
        return (h(Host, { class: "mobile-shops-and-more" }, items.map((item, index) => {
            return (h("div", { class: "shops-and-more-container" }, h("phn-shops-and-more-item", { item: item, class: 'shops-and-more-item shops-and-more-item-' + index, tabindex: "0", onClick: (event) => this.showDrawer(event, item, index), onKeyDown: (event) => this.handleKeyDown(event, item, index) })));
        })));
    }
}
...
class Myporsche {
    ...
    renderLoggedOutComponent() {
        return (h("p-link-pure", { class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                ...
                this.sendMetaFunctionClickAnalyticsEvent(linkItem);
            }, size: "inherit", icon: "user" }, this.myporscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.getSubTextForUser())));
    }
    ...
    renderLoggedInComponent() {
        ...
        const myPorscheDrawer = drawerRestructure ? (h("phn-myporsche-drawer-2", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })) : (h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, unreadMessagesCount: unreadMessagesCount }));
        return [
            myPorscheDrawer,
            h("phn-myporsche-flyout", { class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount })
        ];
    }
    render() {
        const loggedInState = navContentStore.get('loggedInState');
        return (h(Host, null, loggedInState === LOGGED_OUT_USER_STATUS
...
class MyPorscheDrawer {
    ...
    render() {
        let drawerRef;
        return (h(Host, null, h("phn-button-extended", { class: "drawer-trigger", icon: "arrow-head-right", onClick: () => this.openDrawer(drawerRef), onKeyDown: (event) => this.handlePressEnterKey(event, drawerRef), cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-icon", { name: "user", size: "small" }), h("span", { class: "drawer-trigger-label" }, this.myPorscheText, h("p-text", { class: "login-status", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus))), h("phn-myporsche-items-drawer", { class: "drawer--closed", ref: (el) => (drawerRef = el), closeActiveDrawer: this.closeActiveDrawer })));
    }
}
...
class MyPorscheDrawer$1 {
    ...
    openDrawer() {
        const phnDrawerCarSeriesModelOverview2 = (h("phn-myporsche-items-drawer-2", { slot: "content", myPorscheText: this.myPorscheText }));
        const parent = navStateStore.get('activeDrawerContent');
        const currentParent = navStateStore.get('parentDrawerContent');
        navStateStore.set('activeDrawerContent', phnDrawerCarSeriesModelOverview2);
        navStateStore.set('parentDrawerContent', [parent, ...currentParent]);
    ...
    render() {
        return (h(Host, null, h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: () => this.openDrawer(), cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-icon", { name: "user", size: "small" }), h("span", { class: "myporsche-drawer-trigger-label" }, this.myPorscheText, h("p-text", { class: "login-status", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)))));
    }
}
...
class MyPorscheFlyout {
    ...
    render() {
        return (h(Host, null, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, tabindex: "0", onKeyDown: this.keyDownHandler }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items" }, h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
}
...
class MyPorscheItems {
    ...
    render() {
        return (h(Host, null, h("phn-list-item", { class: "myporsche-list-item", item: this.getMyPorscheItemFromTemplateAsLinkItem('carsandservices'), onKeyDown: this.handlePressShiftTabKey }), h("phn-messages-link", { class: "myporsche-list-item", item: this.getMyPorscheItemFromTemplateAsLinkItem('messages') }), h("phn-list-item", { class: "myporsche-list-item", item: this.getMyPorscheItemFromTemplateAsLinkItem('accountadministration') }), h("hr", null), h("phn-list-item", { class: "myporsche-list-item logout", item: this.getMyPorscheItemFromTemplateAsLinkItem('logout'), onKeyDown: this.handlePressTabKey })));
    }
}
...
class MyPorscheItemsDrawer {
    ...
    render() {
        return (h(Host, { class: "drawer-level-2-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", buttonId: this.getValueForField(PHRASEID_FIELD_NAME), text: this.getValueForField(TEXT_FIELD_NAME), onClick: () => this.hide() }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: "My Porsche", class: "drawer-headline" }), h("phn-myporsche-items", null))));
    }
    get hostElement() { return getElement(this); }
}
...
class PreviewBadge {
    ...
    render() {
        return (h(Host, null, h("p-text", { theme: "dark", size: "x-small" }, this.versionString)));
    }
}
...
class ShopsAndMoreItem {
    ...
    render() {
        return (h(Host, null, h("phn-button-extended", { class: "shops-and-more-item-drawer", icon: "arrow-head-right" }, this.item.Text), h("phn-button-extended", { class: "shops-and-more-item-mega-menu" }, this.item.Text)));
    }
}
...
class ShopsAndMoreOverview {
    ...
    renderLinkGroup(_items, _title) {
        return (h("div", { class: "link-group" }, h("phn-headline", { text: _title, class: "head-line" }), h("div", { class: "list-item-group" }, _items.map((linkItem) => {
...
export { BackButton as phn_back_button, BurgerButton as phn_burger_button, ButtonExtended as phn_button_extended, CarFurtherLinks as phn_car_further_links, CarMetaFunctionalities as phn_car_meta_functionalities, CarModel as phn_car_model, CarModelList as phn_car_model_list, CarSeries as phn_car_series, CarSeriesList as phn_car_series_list, CarSeriesModelOverview as phn_car_series_model_overview, CloseButton as phn_close_button, Crest as phn_crest, DealerSearch as phn_dealer_search, DrawerCarSeriesModelOverview as phn_drawer_car_series_model_overview, DrawerCarSeriesModelOverview$1 as phn_drawer_car_series_model_overview_2, DrawerShopsAndMore as phn_drawer_shops_and_more, DrawerShopsAndMore$1 as phn_drawer_shops_and_more_2, Header as phn_header, Headline as phn_headline, ListItem as phn_list_item, MegaFlyOutOverlay as phn_mega_fly_out_overlay, MenuDesktopLevel1 as phn_menu_desktop_level_1, MenuDrawer as phn_menu_drawer, MenuDrawerLevel1 as phn_menu_drawer_level_1, MenuMobileLevel1 as phn_menu_mobile_level_1, MessagesLink as phn_messages_link, MetaFunctionalities as phn_meta_functionalities, MobileCarSeriesList as phn_mobile_car_series_list, MobileCarSeriesList$1 as phn_mobile_car_series_list_2, MobileLayout as phn_mobile_layout, MobileShopsAndMore as phn_mobile_shops_and_more, MobileShopsAndMore$1 as phn_mobile_shops_and_more_2, Myporsche as phn_myporsche, MyPorscheDrawer as phn_myporsche_drawer, MyPorscheDrawer$1 as phn_myporsche_drawer_2, MyPorscheFlyout as phn_myporsche_flyout, MyPorscheItems as phn_myporsche_items, MyPorscheItemsDrawer as phn_myporsche_items_drawer, MyPorscheItemsDrawer$1 as phn_myporsche_items_drawer_2, PreviewBadge as phn_preview_badge, ShopsAndMore as phn_shops_and_more, ShopsAndMoreItem as phn_shops_and_more_item, ShopsAndMoreOverview as phn_shops_and_more_overview };
