import { g as getRenderingRef, f as forceUpdate, r as registerInstance, h, H as Host, c as getAssetPath, e as getElement, i as createEvent } from './index-866367c9.js';
...
const BackButton = class {
    ...
    render() {
        return (h(Host, null, h("p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", "aria-label": "Back to Menu", onClick: this.sendMenuBackClickEventAnalyticsEvent }, this.text)));
    }
};
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (h(Host, null, h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: "burger-button", onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null, "aria-haspopup": "dialog" }, h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines", role: "img", "aria-label": "burger button" }), hasUnreadMessages && h("span", { class: "myporsche-unread-messages-indicator" })), h("div", { style: navStateStore.get('crestLoaded') ? this.hiddenStyle : {}, class: "burger-button-skeleton" })));
    }
};
...
const CarFurtherLinks = class {
    ...
    renderItem(item) {
        return (h("p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: () => this.sendNavigationClickAnalyticsEvent(item), role: "button" }, item.Text));
    }
    render() {
...
const Crest = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, null, h("a", { class: "crest", style: this.contentLoaded() ? {} : hiddenStyle, onClick: () => this.sendCrestClickAnalyticsEvent(), href: this.getCrestLink() }, h("p-marque", { class: "marque" })), h("div", { class: "marque-bone", style: this.contentLoaded() ? hiddenStyle : {} }, h("span", { class: "crest-bone" }), h("span", { class: "label-bone" }))));
    }
    get el() { return getElement(this); }
};
...
const DealerSearch = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, { class: "dealer-search" }, h("p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, href: this.dealerSearchLink, size: "inherit", icon: "pin", class: 'dealer-search-link', onClick: () => {
                const linkItem = {
...
const DesktopShopAndMoreItem = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, null, h("p-text", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, class: "desktop-shop-and-more-item-text", color: "inherit", size: "inherit", tag: "div" }, this.itemText), h("div", { class: "desktop-shop-and-more-item-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
};
...
const ListItem = class {
    ...
    renderLinkItem(linkItem) {
        return (h(Host, null, h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text))));
    }
...
const Myporsche = class {
    ...
    renderLoadingComponent() {
        return (h("p-button-pure", { class: "myporsche-loading", loading: "true", size: "inherit", "aria-label": "myporsche loading", style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle }, this.myporscheText));
    }
...
const MyPorscheDrawer = class {
    ...
    render() {
        return (h(Host, null, h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: this.openDrawer, cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ...
                : 'myporsche-unread-messages-indicator hidden' }), h("p-icon", { color: "inherit", name: "user", size: "small" }), h("span", { class: "myporsche-drawer-trigger-label" }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)))));
    }
};
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button", "aria-label": "open myporsche flyout" }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
