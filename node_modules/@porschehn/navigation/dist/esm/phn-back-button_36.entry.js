import { g as getRenderingRef, f as forceUpdate, r as registerInstance, h, H as Host, c as getAssetPath, e as getElement, i as createEvent } from './index-f8290f1d.js';
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (h(Host, null, h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: `burger-button ${isDrawerOpen ? 'hide-button' : ''}`, onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null }, h("p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" }), hasUnreadMessages && h("span", { class: "myporsche-unread-messages-indicator" })), h("div", { style: navStateStore.get('crestLoaded') ? this.hiddenStyle : {}, class: "burger-button-skeleton" })));
    }
};
...
const MenuDrawer = class {
    ...
    render() {
        ...
        return (h(Host, { class: "drawer-trigger", tabindex: "-1" }, h("div", { class: "menu-drawer" }, h("div", { class: "menu-drawer-container", onClick: this.close }, h("div", { class: "menu-drawer-content", onClick: this.stopClickEvent }, h("div", { class: "menu-drawer-content-wrapper" }, h("div", { class: backAndCloseClass }, !this.isFirstDrawer && (h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), h("p-button-pure", { class: "close-button", icon: "close", hideLabel: "true", size: "small", onClick: this.close })), h("slot", { name: "content" })))))));
    }
    get el() { return getElement(this); }
};
...
const MobileLayout = class {
    ...
    render() {
        return (h(Host, null, h("phn-burger-button", { class: "burger-button", onClick: this.showMobileLevel1 }), navStateStore.get('drawerContentStack').map((drawer, index) => {
            return (h("phn-menu-drawer", { key: index, backButton: drawer.backButton, mobileLayout: this.mobileLayoutElement }, drawer.content));
        })));
    }
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button" }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
