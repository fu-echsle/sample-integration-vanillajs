...
const ButtonExtended = class {
    ...
    render() {
        return (h("button", { tabindex: "-1" }, h("p-text", { color: "inherit", size: "inherit", tag: "div" }, h("slot", null)), this.icon ? h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
};
...
const CarSeries = class {
    ...
    render() {
        ...
        return (h("div", { class: "car-series" }, h("picture", null, h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), h("img", { alt: this.text })), h("p", { class: "car-series-text" }, this.text)));
    }
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (h(Host, { tabindex: "0" }, h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items" }, h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
