import { r as registerInstance, g as getElement, c as getRenderingRef, f as forceUpdate, h, H as Host, d as getAssetPath, e as createEvent } from './index-5a8cb5da.js';
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (h(Host, { class: "burger-button", onClick: () => this.sendMoreClickAnalyticsEvent() }, h("p-text", { size: "inherit", class: "burger-button-text" }, text), h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    }
};
...
const ButtonExtended = class {
    ...
    render() {
        return (h("button", null, h("p-text", { color: "inherit", size: "inherit", tag: "div" }, h("slot", null)), this.icon ? h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
};
...
const CarModel = class {
    ...
    render() {
        const path = getAssetPath(`${config(this.env).ASSETS_URL}/model-assets`);
        return (h("a", { class: "car-model", href: this.link }, h("picture", { class: "model-pic" }, h("source", { type: "image/png", media: "(min-width: 1920px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), h("img", { src: `${path}/1366/${this.image}.png`, alt: this.text })), h("div", { class: "model-text" }, this.text)));
    }
...
const CarSeries = class {
    ...
    render() {
        const path = getAssetPath(`${config(this.env).ASSETS_URL}/series-assets`);
        return (h("div", { class: "car-series" }, h("picture", null, h("source", { type: "image/png", media: "(min-width: 1920px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), h("img", { src: `${path}/1366/${this.image}.png`, alt: this.text })), h("p", { class: "car-series-text" }, this.text)));
    }
...
const CloseButton = class {
    ...
    render() {
        return (h("div", { class: "close-button-wrapper", onClick: (e) => {
...
const Crest = class {
    ...
    render() {
        return (h("a", { class: "crest", onClick: () => this.sendCrestClickAnalyticsEvent(), href: "//www.porsche.com/swiss/de/" }, h("p-marque", { class: "marque" })));
    }
};
    ...
    render() {
        ...
        return (h("div", { class: `drawer-shops-and-more drawer-level-${this.level}-item-scroll drawer-level-${this.level}-item` }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", onClick: () => this.hideDrawer(), buttonId: buttonId, text: buttonText }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: _headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index) => {
                let innerOverlayEl;
                return (h("div", null, h("phn-list-item", { item: item, onClick: () => {
                        if (!item.IsLinkItem) {
...
const Header = class {
    ...
    render() {
        ...
        return (h("div", { class: "header-container" }, h("div", { class: "header limit-stretch" }, h("div", { class: "crest-burger-btn-container" }, h("phn-crest", { class: "crest" }), h("phn-burger-button", { class: "burger-button", onClick: () => menuDrawerLevel1.show() })), h(StateTunnel.Provider, { state: this.appData }, h("div", { class: "menu-container" }, h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), h("phn-menu-drawer-level-1", { ref: (el) => (menuDrawerLevel1 = el) }))), h("div", { class: "header-border" }), this.env === 'preview' && h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), this.isFeature1Enabled && (h("div", null, h("br", null), h("br", null), "Booyah!!! Enabled feature 1!!!"))));
    }
...
const ListItem = class {
    ...
    renderTextItem(textItem) {
        return (h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(textItem) }, h("span", { class: "list-item-text" }, textItem.Text)));
    }
    render() {
...
const MegaFlyOutOverlay = class {
    ...
    render() {
        return (h(Host, { onKeyDown: this.handlePressEnterKey }, h("div", { class: "mega-fly-out-overlay" }, h("div", { tabindex: "0", onFocus: this.handleFocus, class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el) }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
const MenuDesktopLevel1 = class {
    ...
    render() {
        ...
        return (h("div", { class: "menu-desktop-level-1" }, h("div", { class: "menu-series-shop-and-more", onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave() }, h("phn-car-series-list", { carSeries: seriesList, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }), h("phn-shops-and-more", { items: items, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler })), h("div", { class: "menu-separator" }), h("phn-meta-functionalities", { class: "metafunctionalities" })));
    }
};
...
const MenuDrawerLevel1 = class {
    ...
    render() {
        const seriesList = !this.seriesList ? DEFAULT_SERIES_LIST : this.seriesList;
        const items = this.getItems();
        return (h("div", { class: "menu-drawer-level-1 drawer-level-1-item" }, h("div", { class: "drawer-level-1 drawer-level-1-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-close" }, h("phn-close-button", { class: "close-button" })), h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list", { ref: (el) => (this.mobileCarSeriesListElement = el), class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-mobile-shops-and-more", { items: items, class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return getElement(this); }
};
...
const MobileCarSeriesList = class {
    ...
    render() {
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index) => (h("div", { class: "mobile-car-series" }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image, onClick: () => this.showCarSubnavigation(index) }), h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return getElement(this); }
};
...
const MobileShopsAndMore = class {
    ...
    render() {
        return (h(Host, { class: "mobile-shops-and-more" }, this.items.map((item) => {
            let overlayRef;
            return (h("div", { class: "shops-and-more-container" }, h("phn-shops-and-more-item", { item: item, class: "shops-and-more-item", onClick: () => {
...
const Myporsche = class {
    ...
    renderLoggedOutComponent() {
        return (h("p-link-pure", { class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                ...
                this.sendMetaFunctionClickAnalyticsEvent(linkItem);
            }, size: "inherit", icon: "user" }, this.myporscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.subText)));
    }
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (h(Host, null, h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive }, this.myPorscheText, h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items" }, h("phn-myporsche-items", null))) : null));
    }
};
...
const MyPorscheItemsDrawer = class {
    ...
    render() {
        return (h(Host, { class: "drawer-level-2-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-back-and-close" }, h("phn-back-button", { class: "back-button", buttonId: this.menu[0].PhraseId, text: this.menu[0].Text, onClick: () => this.hide() }), h("phn-close-button", { class: "close-button" })), h("phn-headline", { text: "My Porsche", class: "drawer-headline" }), h("phn-myporsche-items", null))));
    }
    get hostElement() { return getElement(this); }
};
...
const ShopsAndMore = class {
    ...
    render() {
        return (h("div", { class: "shops-and-more" }, this.items.map((item) => {
            return (h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler }, h("phn-shops-and-more-item", { slot: "button", item: item, class: "shops-and-more-item" }), h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    }
};
...
const ShopsAndMoreItem = class {
    ...
    render() {
        return (h(Host, null, h("phn-button-extended", { class: "shops-and-more-item-drawer", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(this.item) }, this.item.Text), h("phn-button-extended", { class: "shops-and-more-item-mega-menu" }, this.item.Text)));
    }
};
...
export { ContextConsumer as context_consumer, BackButton as phn_back_button, BurgerButton as phn_burger_button, ButtonExtended as phn_button_extended, CarFurtherLinks as phn_car_further_links, CarMetaFunctionalities as phn_car_meta_functionalities, CarModel as phn_car_model, CarModelList as phn_car_model_list, CarSeries as phn_car_series, CarSeriesList as phn_car_series_list, CarSeriesModelOverview as phn_car_series_model_overview, CloseButton as phn_close_button, Crest as phn_crest, DealerSearch as phn_dealer_search, DrawerCarSeriesModelOverview as phn_drawer_car_series_model_overview, DrawerShopsAndMore as phn_drawer_shops_and_more, Header as phn_header, Headline as phn_headline, ListItem as phn_list_item, MegaFlyOutOverlay as phn_mega_fly_out_overlay, MenuDesktopLevel1 as phn_menu_desktop_level_1, MenuDrawerLevel1 as phn_menu_drawer_level_1, MetaFunctionalities as phn_meta_functionalities, MobileCarSeriesList as phn_mobile_car_series_list, MobileShopsAndMore as phn_mobile_shops_and_more, Myporsche as phn_myporsche, MyPorscheDrawer as phn_myporsche_drawer, MyPorscheFlyout as phn_myporsche_flyout, MyPorscheItems as phn_myporsche_items, MyPorscheItemsDrawer as phn_myporsche_items_drawer, PreviewBadge as phn_preview_badge, ShopsAndMore as phn_shops_and_more, ShopsAndMoreItem as phn_shops_and_more_item, ShopsAndMoreOverview as phn_shops_and_more_overview };
