import { g as getRenderingRef, f as forceUpdate, r as registerInstance, h, H as Host, i as getAssetPath, j as getElement, c as createCommonjsModule, e as commonjsGlobal, k as createEvent } from './_commonjsHelpers-b0a15113.js';
...
const BackButton = class {
    ...
    render() {
        return (h(Host, null, h("phn-p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", "aria-label": "Back to Menu", onClick: this.sendMenuBackClickEventAnalyticsEvent }, this.text)));
    }
};
...
const BurgerButton = class {
    ...
    render() {
        ...
        return (h(Host, null, h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: "burger-button", onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null, "aria-haspopup": "dialog" }, h("phn-p-text", { size: "inherit", class: "burger-button-text" }, this.getText()), h("phn-p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines", role: "img", "aria-label": "burger button" }), hasUnreadMessages && h("span", { class: "myporsche-unread-messages-indicator" })), h("div", { style: navStateStore.get('crestLoaded') ? this.hiddenStyle : {}, class: "burger-button-skeleton" })));
    }
};
...
const ButtonExtended = class {
    ...
    render() {
        return (h("button", { tabindex: this.cancelTabIndex ? -1 : 0 }, h("phn-p-text", { color: "inherit", size: "inherit", tag: "div" }, h("slot", null)), this.icon ? h("phn-p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
};
...
const CarFrontshot = class {
    ...
    render() {
        const path = getAssetPath(`${config(navContentStore.get('env')).ASSETS_URL}/frontshot-assets`);
        const imageFileEnding = 'jpg';
        const imageType = 'jpeg';
        return (h("picture", { "aria-hidden": "true" }, h("source", { type: `image/${imageType}`, media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.${imageFileEnding}, ${path}/1920/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 1024px)", srcSet: `${path}/1366/${this.image}.${imageFileEnding}, ${path}/1366/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 768px)", srcSet: `${path}/1920/${this.image}.${imageFileEnding}, ${path}/1920/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 0px)", srcSet: `${path}/375/${this.image}.${imageFileEnding}, ${path}/375/${this.image}@2x.${imageFileEnding} 2x` }), h("img", { src: `${path}/375/${this.image}.${imageFileEnding}`, class: "frontshot", alt: this.text })));
    }
...
const CarFurtherLinks = class {
    ...
    renderItem(item) {
        return (h("phn-p-link-pure", { href: item.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: () => this.sendNavigationClickAnalyticsEvent(item), role: "button" }, item.Text));
    }
    render() {
        return (h("div", { class: "car-further-links" }, h("div", { class: "car-further-links-wrapper" }, this.renderItem(this.items[0]), this.renderItem(this.items[1]))));
    }
};
...
const CarFurtherLinksV2 = class {
    ...
    render() {
        return (h("div", { class: "car-further-links" }, h("div", { class: this.isDesktop ? 'limit-stretch' : '' }, h("phn-p-grid", { direction: "row-reverse" }, h("phn-p-grid-item", { size: "{base: 12, l:3}" }, h("phn-p-link-pure", { href: this.furtherLinks.Link, icon: 'arrow-head-right', size: "inherit", class: "car-further-links-item", onClick: () => this.sendNavigationClickAnalyticsEvent(this.furtherLinks) }, this.furtherLinks.Text))))));
    }
};
...
const CarMetaFunctionalities = class {
    ...
    render() {
        return isFeatureEnabled(FEATURE_MODEL_META) ? (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map((item) => (h("phn-p-link-pure", { href: item.Link, icon: item.Icon, onClick: () => this.sendModelMetaFunctionAnalyticsEvent(item), size: "inherit", class: "car-meta-functionalities-item" }, item.Text)))))) : (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.renderItem('configurate', this.items[0], this.sendConfigureClickAnalyticsEvent), this.renderItem('compare', this.items[1], this.sendCompareClickAnalyticsEvent), this.renderItem('search', this.items[2], this.sendFindCarClickAnalyticsEvent))));
    }
};
...
const CarMetaFunctionalitiesV2 = class {
    ...
    render() {
        return (h("div", { class: "car-meta-functionalities" }, h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map((item) => (h("phn-p-link-pure", { class: "car-meta-functionalities-item", size: "inherit", href: item.Link, icon: item.Icon, onClick: () => this.sendModelMetaFunctionAnalyticsEvent(item) }, item.Text))))));
    }
};
...
const CarModel = class {
    ...
    render() {
        const path = getAssetPath(`${config(navContentStore.get('env')).ASSETS_URL}/model-assets`);
        const imageFileEnding = 'jpg';
        const imageType = 'jpeg';
        return (h("a", { class: "car-model", href: this.link }, h("picture", { class: "model-pic", "aria-hidden": "true" }, h("source", { type: `image/${imageType}`, media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.${imageFileEnding}, ${path}/1920/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.${imageFileEnding}, ${path}/1366/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.${imageFileEnding}, ${path}/1024/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.${imageFileEnding}, ${path}/768/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.${imageFileEnding}, ${path}/375/${this.image}@2x.${imageFileEnding} 2x` }), h("source", { type: `image/${imageType}`, media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.${imageFileEnding}, ${path}/320/${this.image}@2x.${imageFileEnding} 2x` }), h("img", { alt: this.text })), h("div", { class: "model-text" }, this.text)));
    }
...
const CarModelList = class {
    ...
    render() {
        return (h("div", { class: "car-model-list" }, h("div", { class: 'car-model-list-wrapper car-models-count-' + this.series.Models.length }, this.series.Models.map((model, index) => (h("div", { class: 'car-model car-model-' + index }, h("phn-car-model", { text: model.Name, image: model.Image, link: model.Link, onClick: () => this.sendModelClickAnalyticsEvent(model) })))))));
    }
};
...
const CarModelListV2 = class {
    ...
    render() {
        return (h("div", { class: "car-model-list" }, this.series.Models.map((model) => (h("phn-p-link", { variant: "tertiary", href: model.Link, icon: 'arrow-head-right', size: "inherit", class: "car-model-list-item", onClick: () => this.sendModelClickAnalyticsEvent(model) }, model.Name)))));
    }
};
...
const getSrcPath = (image) => {
    const path = getAssetPath(`${config(navContentStore.get('env')).ASSETS_URL}/series-assets`);
    const imageFileEnding = 'jpg';
...
const CarSeries = class {
    ...
    render() {
        ...
        return (h(Host, { class: "car-series" }, h("p", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, class: "car-series-text", "aria-label": `Porsche Model Series ${this.text}` }, this.text), h("div", { style: navStateStore.get('navigationLoaded') ? hiddenStyle : {}, class: "car-series-skeleton" })));
    }
...
const CarSeriesList = class {
    ...
    render() {
        ...
        return (h(Host, { role: "list" }, isFeatureEnabled(FEATURE_NEW_LEVEL2)
            ? carSeries.map((series) => (h("phn-mega-fly-out-overlay", { class: `car-series-fly-out-overlay overlay-trigger ${series.PhraseId}`, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler, screenReaderId: `car-series-mega-menu-${series.Name}`, role: "listitem" }, h("phn-car-series", { slot: "button", text: series.Name, image: series.Image }), h("phn-car-series-model-overview-v2", { slot: "content", series: series, isMobile: false }))))
            : carSeries.map((series) => (h("phn-mega-fly-out-overlay", { class: `car-series-fly-out-overlay overlay-trigger ${series.PhraseId}`, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler, screenReaderId: `car-series-mega-menu-${series.Name}`, role: "listitem" }, h("phn-car-series", { slot: "button", text: series.Name, image: series.Image }), h("phn-car-series-model-overview", { slot: "content", series: series }))))));
    }
};
...
const CarSeriesModelOverview = class {
    ...
    render() {
        return (h("div", { class: "car-series-model-overview" }, h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta, modelMetaItems: this.series.ModelMeta }), h("phn-car-model-list", { series: this.series }), h("phn-car-further-links", { items: this.series.Further })));
    }
};
...
const CarSeriesModelOverviewV2 = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: this.isDesktop ? 'limit-stretch' : '' }, h("phn-p-grid", { class: "car-series-model-overview" }, h("phn-p-grid-item", { size: "{base: 12, l:6}" }, h("phn-car-frontshot", { text: this.series.Name, image: this.series.Image })), this.isMobile ? (h("phn-p-grid-item", { size: "12" }, h("phn-p-text", { class: "series-headline", size: "large", weight: "semibold" }, this.series.Name))) : null, h("phn-p-grid-item", { size: "{base: 12, l:3}" }, h("phn-car-meta-functionalities-v2", { name: this.series.Name, items: this.series.Meta, modelMetaItems: this.series.ModelMeta })), h("phn-p-grid-item", { size: "{base: 12, l:3}" }, h("phn-car-model-list-v2", { series: this.series })))), navContentStore.get('furtherLinks') ? h("phn-car-further-links-v2", null) : null));
    }
};
...
const Crest = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, null, h("a", { class: "crest", style: this.contentLoaded() ? {} : hiddenStyle, onClick: () => this.sendCrestClickAnalyticsEvent(), href: this.getCrestLink() }, h("phn-p-marque", { class: "marque" })), h("div", { class: "marque-bone", style: this.contentLoaded() ? hiddenStyle : {} }, h("span", { class: "crest-bone" }), h("span", { class: "label-bone" }))));
    }
    get el() { return getElement(this); }
};
...
const DealerSearch = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, { class: "dealer-search" }, h("phn-p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, href: this.dealerSearchLink, size: "inherit", icon: "pin", class: 'dealer-search-link', onClick: () => {
                const linkItem = {
            ...
            } }, this.dealerSearchText), h("div", { class: "dealer-search-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
    get el() { return getElement(this); }
};
...
const DesktopShopAndMoreItem = class {
    ...
    render() {
        const hiddenStyle = { display: 'none' };
        return (h(Host, null, h("phn-p-text", { style: navStateStore.get('navigationLoaded') ? {} : hiddenStyle, class: "desktop-shop-and-more-item-text", color: "inherit", size: "inherit", tag: "div" }, this.itemText), h("div", { class: "desktop-shop-and-more-item-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
};
...
const DrawerCarSeriesModelOverview = class {
    ...
    render() {
        return (h("div", { class: "drawer-car-series-model-overview" }, h("div", { class: "drawer-container drawer-level-2-item-scroll" }, h("phn-headline", { text: this.series.Name }), h("phn-car-meta-functionalities", { name: this.series.Name, items: this.series.Meta, modelMetaItems: this.series.ModelMeta }), h("phn-car-model-list", { class: "car-model-list", series: this.series }), h("phn-car-further-links", { items: this.series.Further }))));
    }
};
...
const DrawerShopsAndMore = class {
    ...
    showDrawer(item, index) {
        const phnDrawerShopsAndMore = {
            ...
            content: (h("phn-drawer-shops-and-more", { headline: item.Text, item: item, class: 'shops-and-more-drawer-level-2 drawer-level-2 drawer-level-2-' + index, slot: "content" }))
        };
    ...
    render() {
        return (h("div", { class: `drawer-shops-and-more` }, h("div", { class: "drawer-container" }, h("phn-headline", { text: this.headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index) => {
                return (h("div", null, h("phn-list-item", { item: item, onClick: () => this.showDrawer(item, index), class: 'drawer-shops-and-more-item drawer-shops-and-more-item-' + index })));
            }))));
    }
};
...
const Header = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.accessTokenExpired = createEvent(this, "accessTokenExpired", 7);
    ...
    render() {
        return (h("header", { class: "header-container" }, isFeatureEnabled(FEATURE_ACCESSIBILITY_STATEMENT) && this.locale == 'en-US' ? (h("a", { class: "sr-only", href: this.accessibilityStatement.Link }, this.accessibilityStatement.Text)) : null, h("phn-p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onClick: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content"), h("div", { class: "header limit-stretch" }, h("div", { class: "crest-burger-btn-container" }, h("phn-crest", { class: "crest" }), h("phn-mobile-layout", null)), h("nav", { class: "menu-container" }, h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" }))), h("div", { class: "header-border" }), this.env === 'preview' && h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), h("div", { id: "main", tabindex: "-1", class: "main-content", onBlur: this.mainContentTab })));
    }
...
const Headline = class {
    ...
    render() {
        return h("h1", { class: "headline" }, this.text);
    }
};
...
const ListItem = class {
    ...
    renderLinkItem(linkItem) {
        return (h(Host, null, h("div", { class: "list-item-link" }, h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text))));
    }
    renderTextItem(textItem) {
        return (h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(textItem), cancelTabIndex: false }, h("span", { class: "list-item-text" }, textItem.Text)));
    }
    render() {
...
const MegaFlyOutOverlay = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "mega-fly-out-overlay" }, h("button", { class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active, onKeyDown: this.handleKeyDown, onClick: this.handleClick, "aria-expanded": this.active === 'active' ? 'true' : 'false', "aria-haspopup": "true", id: this.screenReaderId }, h("slot", { name: "button" })), h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el), onKeyDown: this.handleKeyDownContainer, "aria-labelledby": this.screenReaderId, "aria-hidden": this.active === 'active' ? 'false' : 'true', role: "region" }, h("div", { class: "mega-fly-out-overlay-content" }, h("slot", { name: "content" }))), this.active && h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
const MenuDesktopLevel1 = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.overlayEvent = createEvent(this, "overlayEvent", 7);
    ...
    render() {
        return (h("div", { class: "menu-desktop-level-1" }, h("div", { class: "menu-series-shop-and-more", onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave() }, h("phn-car-series-list", { showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }), h("phn-shops-and-more", { showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler })), navStateStore.get('navigationLoaded') ? h("div", { class: "menu-separator" }) : null, h("phn-meta-functionalities", { class: "metafunctionalities" })));
    }
};
...
const MenuDrawer = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.closeAllDrawers = createEvent(this, "closeAllDrawers", 7);
        this.menuOverlayOpen = createEvent(this, "menuOverlayOpen", 7);
    ...
    render() {
        ...
        return (h(Host, { class: "drawer-trigger", tabindex: "-1" }, h("div", { class: "menu-drawer" }, h("div", { class: "menu-drawer-container", onClick: this.close }, h("div", { class: "menu-drawer-content", onClick: this.stopClickEvent }, h("div", { class: "menu-drawer-content-wrapper", role: "dialog", "aria-modal": "true" }, h("span", { ref: (el) => (this.firstKeyboardAnchor = el), "aria-hidden": "true", tabindex: "-1" }), h("div", { class: backAndCloseClass }, !this.isFirstDrawer && (h("phn-back-button", { class: "back-button", onClick: this.handleBack, buttonId: backButtonId, text: backButtonText })), h("phn-p-button-pure", { class: "close-button", icon: "close", hideLabel: "true", "aria-label": "close dialog", size: "small", onClick: this.close }, "Close Dialog")), h("slot", { name: "content" }), h("span", { ref: (el) => (this.lastKeyboardAnchor = el), "aria-hidden": "true", tabindex: "-1" })))))));
    }
    get el() { return getElement(this); }
};
...
const MenuMobileLevel1 = class {
    ...
    render() {
        ...
        return (h("div", { class: "menu-mobile-level-1 mobile-level-1-item" }, h("div", { class: "mobile-level-1 mobile-level-1-item-scroll" }, h("div", { class: "drawer-container" }, h("div", { class: "drawer-content" }, h("phn-mobile-car-series-list", { class: "mobile-car-series-list", carSeries: seriesList }), h("phn-mobile-shops-and-more", null), h("phn-meta-functionalities", { class: "meta-functionalities" }))))));
    }
};
...
const MessagesLink = class {
    ...
    render() {
        ...
        return (h(Host, null, h("phn-p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" }, h("a", { href: this.item.Link, onClick: this.sendNavigationClickAnalyticsEvent }, h("span", { class: "link-text" }, this.item.Text), h("span", { class: unreadMessagesCount > 0 ? 'unread-messages-count' : 'unread-messages-count hidden' }, unreadMessagesCount)))));
    }
};
...
const MobileCarSeriesList = class {
    ...
    render() {
        return (h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index) => (h("div", { class: "mobile-car-series", key: index }, h("button", { class: "car-series-button", onClick: (event) => this.showDrawer(event, series, index) }, h("phn-car-series", { class: 'car-series car-series-' + index, text: series.Name, image: series.Image })))))));
    }
};
...
const MobileLayout = class {
    ...
    render() {
        return (h(Host, null, h("phn-burger-button", { class: "burger-button", onClick: this.showMobileLevel1 }), navStateStore.get('drawerContentStack').map((drawer, index, array) => {
    ...
    get mobileLayoutElement() { return getElement(this); }
};
...
const MobileShopAndMoreItem = class {
    ...
    render() {
        return (h(Host, { class: "mobile-shop-and-more-item" }, h("phn-button-extended", { class: "mobile-shop-and-more-item-drawer", icon: "arrow-head-right" }, this.item.Text)));
    }
};
...
const MobileShopsAndMore = class {
    constructor(hostRef) {
        ...
        this.showDrawer = (_, item) => {
            const phnDrawerShopsAndMore = {
                content: (h("phn-drawer-shops-and-more", { headline: item.Text, item: item.Items && item.Items.length === 1 ? item.Items[0] : item, slot: "content", class: "shops-and-more-drawer-level-1" }))
            };
            navStateStore.set('drawerContentStack', [...navStateStore.get('drawerContentStack'), phnDrawerShopsAndMore]);
            this.sendNavigationClickAnalyticsEvent(item);
        };
    ...
    render() {
        ...
        return (h(Host, { class: "mobile-shops-and-more" }, items.map((item, index) => {
            return (h("div", { class: "shops-and-more-container" }, h("phn-mobile-shop-and-more-item", { item: item, class: 'mobile-shop-and-more-item mobile-shop-and-more-item-' + index, tabindex: "0", onClick: (event) => this.showDrawer(event, item), onKeyDown: (event) => this.handleKeyDown(event, item) })));
        })));
    }
};
...
const Myporsche = class {
    ...
    renderLoggedOutComponent() {
        return (h("phn-p-link-pure", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                const linkItem = {
                ...
                this.sendMetaFunctionClickAnalyticsEvent(linkItem);
            }, size: "inherit", icon: "user" }, this.myporscheText, h("phn-p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.getSubTextForUser())));
    }
    renderLoadingComponent() {
        return (h("phn-p-button-pure", { class: "myporsche-loading", loading: "true", size: "inherit", "aria-label": "myporsche loading", style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle }, this.myporscheText));
    }
    renderLoggedInFlyout() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        return (h("phn-myporsche-flyout", { style: navStateStore.get('navigationLoaded') ? {} : this.hiddenStyle, class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount }));
    }
    renderLoggedInDrawer() {
        const unreadMessagesCount = navContentStore.get('unreadMessagesCount');
        return (h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.getSubTextForUser(), unreadMessagesCount: unreadMessagesCount }));
    }
    componentWillLoad() {
        this.isDesktop = isDesktop();
    }
    render() {
        const loggedInState = navContentStore.get('loggedInState');
        const hiddenStyle = { display: 'none' };
        return (h(Host, { class: "myporsche" }, this.renderMyPorsche(loggedInState), h("div", { class: "myporsche-skeleton", style: navStateStore.get('navigationLoaded') ? hiddenStyle : {} })));
    }
    get el() { return getElement(this); }
};
    ...
    constructor(hostRef) {
        ...
        this.openDrawer = () => {
            const phnMyporscheItemsDrawer = {
                content: h("phn-myporsche-items-drawer", { slot: "content", myPorscheText: this.myPorscheText })
            };
            navStateStore.set('drawerContentStack', [...navStateStore.get('drawerContentStack'), phnMyporscheItemsDrawer]);
        };
    }
    render() {
        return (h(Host, null, h("phn-button-extended", { class: "myporsche-drawer-trigger", icon: "arrow-head-right", onClick: this.openDrawer, cancelTabIndex: false }, h("span", { class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("phn-p-icon", { color: "inherit", name: "user", size: "small" }), h("span", { class: "myporsche-drawer-trigger-label" }, this.myPorscheText, h("phn-p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)))));
    }
};
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (h(Host, null, h("span", { "aria-hidden": "true", class: this.unreadMessagesCount > 0
                ? 'myporsche-unread-messages-indicator'
                : 'myporsche-unread-messages-indicator hidden' }), h("phn-p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, "aria-label": "open myporsche flyout" }, this.myPorscheText, h("phn-p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (h("div", { class: "myporsche-items", "aria-labelledby": this.screenReaderId, role: "region" }, h("phn-myporsche-items", { myPorscheCloseHandler: () => this.myPorscheCloseHandler() }))) : null));
    }
};
...
const MyPorscheItems = class {
    constructor(hostRef) {
        ...
        this.displayListItems = (item, index) => {
            if (item.PhraseId === `${MYPORSCHE_PHRASE_ID}.messages`) {
                if (index === 0) {
                    return (h("li", null, h("phn-messages-link", { class: "myporsche-list-item", item: item, onKeyDown: this.handlePressShiftTabKey })));
                }
                return (h("li", null, h("phn-messages-link", { class: "myporsche-list-item", item: item })));
            }
            if (index === 0) {
                return (h("li", null, h("phn-list-item", { class: "myporsche-list-item", item: item, onKeyDown: this.handlePressShiftTabKey })));
            }
            return (h("li", null, h("phn-list-item", { class: "myporsche-list-item", item: item })));
        };
    }
    ...
    render() {
        if (navContentStore.get('metafunctionalities').length > 0) {
            ...
            return (h("ul", null, nonStaticItems.map(this.displayListItems), h("hr", { "aria-hidden": "true" }), h("li", null, h("phn-list-item", { class: "myporsche-list-item logout", item: this.getMyPorscheItemFromTemplateAsLinkItem('logout'), onKeyDown: this.handlePressTabKey }))));
        }
        return null;
    }
};
...
const MyPorscheItemsDrawer = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "drawer-container" }, h("phn-headline", { text: this.myPorscheText, class: "drawer-headline" }), h("phn-myporsche-items", null))));
    }
};
...
const PreviewBadge = class {
    ...
    render() {
        return (h(Host, null, h("phn-p-text", { theme: "dark", size: "x-small" }, this.versionString)));
    }
};
...
const ShopsAndMore = class {
    ...
    render() {
        ...
        return (h("div", { class: "shops-and-more" }, items.map((item) => {
            return (h("phn-mega-fly-out-overlay", { class: "shops-and-more-overlay-trigger overlay-trigger", showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }, h("phn-desktop-shop-and-more-item", { slot: "button", itemText: item.Text, class: "desktop-shop-and-more-item" }), h("phn-shops-and-more-overview", { slot: "content", item: item })));
        })));
    }
};
...
const ShopsAndMoreOverview = class {
    ...
    renderLinkGroup(_items, _title) {
        return (h("div", { class: "link-group" }, h("phn-headline", { role: "heading", "aria-level": "2", text: _title, class: "head-line" }), h("ul", { class: "list-item-group" }, _items.map((linkItem) => {
            return (h("li", null, h("phn-list-item", { item: linkItem })));
        }))));
    }
    ...
    render() {
        return (h("div", { class: "shops-and-more-overview" }, h("div", { class: "shops-and-more-overview-content" }, hasLinkItemChild(this.item)
...
export { BackButton as phn_back_button, BurgerButton as phn_burger_button, ButtonExtended as phn_button_extended, CarFrontshot as phn_car_frontshot, CarFurtherLinks as phn_car_further_links, CarFurtherLinksV2 as phn_car_further_links_v2, CarMetaFunctionalities as phn_car_meta_functionalities, CarMetaFunctionalitiesV2 as phn_car_meta_functionalities_v2, CarModel as phn_car_model, CarModelList as phn_car_model_list, CarModelListV2 as phn_car_model_list_v2, CarSeries as phn_car_series, CarSeriesList as phn_car_series_list, CarSeriesModelOverview as phn_car_series_model_overview, CarSeriesModelOverviewV2 as phn_car_series_model_overview_v2, Crest as phn_crest, DealerSearch as phn_dealer_search, DesktopShopAndMoreItem as phn_desktop_shop_and_more_item, DrawerCarSeriesModelOverview as phn_drawer_car_series_model_overview, DrawerShopsAndMore as phn_drawer_shops_and_more, Header as phn_header, Headline as phn_headline, ListItem as phn_list_item, MegaFlyOutOverlay as phn_mega_fly_out_overlay, MenuDesktopLevel1 as phn_menu_desktop_level_1, MenuDrawer as phn_menu_drawer, MenuMobileLevel1 as phn_menu_mobile_level_1, MessagesLink as phn_messages_link, MetaFunctionalities as phn_meta_functionalities, MobileCarSeriesList as phn_mobile_car_series_list, MobileLayout as phn_mobile_layout, MobileShopAndMoreItem as phn_mobile_shop_and_more_item, MobileShopsAndMore as phn_mobile_shops_and_more, Myporsche as phn_myporsche, MyPorscheDrawer as phn_myporsche_drawer, MyPorscheFlyout as phn_myporsche_flyout, MyPorscheItems as phn_myporsche_items, MyPorscheItemsDrawer as phn_myporsche_items_drawer, PreviewBadge as phn_preview_badge, ShopsAndMore as phn_shops_and_more, ShopsAndMoreOverview as phn_shops_and_more_overview };
