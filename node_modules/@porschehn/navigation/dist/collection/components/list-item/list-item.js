...
export class ListItem {
    ...
    renderLinkItem(linkItem) {
        return (h("p-text", { class: "list-item-link", tag: "div", color: "inherit", size: "inherit" },
            h("a", { href: linkItem.Link, onClick: () => this.sendNavigationClickAnalyticsEvent(linkItem) }, linkItem.Text)));
    }
    renderTextItem(textItem) {
        return (h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(textItem) },
