 ...
 */
/* Internal functions, - interface or output might change in future releases! */
.shops-and-more-overview ul {
  margin: 0;
  padding: 0;
  text-indent: 0;
  list-style-type: none;
}
.shops-and-more-overview li {
  margin: 0;
  padding: 0;
  text-indent: 0;
  list-style-type: none;
}
.shops-and-more-overview .shops-and-more-overview-content {
  display: flex;
  flex-direction: row;
...
@media (min-width: 1300px) and (max-width: 1759px) {
  .shops-and-more-overview .shops-and-more-overview-content .link-group {
    margin-left: 3.75rem;
...
.shops-and-more-overview .shops-and-more-overview-content .link-group:nth-child(2) {
  margin: 0;
}
.shops-and-more-overview .shops-and-more-overview-content .link-group .list-item-group {
