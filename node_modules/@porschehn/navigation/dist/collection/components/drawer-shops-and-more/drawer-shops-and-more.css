...
.drawer-shops-and-more .drawer-container {
  padding-right: 7%;
  padding-left: 7%;
}
.drawer-shops-and-more .drawer-back-and-close {
  display: flex;
  flex-direction: row;
...
@media (min-width: 760px) {
  .drawer-shops-and-more .drawer-back-and-close .close-button {
    margin-right: -1.125rem;
  }
}
.drawer-shops-and-more .drawer-back-and-close .back-button {
