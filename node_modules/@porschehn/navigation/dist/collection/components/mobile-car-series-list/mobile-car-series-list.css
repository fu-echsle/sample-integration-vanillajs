...
'xxl': 1920px
*/
.mobile-car-series-list {
  display: flex;
  flex-wrap: wrap;
}
.mobile-car-series-list .mobile-car-series {
  width: 50%;
}
...
.mobile-car-series-list .mobile-car-series .car-series-button {
  display: flex;
  font-family: inherit;
  width: 100%;
  margin: 0;
...
.mobile-car-series-list .mobile-car-series .car-series-button::-moz-focus-inner {
  border: 0;
}
.mobile-car-series-list .mobile-car-series .car-series-button:focus {
  outline-width: 2px;
  outline-style: solid;
  outline-offset: 1px;
