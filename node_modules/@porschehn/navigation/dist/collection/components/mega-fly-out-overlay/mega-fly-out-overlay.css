...
@media (min-width: 1300px) {
  .mega-fly-out-overlay .mega-fly-out-overlay-button {
    display: flex;
    font-family: inherit;
    width: 100%;
    margin: 0;
  ...
  .mega-fly-out-overlay .mega-fly-out-overlay-button::-moz-focus-inner {
    border: 0;
  }
  .mega-fly-out-overlay .mega-fly-out-overlay-button:focus {
    outline-width: 2px;
    outline-style: solid;
    outline-offset: 1px;
    outline-color: #00d5b9;
  }
  .mega-fly-out-overlay .mega-fly-out-overlay-button-active {
    border-bottom: 2px solid #d5001c;
  }
  .mega-fly-out-overlay .mega-fly-out-overlay-button-active:hover {
    color: #d5001c;
  }
}
.mega-fly-out-overlay .mega-fly-out-overlay-container {
  display: block;
  visibility: hidden;
  width: 100%;
  position: absolute;
...
.mega-fly-out-overlay .mega-fly-out-overlay-container .mega-fly-out-overlay-content {
