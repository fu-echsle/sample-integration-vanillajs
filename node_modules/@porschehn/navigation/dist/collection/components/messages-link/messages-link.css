...
:host .list-item-link .unread-messages-count {
  height: 1rem;
  margin-left: 0.5rem;
  padding: 0 0.3125rem;
...
:host .list-item-link .unread-messages-count:hover {
  color: #fff;
}
:host .list-item-link .unread-messages-count.hidden {
  display: none;
}