...
export class CarMetaFunctionalities {
    ...
    render() {
        return isFeatureEnabled(FEATURE_MODEL_META) ? (h("div", { class: "car-meta-functionalities" },
            h("div", { class: "car-meta-functionalities-wrapper" }, this.modelMetaItems.map((item) => (h("p-link-pure", { href: item.Link, icon: item.Icon, onClick: () => this.sendModelMetaFunctionAnalyticsEvent(item), size: "inherit", class: "car-meta-functionalities-item" }, item.Text)))))) : (h("div", { class: "car-meta-functionalities" },
