...
'xxl': 1920px
*/
.drawer-car-series-model-overview {
  position: fixed;
  width: 100%;
  right: 0;
  bottom: 0;
...
.drawer-car-series-model-overview .drawer-container {
  right: 0;
  bottom: 0;
  top: 0;
  overflow-y: auto;
...
.drawer-car-series-model-overview .drawer-container .drawer-back-and-close {
  display: flex;
  flex-direction: row;
...
.drawer-car-series-model-overview .drawer-container .drawer-back-and-close .back-button {
  margin-left: -0.625rem;
}
@media (min-width: 760px) {
  .drawer-car-series-model-overview .drawer-container .drawer-back-and-close .close-button {
