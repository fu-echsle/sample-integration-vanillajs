...
@media (min-width: 1300px) and (max-width: 1759px) {
  :host .flyout-trigger:first-child {
...
@media (min-width: 1300px) {
  :host .flyout-trigger .login-status {
    position: absolute;
    top: 0;
...
:host .myporsche-items phn-myporsche-items {
  box-sizing: inherit;
  border: 1px solid #c9cacb;
  position: relative;
  background: #fff;
}
:host .myporsche-items phn-myporsche-items:before {
  content: "";
  width: 0;
  height: 0;
  position: absolute;
  ...
  border-color: transparent transparent #c9cacb;
}
:host .myporsche-items phn-myporsche-items:after {
  content: "";
  width: 0;
  height: 0;
  position: absolute;
...
@media (min-width: 1300px) {
  :host .myporsche-items phn-myporsche-items {
    padding: 0.625rem 1.5rem 2.25rem 1.5rem;
  }
}
...
:host .myporsche-unread-messages-indicator.hidden {
  display: none;
}