...
export class MyPorscheFlyout {
    ...
    render() {
        return (h(Host, null,
            ...
            h("p-button-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive, onKeyDown: this.keyDownHandler, "aria-haspopup": "true", "aria-expanded": this.isActive ? 'true' : 'false', onClick: this.handleClick, id: this.screenReaderId, role: "button" },
                this.myPorscheText,
