 ...
 */
/* Internal functions, - interface or output might change in future releases! */
:host.myporsche p-link-pure, :host.myporsche p-button-pure {
...
:host.myporsche p-link-pure .login-status, :host.myporsche p-button-pure .login-status {
  margin-top: -0.25rem;
  font-size: 0.75rem;
}
@media (min-width: 760px) and (max-width: 999px) {
...
:host.myporsche .myporsche-logged-in {
  padding: 0.875rem 0 0.875rem 0;
  border-bottom: 1px solid #c9cacb;
}
@media (min-width: 760px) and (max-width: 999px) {
...
@media (min-width: 1300px) {
  :host.myporsche .myporsche-skeleton {
    width: 8rem;
    margin-top: 0.125rem;
    width: 6.375rem;
    height: 0.875rem;
