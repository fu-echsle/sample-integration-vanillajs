...
.menu-desktop-level-1 .menu-series-shop-and-more {
  display: inline-flex;
}
.menu-desktop-level-1 .menu-separator {
  width: 1px;
  height: 2.375rem;
...
.menu-desktop-level-1 .metafunctionalities {
  padding-top: 1.3125rem;
}
@media (-ms-high-contrast: none) and (min-width: 1300px) and (max-width: 1759px) {
  .menu-desktop-level-1 .metafunctionalities {
    flex: 1;
  }
}
