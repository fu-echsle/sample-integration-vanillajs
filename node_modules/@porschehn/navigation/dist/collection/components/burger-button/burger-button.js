...
export class BurgerButton {
    ...
    render() {
        ...
        return (h(Host, null,
            h("button", { style: navStateStore.get('crestLoaded') ? {} : this.hiddenStyle, class: "burger-button", onClick: hasMenuContent ? this.sendMoreClickAnalyticsEvent : null, "aria-haspopup": "dialog" },
                h("phn-p-text", { size: "inherit", class: "burger-button-text" }, this.getText()),
                h("phn-p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines", role: "img", "aria-label": "burger button" }),
