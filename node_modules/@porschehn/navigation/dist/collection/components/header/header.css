...
.header .crest-burger-btn-container {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.header .crest-burger-btn-container .crest {
  z-index: 1;
...
.header .menu-container .menu-desktop-level-1 {
  flex: 1;
}
...
phn-p-button.skip-content.focused {
  outline-width: 2px;
  outline-style: solid;
  outline-offset: 1px;
  outline-color: currentColor;
