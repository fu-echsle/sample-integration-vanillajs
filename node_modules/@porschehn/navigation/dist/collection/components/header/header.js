...
import { DEFAULT_ENVIRONMENT, DEFAULT_LOCALE, LOADING_STATUS, LOGGED_IN_USER_NO_NAME_STATUS, LOGGED_OUT_USER_STATUS, REDACTED, VERSION } from '../../services/constants';
export class Header {
    constructor() {
