...
import { DEFAULT_ACCESSIBILITY_STATEMENT, DEFAULT_ENVIRONMENT, DEFAULT_LOCALE, FEATURE_ACCESSIBILITY_STATEMENT, LOADING_STATUS, LOGGED_OUT_USER_STATUS, REDACTED, VERSION } from '../../utility/constants';
...
export class Header {
    ...
    render() {
        return (h("header", { class: "header-container" },
            isFeatureEnabled(FEATURE_ACCESSIBILITY_STATEMENT) && this.locale == 'en-US' ? (h("a", { class: "sr-only", href: this.accessibilityStatement.Link }, this.accessibilityStatement.Text)) : null,
            h("phn-p-button", { variant: "primary", class: "skip-content", onfocus: this.addFocus, onClick: this.skipToMainContent, onblur: this.removeFocus }, "Skip to main content"),
