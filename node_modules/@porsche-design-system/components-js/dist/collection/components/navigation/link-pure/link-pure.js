...
import { calcLineHeightForElement, mapBreakpointPropToPrefixedClasses, prefix, transitionListener, insertSlottedStyles } from '../../../utils';
...
export class LinkPure {
    ...
    render() {
        ...
        return (h(Host, null,
            h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a'
                ? {
                    href: this.href,
                    target: this.target,
                ...
                : null), { ref: (el) => (this.linkTag = el) }),
                h("p-icon", { class: iconClasses, color: "inherit", size: "inherit", name: this.icon, source: this.iconSource, ref: (el) => (this.iconTag = el), "aria-hidden": "true" }),
    ...
    static get is() { return "p-link-pure"; }
    ...
    static get properties() { return {
        ...
        "active": {
            ...
            "docs": {
                "tags": [],
                "text": "Display link in active state."
            },
            "attribute": "active",
            "reflect": false,
            "defaultValue": "false"
