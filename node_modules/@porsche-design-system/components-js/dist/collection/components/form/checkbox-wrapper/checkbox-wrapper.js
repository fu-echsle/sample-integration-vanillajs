...
export class CheckboxWrapper {
    ...
    render() {
        ...
        const labelTextClasses = Object.assign({ [prefix('checkbox-wrapper__label-text')]: true, [prefix('checkbox-wrapper__label-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
