...
import { insertSlottedStyles, isTouchDevice, mapBreakpointPropToPrefixedClasses, prefix, transitionListener } from '../../../utils';
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            ...
            h("div", { id: `option-${key}`, role: "option", color: "inherit", class: {
                ...
                key === this.optionSelected && (h("p-icon", { class: prefix('select-wrapper__fake-option-icon'), "aria-hidden": "true", name: "check", color: "inherit" })))
        ]);
    }
