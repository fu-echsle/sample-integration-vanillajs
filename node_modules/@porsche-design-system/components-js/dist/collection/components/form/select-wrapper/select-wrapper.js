...
export class SelectWrapper {
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            (option.parentElement.tagName === 'OPTGROUP' && option.previousElementSibling === null) && (h("span", { class: cx(prefix('select-wrapper__fake-optgroup-label')), role: "presentation" }, option.closest('optgroup').label)),
