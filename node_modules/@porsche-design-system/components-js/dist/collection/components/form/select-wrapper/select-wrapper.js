    ...
    render() {
        ...
        return (h(Host, null,
            h("div", { class: labelClasses },
                h("label", null,
                    this.isLabelVisible &&
                        h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: () => this.labelClick() }, this.label || h("span", null,
                            h("slot", { name: 'label' }))),
                    this.isDescriptionVisible &&
                        h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description || h("span", null,
                            h("slot", { name: 'description' }))),
                    h("span", { class: fakeSelectClasses },
                        h("p-icon", { class: iconClasses, name: 'arrow-head-down', color: 'inherit' }),
                        h("slot", null))),
                !this.isTouch &&
                    h("div", { class: fakeOptionListClasses, role: 'listbox', "aria-activedescendant": `option-${this.optionSelected}`, tabIndex: -1, "aria-expanded": this.fakeOptionListHidden ? 'false' : 'true', "aria-labelledby": this.label, ref: el => this.fakeOptionListNode = el }, this.createFakeOptionList())),
            this.isMessageVisible &&
                h("p-text", { class: messageClasses, color: 'inherit', role: this.state === 'error' && 'alert' }, this.message || h("span", null,
                    h("slot", { name: 'message' })))));
    }
    get isLabelVisible() {
