...
.p-spinner {
  ...
  -webkit-animation-duration: var(--p-animation-duration__spinner);
          animation-duration: var(--p-animation-duration__spinner);
}
...
.p-spinner__fg {
  ...
  -webkit-animation: rotate var(--p-animation-duration__spinner) linear infinite, dash var(--p-animation-duration__spinner) ease-in-out infinite;
          animation: rotate var(--p-animation-duration__spinner) linear infinite, dash var(--p-animation-duration__spinner) ease-in-out infinite;
