...
:host(.p-text-list-item--unordered) {
  padding-left: 1.5rem !important;
}
:host(.p-text-list-item--unordered)::before {
  content: "" !important;
...
:host(.p-text-list-item--unordered.p-text-list-item--nested)::before {
  height: 1px !important;
  width: 0.5rem !important;
  top: calc(1.5em / 2) !important;
}

:host(.p-text-list-item--ordered) {
  padding-left: 2.5rem !important;
}
:host(.p-text-list-item--ordered)::before {
  position: absolute !important;
...
:host(.p-text-list-item--ordered-numbered)::before {
  content: counters(section, ".", decimal) "." !important;
}

:host(.p-text-list-item--ordered-alphabetically)::before {
  content: counters(section, ".", lower-latin) "." !important;
}

:host(.p-text-list-item--ordered-numbered.p-text-list-item--nested)::before {
  content: counters(section, ".", decimal) !important;
}

:host(.p-text-list-item--ordered-alphabetically.p-text-list-item--nested)::before {
  content: counters(section, ".", lower-latin) !important;
}