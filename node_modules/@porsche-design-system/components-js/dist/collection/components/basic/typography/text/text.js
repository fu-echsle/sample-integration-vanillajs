...
export class Text {
    ...
    render() {
        ...
        const textClasses = Object.assign({ [prefix('text')]: true, [prefix(`text--weight-${this.weight}`)]: true, [prefix(`text--align-${this.align}`)]: true, [prefix(`text--color-${this.color}`)]: true, [prefix('text--ellipsis')]: this.ellipsis, [prefix(`text--theme-${this.theme}`)]: this.color !== 'inherit' }, mapBreakpointPropToPrefixedClasses('text--size', this.size));
    ...
    static get properties() { return {
        ...
        "color": {
            ...
            "mutable": false,
            "complexType": {
                "original": "'brand' | 'default' | 'neutral-contrast-high' | 'neutral-contrast-medium' | 'neutral-contrast-low' | 'notification-success' | 'notification-warning' | 'notification-error' | 'notification-neutral' | 'inherit'",
                "resolved": "\"brand\" | \"default\" | \"inherit\" | \"neutral-contrast-high\" | \"neutral-contrast-low\" | \"neutral-contrast-medium\" | \"notification-error\" | \"notification-neutral\" | \"notification-success\" | \"notification-warning\"",
                "references": {}
            },
            "required": false,
            "optional": true,
