...
class CheckboxWrapper {
    ...
    render() {
        const labelClasses = classnames(prefix('checkbox-wrapper__label'));
        const fakeCheckboxClasses = classnames(prefix('checkbox-wrapper__fake-checkbox'), (this.checked || this.indeterminate) && prefix('checkbox-wrapper__fake-checkbox--checked'), this.disabled && prefix('checkbox-wrapper__fake-checkbox--disabled'), this.state !== 'none' && prefix(`checkbox-wrapper__fake-checkbox--${this.state}`));
        const iconClasses = classnames(prefix('checkbox-wrapper__icon'), (this.checked || this.indeterminate) && prefix('checkbox-wrapper__icon--checked'));
        const labelTextClasses = classnames(prefix('checkbox-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('checkbox-wrapper__label-text--disabled'));
        const messageClasses = classnames(prefix('checkbox-wrapper__message'), this.state !== 'none' && prefix(`checkbox-wrapper__message--${this.state}`));
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible && (h("p-text", { class: labelTextClasses, tag: "span", color: "inherit", onClick: this.labelClick }, this.label || (h("span", null, h("slot", { name: "label" }))))), h("span", { class: fakeCheckboxClasses }, h("p-icon", { class: iconClasses, name: this.indeterminate ? 'minus' : 'check', theme: "dark", size: "inherit", "aria-hidden": "true" }), h("slot", null))), this.isMessageVisible && (h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (h("span", null, h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
