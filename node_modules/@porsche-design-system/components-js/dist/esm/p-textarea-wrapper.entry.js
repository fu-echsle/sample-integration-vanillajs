...
const TextareaWrapper = class {
    ...
    render() {
        ...
        const descriptionTextClasses = cx(prefix('textarea-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__description-text--disabled'));
        ...
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, color: 'inherit', tag: 'span', onClick: () => this.labelClick() }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), this.isDescriptionVisible &&
            h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description ? this.description : h("span", null, h("slot", { name: 'description' }))), h("span", { class: fakeTextareaClasses }, h("slot", null))), this.isMessageVisible &&
