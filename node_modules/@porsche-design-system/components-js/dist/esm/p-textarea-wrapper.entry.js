...
class TextareaWrapper {
    ...
    render() {
        const labelClasses = classnames(prefix('textarea-wrapper__label'));
        const labelTextClasses = classnames(prefix('textarea-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__label-text--disabled'));
        const descriptionTextClasses = classnames(prefix('textarea-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__description-text--disabled'));
        const fakeTextareaClasses = classnames(prefix('textarea-wrapper__fake-textarea'), prefix(`textarea-wrapper__fake-textarea--${this.state}`), this.disabled && prefix('textarea-wrapper__fake-textarea--disabled'), this.readonly && prefix('textarea-wrapper__fake-textarea--readonly'));
        const messageClasses = classnames(prefix('textarea-wrapper__message'), prefix(`textarea-wrapper__message--${this.state}`));
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible && (h("p-text", { class: labelTextClasses, color: "inherit", tag: "span", onClick: this.labelClick }, this.label || (h("span", null, h("slot", { name: "label" }))))), this.isDescriptionVisible && (h("p-text", { class: descriptionTextClasses, tag: "span", color: "inherit", size: "x-small", onClick: this.labelClick }, this.description || (h("span", null, h("slot", { name: "description" }))))), h("span", { class: fakeTextareaClasses }, h("slot", null))), this.isMessageVisible && (h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (h("span", null, h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
