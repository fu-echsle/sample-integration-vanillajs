...
class SelectWrapper {
    ...
    render() {
        ...
        const labelTextClasses = Object.assign({ [prefix('select-wrapper__label-text')]: true, [prefix('select-wrapper__label-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('select-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const descriptionTextClasses = Object.assign({ [prefix('select-wrapper__description-text')]: true, [prefix('select-wrapper__description-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']));
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            ...
            h("div", { id: `option-${key}`, role: "option", color: "inherit", class: {
