...
class TextFieldWrapper {
    ...
    render() {
        const containerClasses = classnames(prefix('text-field-wrapper__container'));
        const labelClasses = classnames(prefix('text-field-wrapper__label'));
        const labelTextClasses = classnames(prefix('text-field-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('text-field-wrapper__label-text--disabled'));
        const descriptionTextClasses = classnames(prefix('text-field-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]), this.disabled && prefix('text-field-wrapper__description-text--disabled'));
        const fakeInputClasses = classnames(prefix('text-field-wrapper__fake-input'), this.state !== 'none' && prefix(`text-field-wrapper__fake-input--${this.state}`), this.disabled && prefix('text-field-wrapper__fake-input--disabled'), this.readonly && prefix('text-field-wrapper__fake-input--readonly'));
        const buttonClasses = classnames(prefix('text-field-wrapper__button'));
        const messageClasses = classnames(prefix('text-field-wrapper__message'), this.state !== 'none' && prefix(`text-field-wrapper__message--${this.state}`));
