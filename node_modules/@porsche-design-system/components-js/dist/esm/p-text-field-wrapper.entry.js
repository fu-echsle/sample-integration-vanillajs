...
class TextFieldWrapper {
    ...
    render() {
        ...
        const labelTextClasses = Object.assign({ [prefix('text-field-wrapper__label-text')]: true, [prefix('text-field-wrapper__label-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const descriptionTextClasses = Object.assign({ [prefix('text-field-wrapper__description-text')]: true, [prefix('text-field-wrapper__description-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]));
