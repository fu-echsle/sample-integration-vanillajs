import { r as registerInstance, d as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, e as transitionListener, o as handleButtonEvent, j as insertSlottedStyles, g as getElement } from './index-e8247a5d.js';
...
const TextFieldWrapper = class {
    ...
    render() {
        ...
        const descriptionTextClasses = cx(prefix('text-field-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('text-field-wrapper__description-text--disabled'));
        ...
        return (h(Host, null, h("div", { class: containerClasses }, h("label", { class: labelClasses }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: () => this.labelClick() }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), this.isDescriptionVisible &&
            h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description ? this.description : h("span", null, h("slot", { name: 'description' }))), h("span", { class: fakeInputClasses }, h("slot", null))), this.isPasswordToggleable &&
            h("button", { type: 'button', class: buttonClasses, onClick: () => this.togglePassword(), disabled: this.disabled }, h("p-icon", { name: this.showPassword ? 'view-off' : 'view', color: 'inherit' })), this.isInputTypeSearch &&
            h("button", { onClick: (event) => this.onSubmitHandler(event), type: 'submit', class: buttonClasses, disabled: this.disabled || this.readonly }, h("p-icon", { name: 'search', color: 'inherit' }))), this.isMessageVisible &&
