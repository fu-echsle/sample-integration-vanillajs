...
class Pagination {
    ...
    render() {
        ...
        const paginationClasses = Object.assign({ [prefix('pagination')]: true, [prefix(`pagination--theme-${this.theme}`)]: true }, mapBreakpointPropToPrefixedClasses('pagination--size', this.maxNumberOfPageLinks));
