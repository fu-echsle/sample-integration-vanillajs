import { r as registerInstance, c as prefix, m as mapBreakpointPropToPrefixedClasses, h, g as getElement } from './breakpointCustomizable-f03211e4.js';
...
class Button {
    ...
    render() {
        const buttonClasses = classnames(prefix('button'), prefix(`button--${this.variant}`), mapBreakpointPropToPrefixedClasses('button-', this.hideLabel, ['without-label', 'with-label']), prefix(`button--theme-${this.theme}`));
