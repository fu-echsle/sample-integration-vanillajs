...
class FlexItem {
    ...
    render() {
        const flexItemClasses = classnames(prefix('flex__item'), this.width !== 'auto' && mapBreakpointPropToPrefixedClasses('flex__item--width', this.width), this.offset !== 'none' && mapBreakpointPropToPrefixedClasses('flex__item--offset', this.offset), this.alignSelf !== 'auto' && mapBreakpointPropToPrefixedClasses('flex__item--align-self', this.alignSelf), this.grow !== 0 && mapBreakpointPropToPrefixedClasses('flex__item--grow', this.grow), this.shrink !== 1 && mapBreakpointPropToPrefixedClasses('flex__item--shrink', this.shrink), this.flex !== 'initial' && mapBreakpointPropToPrefixedClasses('flex__item-', this.flex));
