...
class Link {
    ...
    render() {
        ...
        const linkClasses = Object.assign({ [prefix('link')]: true, [prefix(`link--${this.variant}`)]: true, [prefix(`link--theme-${this.theme}`)]: true }, mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']));
