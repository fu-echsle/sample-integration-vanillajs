import { r as registerInstance, c as prefix, h, g as getElement } from './breakpointCustomizable-f03211e4.js';
...
class Headline {
    ...
    render() {
        ...
        const headlineClasses = classnames(prefix('headline'), prefix(`headline--variant-${this.variant}`), prefix(`headline--align-${this.align}`), prefix(`headline--color-${this.color}`), this.ellipsis && prefix('headline--ellipsis'), this.color !== 'inherit' && prefix(`headline--theme-${this.theme}`));
