...
class Divider {
    ...
    render() {
        const dividerClasses = classnames(prefix('divider'), prefix(`divider--color-${this.color}`), prefix(`divider--theme-${this.theme}`), mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
