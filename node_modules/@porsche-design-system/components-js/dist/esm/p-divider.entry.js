...
class Divider {
    ...
    render() {
        const dividerClasses = Object.assign({ [prefix('divider')]: true, [prefix(`divider--color-${this.color}`)]: true, [prefix(`divider--theme-${this.theme}`)]: true }, mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
