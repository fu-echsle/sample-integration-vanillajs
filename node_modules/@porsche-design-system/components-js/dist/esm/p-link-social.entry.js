...
const LinkSocial = class {
    ...
    render() {
        ...
        const linkClasses = cx(prefix('link-social'), mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']), prefix(`link-social--${this.icon}`), prefix(`link-social--theme-${this.theme}`));
...
export { LinkSocial as p_link_social };
