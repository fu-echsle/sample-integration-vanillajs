...
class LinkSocial {
    ...
    render() {
        ...
        const linkClasses = classnames(prefix('link-social'), mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']), prefix(`link-social--${this.icon}`), prefix(`link-social--theme-${this.theme}`));
