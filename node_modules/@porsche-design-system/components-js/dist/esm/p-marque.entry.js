...
const Marque = class {
    ...
    render() {
        ...
        return (h("picture", { class: marqueClasses }, h("source", { srcSet: buildSrcSet('medium'), media: "(min-width: 1300px)" }), h("source", { srcSet: buildSrcSet('small') }), h("img", { src: `${CDN_BASE_URL}/${manifestPath.medium['2x']}`, alt: "Porsche" })));
    }
};
