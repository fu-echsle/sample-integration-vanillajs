import { r as registerInstance, c as prefix, m as mapBreakpointPropToPrefixedClasses, h } from './breakpointCustomizable-f03211e4.js';
...
class Spinner {
    ...
    render() {
        const spinnerClasses = classnames(prefix('spinner'), mapBreakpointPropToPrefixedClasses('spinner--size', this.size), prefix(`spinner--theme-${this.theme}`));
