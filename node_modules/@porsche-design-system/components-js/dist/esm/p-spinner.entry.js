import { r as registerInstance, d as prefix, m as mapBreakpointPropToPrefixedClasses, h } from './index-e8247a5d.js';
...
const Spinner = class {
    ...
    render() {
        const spinnerClasses = cx(prefix('spinner'), mapBreakpointPropToPrefixedClasses('spinner--size', this.size), prefix(`spinner--theme-${this.theme}`));
