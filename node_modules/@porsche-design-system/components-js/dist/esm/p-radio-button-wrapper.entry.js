...
class RadioButtonWrapper {
    ...
    render() {
        ...
        const labelTextClasses = Object.assign({ [prefix('radio-button-wrapper__label-text')]: true, [prefix('radio-button-wrapper__label-text--disabled')]: this.disabled }, mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
