...
class RadioButtonWrapper {
    ...
    render() {
        const labelClasses = classnames(prefix('radio-button-wrapper__label'));
        const fakeRadioButtonClasses = classnames(prefix('radio-button-wrapper__fake-radio-button'), this.checked && prefix('radio-button-wrapper__fake-radio-button--checked'), this.disabled && prefix('radio-button-wrapper__fake-radio-button--disabled'), this.state !== 'none' && prefix(`radio-button-wrapper__fake-radio-button--${this.state}`));
        const labelTextClasses = classnames(prefix('radio-button-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('radio-button-wrapper__label-text--disabled'));
        const messageClasses = classnames(prefix('radio-button-wrapper__message'), this.state !== 'none' && prefix(`radio-button-wrapper__message--${this.state}`));
