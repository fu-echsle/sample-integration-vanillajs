...
class ButtonPure {
    ...
    render() {
        const buttonPureClasses = classnames(prefix('button-pure'), mapBreakpointPropToPrefixedClasses('button-pure--size', this.size), prefix(`button-pure--theme-${this.theme}`));
        const iconClasses = classnames(prefix('button-pure__icon'));
        const labelClasses = classnames(prefix('button-pure__label'), mapBreakpointPropToPrefixedClasses('button-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = classnames(prefix('button-pure__subline'), mapBreakpointPropToPrefixedClasses('button-pure__subline-', this.hideLabel, ['hidden', 'visible']));
