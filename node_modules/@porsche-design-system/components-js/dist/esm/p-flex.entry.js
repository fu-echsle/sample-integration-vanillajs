...
const Flex = class {
    ...
    render() {
        const flexClasses = cx(prefix('flex'), this.inline !== false && mapBreakpointPropToPrefixedClasses('flex-', this.inline, ['inline', 'default']), this.wrap !== 'nowrap' && mapBreakpointPropToPrefixedClasses('flex--wrap', this.wrap), this.direction !== 'row' && mapBreakpointPropToPrefixedClasses('flex--direction', this.direction), this.justifyContent !== 'flex-start' && mapBreakpointPropToPrefixedClasses('flex--justify-content', this.justifyContent), this.alignItems !== 'stretch' && mapBreakpointPropToPrefixedClasses('flex--align-items', this.alignItems), this.alignContent !== 'stretch' && mapBreakpointPropToPrefixedClasses('flex--align-content', this.alignContent));
        return (h(Host, { class: flexClasses }));
    }
};
Flex.style = flexCss;

export { Flex as p_flex };
