...
class LinkPure {
    ...
    render() {
        ...
        const linkPureClasses = Object.assign({ [prefix('link-pure')]: true, [prefix(`link-pure--theme-${this.theme}`)]: true, [prefix('link-pure--active')]: this.active }, mapBreakpointPropToPrefixedClasses('link-pure--size', this.size));
        const iconClasses = prefix('link-pure__icon');
        const labelClasses = Object.assign({ [prefix('link-pure__label')]: true }, mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = Object.assign({ [prefix('link-pure__subline')]: true }, mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
        return (h(Host, null, h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a'
            ? {
                href: this.href,
                target: this.target,
...
export { LinkPure as p_link_pure };
