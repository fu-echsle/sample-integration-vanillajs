import { r as registerInstance, e as transitionListener, d as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, j as insertSlottedStyles, g as getElement, f as calcLineHeightForElement } from './index-e8247a5d.js';
...
const LinkPure = class {
    ...
    render() {
        ...
        const linkPureClasses = cx(prefix('link-pure'), mapBreakpointPropToPrefixedClasses('link-pure--size', this.size), prefix(`link-pure--theme-${this.theme}`), this.active && prefix('link-pure--active'));
        const iconClasses = cx(prefix('link-pure__icon'));
        const labelClasses = cx(prefix('link-pure__label'), mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = cx(prefix('link-pure__subline'), mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
