...
class LinkPure {
    ...
    render() {
        ...
        const linkPureClasses = classnames(prefix('link-pure'), mapBreakpointPropToPrefixedClasses('link-pure--size', this.size), prefix(`link-pure--theme-${this.theme}`), this.active && prefix('link-pure--active'));
        const iconClasses = classnames(prefix('link-pure__icon'));
        const labelClasses = classnames(prefix('link-pure__label'), mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = classnames(prefix('link-pure__subline'), mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
