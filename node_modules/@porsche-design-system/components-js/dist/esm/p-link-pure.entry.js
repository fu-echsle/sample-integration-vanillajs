...
const LinkPure = class {
    ...
    render() {
        ...
        return (h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a' ? {
            href: this.href,
            target: this.target,
            download: this.download,
            rel: this.rel
        } : null), { ref: el => this.linkTag = el }), h("p-icon", { class: iconClasses, color: 'inherit', size: 'inherit', name: this.icon, source: this.iconSource, ref: el => this.iconTag = el, "aria-hidden": 'true' }), h("p-text", { class: labelClasses, tag: 'span', color: 'inherit', size: 'inherit', weight: this.weight }, h("slot", null))));
    }
