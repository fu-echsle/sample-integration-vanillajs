...
import { r as registerInstance, c as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, g as getElement } from './breakpointCustomizable-633ca215.js';
...
var SelectWrapper = /** @class */ (function () {
    ...
    SelectWrapper.prototype.render = function () {
        ...
        var _this = this;
        var labelClasses = prefix('select-wrapper__label');
        var labelTextClasses = Object.assign((_a = {}, _a[prefix('select-wrapper__label-text')] = true, _a[prefix('select-wrapper__label-text--disabled')] = this.disabled, _a), mapBreakpointPropToPrefixedClasses('select-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        var descriptionTextClasses = Object.assign((_b = {}, _b[prefix('select-wrapper__description-text')] = true, _b[prefix('select-wrapper__description-text--disabled')] = this.disabled, _b), mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']));
        var fakeSelectClasses = (_c = {},
            _c[prefix('select-wrapper__fake-select')] = true,
            _c[prefix('select-wrapper__fake-select--disabled')] = this.disabled,
            _c[prefix("select-wrapper__fake-select--" + this.state)] = this.state !== 'none',
            _c);
        var fakeOptionListClasses = (_d = {},
            _d[prefix('select-wrapper__fake-option-list')] = true,
            _d[prefix('select-wrapper__fake-option-list--hidden')] = this.fakeOptionListHidden,
            _d);
        var iconClasses = (_e = {},
            _e[prefix('select-wrapper__icon')] = true,
            _e[prefix('select-wrapper__icon--disabled')] = this.disabled,
            _e[prefix('select-wrapper__icon--opened')] = !this.fakeOptionListHidden,
            _e);
        var messageClasses = (_f = {},
            _f[prefix('select-wrapper__message')] = true,
            _f[prefix("select-wrapper__message--" + this.state)] = this.state !== 'none',
            _f);
    ...
    SelectWrapper.prototype.createFakeOptionList = function () {
        ...
        return Array.from(this.options).map(function (option, key) {
            var _a;
            return [
                option.parentElement.tagName === 'OPTGROUP' && option.previousElementSibling === null && (h("span", { class: prefix('select-wrapper__fake-optgroup-label'), role: "presentation" }, option.closest('optgroup').label)),
                h("div", { id: "option-" + key, role: "option", color: "inherit", class: (_a = {},
                        _a[prefix('select-wrapper__fake-option')] = true,
