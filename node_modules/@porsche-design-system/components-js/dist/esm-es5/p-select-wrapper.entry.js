...
import { r as registerInstance, c as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, g as getElement } from './breakpointCustomizable-f03211e4.js';
...
var SelectWrapper = /** @class */ (function () {
    function SelectWrapper(hostRef) {
        ...
        this.setOptionList = function () {
            ...
            _this.optgroups = _this.select.querySelectorAll('optgroup');
    ...
    SelectWrapper.prototype.render = function () {
        ...
        var _this = this;
        var labelClasses = classnames(prefix('select-wrapper__label'));
        var labelTextClasses = classnames(prefix('select-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('select-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), (_a = {}, _a[prefix('select-wrapper__label-text--disabled')] = this.disabled, _a));
        var descriptionTextClasses = classnames(prefix('select-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), (_b = {}, _b[prefix('select-wrapper__description-text--disabled')] = this.disabled, _b));
        var fakeSelectClasses = classnames(prefix('select-wrapper__fake-select'), (_c = {}, _c[prefix('select-wrapper__fake-select--disabled')] = this.disabled, _c), (_d = {}, _d[prefix("select-wrapper__fake-select--" + this.state)] = this.state !== 'none', _d));
        var fakeOptionListClasses = classnames(prefix('select-wrapper__fake-option-list'), (_e = {},
            _e[prefix('select-wrapper__fake-option-list--hidden')] = this.fakeOptionListHidden,
            _e));
        var iconClasses = classnames(prefix('select-wrapper__icon'), (_f = {}, _f[prefix('select-wrapper__icon--disabled')] = this.disabled, _f), (_g = {}, _g[prefix('select-wrapper__icon--opened')] = !this.fakeOptionListHidden, _g));
        var messageClasses = classnames(prefix('select-wrapper__message'), (_h = {},
            _h[prefix("select-wrapper__message--" + this.state)] = this.state !== 'none',
            _h));
        return (h(Host, null, h("div", { class: labelClasses }, h("label", null, this.isLabelVisible && (h("p-text", { class: labelTextClasses, tag: "span", color: "inherit", onClick: this.labelClick }, this.label || (h("span", null, h("slot", { name: "label" }))))), this.isDescriptionVisible && (h("p-text", { class: descriptionTextClasses, tag: "span", color: "inherit", size: "x-small", onClick: this.labelClick }, this.description || (h("span", null, h("slot", { name: "description" }))))), h("span", { class: fakeSelectClasses }, h("p-icon", { class: iconClasses, name: "arrow-head-down", color: "inherit" }), h("slot", null))), !this.isTouch && (h("div", { class: fakeOptionListClasses, role: "listbox", "aria-activedescendant": "option-" + this.optionSelected, tabIndex: -1, "aria-expanded": this.fakeOptionListHidden ? 'false' : 'true', "aria-labelledby": this.label, ref: function (el) { return (_this.fakeOptionListNode = el); } }, this.createFakeOptionList()))), this.isMessageVisible && (h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (h("span", null, h("slot", { name: "message" })))))));
    };
    ...
    SelectWrapper.prototype.createFakeOptionList = function () {
        ...
        return Array.from(this.options).map(function (option, key) {
            var _a;
            return [
                _this.optgroups.length > 0 && option === option.parentNode.firstChild && (h("span", { class: classnames(prefix('select-wrapper__fake-optgroup-label')), role: "presentation" }, option.closest('optgroup').label)),
                h("div", { id: "option-" + key, role: "option", color: "inherit", class: classnames(prefix('select-wrapper__fake-option'), (_a = {},
                        ...
                        _a)), onClick: function () { return (!_this.optionDisabled.includes(key) ? _this.setOptionSelected(key) : _this.select.focus()); }, "aria-selected": _this.optionSelected === key && 'true', "aria-disabled": _this.optionDisabled.includes(key) && 'true' }, h("span", null, option.text), key === _this.optionSelected && (h("p-icon", { class: classnames(prefix('select-wrapper__fake-option-icon')), "aria-hidden": "true", name: "check", color: "inherit" })))
            ];
        });
    };
