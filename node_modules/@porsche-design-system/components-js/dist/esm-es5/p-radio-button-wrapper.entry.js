...
var RadioButtonWrapper = /** @class */ (function () {
    ...
    RadioButtonWrapper.prototype.render = function () {
        var _this = this;
        var labelClasses = cx(prefix('radio-button-wrapper__label'));
        var fakeRadioButtonClasses = cx(prefix('radio-button-wrapper__fake-radio-button'), this.checked && prefix('radio-button-wrapper__fake-radio-button--checked'), this.disabled && prefix('radio-button-wrapper__fake-radio-button--disabled'), this.state !== 'none' && prefix("radio-button-wrapper__fake-radio-button--" + this.state));
        var labelTextClasses = cx(prefix('radio-button-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('radio-button-wrapper__label-text--disabled'));
        var messageClasses = cx(prefix('radio-button-wrapper__message'), this.state !== 'none' && prefix("radio-button-wrapper__message--" + this.state));
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: function (e) { return _this.labelClick(e); } }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), h("span", { class: fakeRadioButtonClasses }, h("slot", null))), this.isMessageVisible &&
