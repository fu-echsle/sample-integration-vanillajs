...
var RadioButtonWrapper = /** @class */ (function () {
    ...
    RadioButtonWrapper.prototype.render = function () {
        var _b, _c, _d;
        var labelClasses = prefix('radio-button-wrapper__label');
        var fakeRadioButtonClasses = (_b = {},
            _b[prefix('radio-button-wrapper__fake-radio-button')] = true,
            _b[prefix('radio-button-wrapper__fake-radio-button--checked')] = this.checked,
            _b[prefix('radio-button-wrapper__fake-radio-button--disabled')] = this.disabled,
            _b[prefix("radio-button-wrapper__fake-radio-button--" + this.state)] = this.state !== 'none',
            _b);
        var labelTextClasses = Object.assign((_c = {}, _c[prefix('radio-button-wrapper__label-text')] = true, _c[prefix('radio-button-wrapper__label-text--disabled')] = this.disabled, _c), mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        var messageClasses = (_d = {},
            _d[prefix('radio-button-wrapper__message')] = true,
            _d[prefix("radio-button-wrapper__message--" + this.state)] = this.state !== 'none',
            _d);
