...
var TextFieldWrapper = /** @class */ (function () {
    ...
    TextFieldWrapper.prototype.render = function () {
        ...
        return (h(Host, null, h("div", { class: containerClasses }, h("label", { class: labelClasses }, this.isLabelVisible &&
            ...
            h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: function () { return _this.labelClick(); } }, this.description ? this.description : h("span", null, h("slot", { name: 'description' }))), h("span", { class: fakeInputClasses }, h("slot", null))), this.isPasswordToggleable &&
            h("button", { type: 'button', class: buttonClasses, onClick: function () { return _this.togglePassword(); }, disabled: this.disabled }, h("p-icon", { name: this.showPassword ? 'view-off' : 'view', color: 'inherit' })), this.isInputTypeSearch &&
            h("button", { onClick: function (event) { return _this.onSubmitHandler(event); }, type: 'submit', class: buttonClasses, disabled: this.disabled || this.readonly }, h("p-icon", { name: 'search', color: 'inherit' }))), this.isMessageVisible &&
    ...
    TextFieldWrapper.prototype.onSubmitHandler = function (event) {
        var _this = this;
        if (this.isInputTypeSearch) {
            handleButtonEvent(event, this.host, function () { return _this.searchButtonType; }, function () { return _this.disabled; });
        }
    };
