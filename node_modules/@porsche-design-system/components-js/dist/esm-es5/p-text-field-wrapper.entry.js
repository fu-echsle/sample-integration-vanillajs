...
var TextFieldWrapper = /** @class */ (function () {
    ...
    TextFieldWrapper.prototype.render = function () {
        var containerClasses = classnames(prefix('text-field-wrapper__container'));
        var labelClasses = classnames(prefix('text-field-wrapper__label'));
        var labelTextClasses = classnames(prefix('text-field-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('text-field-wrapper__label-text--disabled'));
        var descriptionTextClasses = classnames(prefix('text-field-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]), this.disabled && prefix('text-field-wrapper__description-text--disabled'));
        var fakeInputClasses = classnames(prefix('text-field-wrapper__fake-input'), this.state !== 'none' && prefix("text-field-wrapper__fake-input--" + this.state), this.disabled && prefix('text-field-wrapper__fake-input--disabled'), this.readonly && prefix('text-field-wrapper__fake-input--readonly'));
        var buttonClasses = classnames(prefix('text-field-wrapper__button'));
        var messageClasses = classnames(prefix('text-field-wrapper__message'), this.state !== 'none' && prefix("text-field-wrapper__message--" + this.state));
