...
var LinkSocial = /** @class */ (function () {
    ...
    LinkSocial.prototype.render = function () {
        ...
        var linkClasses = cx(prefix('link-social'), mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']), prefix("link-social--" + this.icon), prefix("link-social--theme-" + this.theme));
        var iconClasses = prefix('link-social__icon');
        var labelClasses = prefix('link-social__label');
