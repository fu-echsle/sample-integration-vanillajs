...
var LinkSocial = /** @class */ (function () {
    ...
    LinkSocial.prototype.render = function () {
        ...
        var linkClasses = Object.assign((_a = {}, _a[prefix('link-social')] = true, _a[prefix("link-social--" + this.icon)] = true, _a[prefix("link-social--theme-" + this.theme)] = true, _a), mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']));
