...
var Divider = /** @class */ (function () {
    ...
    Divider.prototype.render = function () {
        var dividerClasses = cx(prefix('divider'), prefix("divider--color-" + this.color), prefix("divider--theme-" + this.theme), mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
