import { r as registerInstance, c as prefix, h } from './breakpointCustomizable-063d6106.js';
...
var FieldsetWrapper = /** @class */ (function () {
    ...
    FieldsetWrapper.prototype.render = function () {
        var fieldsetClasses = classnames(prefix('fieldset-wrapper'));
        var labelClasses = classnames(prefix('fieldset-wrapper__label'));
        return (h("fieldset", { class: fieldsetClasses }, this.label && h("legend", { class: labelClasses }, this.label), h("slot", null)));
    };
