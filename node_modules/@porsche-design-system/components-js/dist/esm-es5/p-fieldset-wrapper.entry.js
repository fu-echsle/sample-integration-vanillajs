...
var FieldsetWrapper = /** @class */ (function () {
    ...
    FieldsetWrapper.prototype.render = function () {
        var fieldsetClasses = cx(prefix('fieldset-wrapper'));
        var labelClasses = cx(prefix('fieldset-wrapper__label'));
        return (h("fieldset", { class: fieldsetClasses }, this.label &&
            h("legend", { class: labelClasses }, this.label), h("slot", null)));
    };
    return FieldsetWrapper;
}());
FieldsetWrapper.style = fieldsetWrapperCss;
export { FieldsetWrapper as p_fieldset_wrapper };
