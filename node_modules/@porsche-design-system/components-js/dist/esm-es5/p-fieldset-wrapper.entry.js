import { r as registerInstance, h, c as prefix } from './breakpointCustomizable-633ca215.js';
...
var FieldsetWrapper = /** @class */ (function () {
    ...
    FieldsetWrapper.prototype.render = function () {
        var fieldsetClasses = prefix('fieldset-wrapper');
        var labelClasses = prefix('fieldset-wrapper__label');
