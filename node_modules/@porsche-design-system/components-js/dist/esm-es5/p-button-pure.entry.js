...
import { i as improveButtonHandlingForCustomElement } from './buttonHandling-8f4ca036.js';
...
var ButtonPure = /** @class */ (function () {
    ...
    ButtonPure.prototype.render = function () {
        var _this = this;
        var buttonPureClasses = classnames(prefix('button-pure'), mapBreakpointPropToPrefixedClasses('button-pure--size', this.size), prefix("button-pure--theme-" + this.theme));
        var iconClasses = classnames(prefix('button-pure__icon'));
        var labelClasses = classnames(prefix('button-pure__label'), mapBreakpointPropToPrefixedClasses('button-pure__label-', this.hideLabel, ['hidden', 'visible']));
        var sublineClasses = classnames(prefix('button-pure__subline'), mapBreakpointPropToPrefixedClasses('button-pure__subline-', this.hideLabel, ['hidden', 'visible']));
        return (h(Host, null, h("button", { class: buttonPureClasses, type: this.type, disabled: this.isDisabled(), tabindex: this.tabbable ? 0 : -1, ref: function (el) { return (_this.buttonTag = el); }, "aria-busy": this.loading && 'true' }, this.loading ? (h("p-spinner", { class: iconClasses, size: "inherit", theme: this.theme, ref: function (el) { return (_this.iconTag = el); } })) : (h("p-icon", { class: iconClasses, color: "inherit", size: "inherit", name: this.icon, source: this.iconSource, ref: function (el) { return (_this.iconTag = el); }, "aria-hidden": "true" })), h("p-text", { class: labelClasses, tag: "span", color: "inherit", size: "inherit", weight: this.weight }, h("slot", null))), this.hasSubline && (h("p-text", { class: sublineClasses, color: "inherit", size: "inherit", tag: "div" }, h("slot", { name: "subline" })))));
    };
