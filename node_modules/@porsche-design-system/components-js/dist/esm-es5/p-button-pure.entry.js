import { r as registerInstance, i as improveButtonHandlingForCustomElement, e as transitionListener, d as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, g as getElement, f as calcLineHeightForElement } from './index-e8247a5d.js';
...
var ButtonPure = /** @class */ (function () {
    ...
    ButtonPure.prototype.componentDidLoad = function () {
        ...
        improveButtonHandlingForCustomElement(this.host, function () { return _this.type; }, function () { return _this.isDisabled(); });
        transitionListener(this.buttonTag, 'font-size', function () {
            var size = calcLineHeightForElement(_this.buttonTag);
    ...
    ButtonPure.prototype.render = function () {
        var _this = this;
        var buttonPureClasses = cx(prefix('button-pure'), mapBreakpointPropToPrefixedClasses('button-pure--size', this.size), prefix("button-pure--theme-" + this.theme));
        var iconClasses = cx(prefix('button-pure__icon'));
        var labelClasses = cx(prefix('button-pure__label'), mapBreakpointPropToPrefixedClasses('button-pure__label-', this.hideLabel, ['hidden', 'visible']));
        var sublineClasses = cx(prefix('button-pure__subline'), mapBreakpointPropToPrefixedClasses('button-pure__subline-', this.hideLabel, ['hidden', 'visible']));
        return (h(Host, null, h("button", { class: buttonPureClasses, type: this.type, disabled: this.isDisabled(), tabindex: this.tabbable ? 0 : -1, ref: function (el) { return (_this.buttonTag = el); }, "aria-busy": this.loading && 'true' }, this.loading ? (h("p-spinner", { class: iconClasses, size: "inherit", theme: this.theme, ref: function (el) { return (_this.iconTag = el); } })) : (h("p-icon", { class: iconClasses, color: "inherit", size: "inherit", name: this.icon, source: this.iconSource, ref: function (el) { return (_this.iconTag = el); }, "aria-hidden": "true" })), h("p-text", { class: labelClasses, tag: "span", color: "inherit", size: "inherit", weight: this.weight }, h("slot", null))), this.subline && (h("p-text", { class: sublineClasses, color: "inherit", size: "inherit", tag: "div" }, h("slot", { name: "subline" })))));
    };
    ButtonPure.prototype.setSubline = function () {
...
export { ButtonPure as p_button_pure };
