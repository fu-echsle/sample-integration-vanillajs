import { r as registerInstance, e as createEvent, c as prefix, m as mapBreakpointPropToPrefixedClasses, h, g as getElement } from './breakpointCustomizable-633ca215.js';
...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.render = function () {
        ...
        var paginationClasses = Object.assign((_a = {}, _a[prefix('pagination')] = true, _a[prefix("pagination--theme-" + this.theme)] = true, _a), mapBreakpointPropToPrefixedClasses('pagination--size', this.maxNumberOfPageLinks));
        var paginationItemsClasses = prefix('pagination__items');
        ...
        var createPaginationItems = function () {
            ...
            var prevItem;
            var nextItem;
            var paginationItemClasses = prefix('pagination__item');
            paginationModel.forEach(function (pageModel) {
                var _a, _b, _c, _d;
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    var paginationPrevClasses = (_a = {},
                        _a[prefix('pagination__prev')] = true,
                        _a[prefix('pagination__prev--disabled')] = !pageModel.isActive,
                        _a);
                ...
                if (pageModel.type === itemTypes.ELLIPSIS) {
                    var paginationGoToClasses = (_b = {},
                        _b[prefix('pagination__goto')] = true,
                        _b[prefix('pagination__goto--ellipsis')] = true,
                        _b);
                ...
                if (pageModel.type === itemTypes.PAGE) {
                    var paginationGoToClasses = (_c = {},
                        _c[prefix('pagination__goto')] = true,
                        _c[prefix('pagination__goto--current')] = pageModel.isActive,
                        _c);
                ...
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    var paginationNextClasses = (_d = {},
                        _d[prefix('pagination__next')] = true,
                        _d[prefix('pagination__next--disabled')] = !pageModel.isActive,
                        _d);
