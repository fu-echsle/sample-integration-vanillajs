...
var handleResize = throttle(500, function () {
...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.render = function () {
        var _this = this;
        var breakpointClasses = mapBreakpointPropToPrefixedClasses('pagination--size', this.maxNumberOfPageLinks);
        var pageRange = this.breakpointMaxNumberOfPageLinks === 7 ? 1 : 0;
        var paginationClasses = classnames(breakpointClasses, prefix('pagination'), prefix("pagination--theme-" + this.theme));
        var paginationItemsClasses = classnames(prefix('pagination__items'));
        ...
        var createPaginationItems = function () {
            ...
            var prevItem;
            var nextItem;
            var paginationItemClasses = classnames(prefix('pagination__item'));
            paginationModel.forEach(function (pageModel) {
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    var paginationPrevClasses = classnames(prefix('pagination__prev'), !pageModel.isActive && prefix('pagination__prev--disabled'));
                    return (prevItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), h("span", { class: paginationPrevClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: function () { return _this.onClick(pageModel.value); }, onKeyDown: function (e) { return _this.onKeyDown(e, pageModel.value); }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": _this.allyLabelPrev }, h("p-icon", { name: "arrow-head-left", color: "inherit" })))));
                }
                if (pageModel.type === itemTypes.ELLIPSIS) {
                    var paginationGoToClasses = classnames(prefix('pagination__goto'), prefix('pagination__goto--ellipsis'));
                ...
                if (pageModel.type === itemTypes.PAGE) {
                    var paginationGoToClasses = classnames(prefix('pagination__goto'), pageModel.isActive && prefix('pagination__goto--current'));
                ...
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    var paginationNextClasses = classnames(prefix('pagination__next'), !pageModel.isActive && prefix('pagination__next--disabled'));
                    return (nextItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), h("span", { class: paginationNextClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: function () { return _this.onClick(pageModel.value); }, onKeyDown: function (e) { return _this.onKeyDown(e, pageModel.value); }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": _this.allyLabelNext }, h("p-icon", { name: "arrow-head-right", color: "inherit" })))));
                }
            });
            return {
                prevItem: prevItem,
        ...
        return (h("nav", { class: paginationClasses, role: "navigation", "aria-label": this.allyLabel, ref: function (el) { return (_this.navigationElement = el); } }, h("ul", { class: paginationItemsClasses }, paginationItems.prevItem, paginationItems.pageItems, paginationItems.nextItem)));
    };
