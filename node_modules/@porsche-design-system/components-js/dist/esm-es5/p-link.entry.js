...
var Link = /** @class */ (function () {
    ...
    Link.prototype.render = function () {
        ...
        var linkClasses = Object.assign((_a = {}, _a[prefix('link')] = true, _a[prefix("link--" + this.variant)] = true, _a[prefix("link--theme-" + this.theme)] = true, _a), mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']));
        ...
        return (h(TagType, Object.assign({ class: linkClasses }, (TagType === 'a' && {
            ...
            rel: this.rel
        })), h("p-icon", { class: iconClasses, size: "inherit", name: this.icon, source: this.iconSource, color: "inherit", "aria-hidden": "true" }), h("p-text", { tag: "span", color: "inherit", class: labelClasses }, h("slot", null))));
    };
