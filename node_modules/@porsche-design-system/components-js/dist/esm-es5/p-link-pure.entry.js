...
var LinkPure = /** @class */ (function () {
    ...
    LinkPure.prototype.componentDidLoad = function () {
        ...
        transitionListener(this.linkTag, 'font-size', function () {
            var size = calcLineHeightForElement(_this.linkTag);
    ...
    LinkPure.prototype.render = function () {
        ...
        var linkPureClasses = Object.assign((_a = {}, _a[prefix('link-pure')] = true, _a[prefix("link-pure--theme-" + this.theme)] = true, _a[prefix('link-pure--active')] = this.active, _a), mapBreakpointPropToPrefixedClasses('link-pure--size', this.size));
        var iconClasses = prefix('link-pure__icon');
        var labelClasses = Object.assign((_b = {}, _b[prefix('link-pure__label')] = true, _b), mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        var sublineClasses = Object.assign((_c = {}, _c[prefix('link-pure__subline')] = true, _c), mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
