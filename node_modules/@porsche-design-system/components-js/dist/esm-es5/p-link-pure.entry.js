...
var LinkPure = /** @class */ (function () {
    ...
    LinkPure.prototype.render = function () {
        ...
        var linkPureClasses = cx(prefix('link-pure'), mapBreakpointPropToPrefixedClasses('link-pure--size', this.size), prefix("link-pure--theme-" + this.theme), this.active && prefix('link-pure--active'));
        var iconClasses = cx(prefix('link-pure__icon'));
        var labelClasses = cx(prefix('link-pure__label'), mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        var sublineClasses = cx(prefix('link-pure__subline'), mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
