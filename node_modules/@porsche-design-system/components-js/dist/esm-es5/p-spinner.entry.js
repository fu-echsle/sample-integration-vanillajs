import { r as registerInstance, c as prefix, m as mapBreakpointPropToPrefixedClasses, h } from './breakpointCustomizable-633ca215.js';
...
var Spinner = /** @class */ (function () {
    ...
    Spinner.prototype.render = function () {
        var _a;
        var spinnerClasses = Object.assign((_a = {}, _a[prefix('spinner')] = true, _a[prefix("spinner--theme-" + this.theme)] = true, _a), mapBreakpointPropToPrefixedClasses('spinner--size', this.size));
        var imageClasses = prefix('spinner__image');
        var bgClasses = prefix('spinner__bg');
        var fgClasses = prefix('spinner__fg');
        return (h("span", { class: spinnerClasses, "aria-busy": "true", "aria-live": "polite" }, h("svg", { class: imageClasses, viewBox: "0 0 32 32", width: "100%", height: "100%", role: "img", focusable: "false" }, h("circle", { class: bgClasses, cx: "50%", cy: "50%", r: "9" }), h("circle", { class: fgClasses, cx: "50%", cy: "50%", r: "9" }))));
    };
    return Spinner;
}());
Spinner.style = spinnerCss;
export { Spinner as p_spinner };
