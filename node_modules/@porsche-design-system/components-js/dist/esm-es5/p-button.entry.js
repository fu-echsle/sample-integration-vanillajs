...
var Button = /** @class */ (function () {
    ...
    Button.prototype.render = function () {
        var buttonClasses = classnames(prefix('button'), prefix("button--" + this.variant), mapBreakpointPropToPrefixedClasses('button-', this.hideLabel, ['without-label', 'with-label']), prefix("button--theme-" + this.theme));
