import { r as registerInstance, h, g as getElement, c as prefix } from './breakpointCustomizable-633ca215.js';
...
var Headline = /** @class */ (function () {
    ...
    Headline.prototype.render = function () {
        ...
        var headlineClasses = (_a = {},
            _a[prefix('headline')] = true,
            _a[prefix("headline--variant-" + this.variant)] = true,
            _a[prefix("headline--align-" + this.align)] = true,
            _a[prefix("headline--color-" + this.color)] = true,
            _a[prefix('headline--ellipsis')] = this.ellipsis,
            _a[prefix("headline--theme-" + this.theme)] = this.color !== 'inherit',
            _a);
