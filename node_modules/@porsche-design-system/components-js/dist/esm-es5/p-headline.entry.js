import { r as registerInstance, d as prefix, h, j as insertSlottedStyles, g as getElement } from './index-e8247a5d.js';
...
var Headline = /** @class */ (function () {
    ...
    Headline.prototype.render = function () {
        ...
        var headlineClasses = cx(prefix('headline'), prefix("headline--variant-" + this.variant), prefix("headline--align-" + this.align), prefix("headline--color-" + this.color), this.ellipsis && prefix('headline--ellipsis'), this.color !== 'inherit' && prefix("headline--theme-" + this.theme));
