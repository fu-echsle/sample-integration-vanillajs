...
var Headline = /** @class */ (function () {
    ...
    Headline.prototype.render = function () {
        ...
        var headlineClasses = classnames(prefix('headline'), prefix("headline--variant-" + this.variant), prefix("headline--align-" + this.align), prefix("headline--color-" + this.color), this.ellipsis && prefix('headline--ellipsis'), this.color !== 'inherit' && prefix("headline--theme-" + this.theme));
