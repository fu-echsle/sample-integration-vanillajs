...
var TextareaWrapper = /** @class */ (function () {
    ...
    TextareaWrapper.prototype.render = function () {
        var _a, _b, _c, _d;
        var labelClasses = prefix('textarea-wrapper__label');
        var labelTextClasses = Object.assign((_a = {}, _a[prefix('textarea-wrapper__label-text')] = true, _a[prefix('textarea-wrapper__label-text--disabled')] = this.disabled, _a), mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        var descriptionTextClasses = Object.assign((_b = {}, _b[prefix('textarea-wrapper__description-text')] = true, _b[prefix('textarea-wrapper__description-text--disabled')] = this.disabled, _b), mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]));
        var fakeTextareaClasses = (_c = {},
            _c[prefix('textarea-wrapper__fake-textarea')] = true,
            _c[prefix("textarea-wrapper__fake-textarea--" + this.state)] = true,
            _c[prefix('textarea-wrapper__fake-textarea--disabled')] = this.disabled,
            _c[prefix('textarea-wrapper__fake-textarea--readonly')] = this.readonly,
            _c);
        var messageClasses = (_d = {},
            _d[prefix('textarea-wrapper__message')] = true,
            _d[prefix("textarea-wrapper__message--" + this.state)] = true,
            _d);
