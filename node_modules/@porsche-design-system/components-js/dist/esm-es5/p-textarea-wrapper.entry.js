import { r as registerInstance, d as prefix, m as mapBreakpointPropToPrefixedClasses, h, H as Host, e as transitionListener, j as insertSlottedStyles, g as getElement } from './index-e8247a5d.js';
...
var TextareaWrapper = /** @class */ (function () {
    ...
    TextareaWrapper.prototype.render = function () {
        ...
        var descriptionTextClasses = cx(prefix('textarea-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__description-text--disabled'));
        ...
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible &&
            h("p-text", { class: labelTextClasses, color: 'inherit', tag: 'span', onClick: function () { return _this.labelClick(); } }, this.label ? this.label : h("span", null, h("slot", { name: 'label' }))), this.isDescriptionVisible &&
            h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: function () { return _this.labelClick(); } }, this.description ? this.description : h("span", null, h("slot", { name: 'description' }))), h("span", { class: fakeTextareaClasses }, h("slot", null))), this.isMessageVisible &&
            h("p-text", { class: messageClasses, color: 'inherit', role: this.state === 'error' && 'alert' }, this.message ? this.message : h("span", null, h("slot", { name: 'message' })))));
    };
