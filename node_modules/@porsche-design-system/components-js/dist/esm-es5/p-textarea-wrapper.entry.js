...
var TextareaWrapper = /** @class */ (function () {
    ...
    TextareaWrapper.prototype.render = function () {
        var labelClasses = classnames(prefix('textarea-wrapper__label'));
        var labelTextClasses = classnames(prefix('textarea-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__label-text--disabled'));
        var descriptionTextClasses = classnames(prefix('textarea-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('textarea-wrapper__description-text--disabled'));
        var fakeTextareaClasses = classnames(prefix('textarea-wrapper__fake-textarea'), prefix("textarea-wrapper__fake-textarea--" + this.state), this.disabled && prefix('textarea-wrapper__fake-textarea--disabled'), this.readonly && prefix('textarea-wrapper__fake-textarea--readonly'));
        var messageClasses = classnames(prefix('textarea-wrapper__message'), prefix("textarea-wrapper__message--" + this.state));
