...
var CheckboxWrapper = /** @class */ (function () {
    ...
    CheckboxWrapper.prototype.render = function () {
        var _b, _c, _d, _e;
        var labelClasses = prefix('checkbox-wrapper__label');
        var fakeCheckboxClasses = (_b = {},
            _b[prefix('checkbox-wrapper__fake-checkbox')] = true,
            _b[prefix('checkbox-wrapper__fake-checkbox--checked')] = this.checked || this.indeterminate,
            _b[prefix('checkbox-wrapper__fake-checkbox--disabled')] = this.disabled,
            _b[prefix("checkbox-wrapper__fake-checkbox--" + this.state)] = this.state !== 'none',
            _b);
        var iconClasses = (_c = {},
            _c[prefix('checkbox-wrapper__icon')] = true,
            _c[prefix('checkbox-wrapper__icon--checked')] = this.checked || this.indeterminate,
            _c);
        var labelTextClasses = Object.assign((_d = {}, _d[prefix('checkbox-wrapper__label-text')] = true, _d[prefix('checkbox-wrapper__label-text--disabled')] = this.disabled, _d), mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        var messageClasses = (_e = {},
            _e[prefix('checkbox-wrapper__message')] = true,
            _e[prefix("checkbox-wrapper__message--" + this.state)] = this.state !== 'none',
            _e);
