...
var CheckboxWrapper = /** @class */ (function () {
    ...
    CheckboxWrapper.prototype.render = function () {
        var labelClasses = classnames(prefix('checkbox-wrapper__label'));
        var fakeCheckboxClasses = classnames(prefix('checkbox-wrapper__fake-checkbox'), (this.checked || this.indeterminate) && prefix('checkbox-wrapper__fake-checkbox--checked'), this.disabled && prefix('checkbox-wrapper__fake-checkbox--disabled'), this.state !== 'none' && prefix("checkbox-wrapper__fake-checkbox--" + this.state));
        var iconClasses = classnames(prefix('checkbox-wrapper__icon'), (this.checked || this.indeterminate) && prefix('checkbox-wrapper__icon--checked'));
        var labelTextClasses = classnames(prefix('checkbox-wrapper__label-text'), mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('checkbox-wrapper__label-text--disabled'));
        var messageClasses = classnames(prefix('checkbox-wrapper__message'), this.state !== 'none' && prefix("checkbox-wrapper__message--" + this.state));
