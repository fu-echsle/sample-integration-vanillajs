...
import { _ as __assign, r as registerInstance, h, H as Host, g as getElement, c as prefix, m as mapBreakpointPropToPrefixedClasses } from './breakpointCustomizable-633ca215.js';
...
import { I as ICONS_MANIFEST, a as CDN_BASE_URL$1 } from './index-02c10760.js';
...
var Icon = /** @class */ (function () {
    ...
    Icon.prototype.loadIcon = function () {
        ...
        if (this.isVisible) {
            ...
            getSvgContent(url_1).then(function (iconContent) {
                ...
                if (url_1 === buildIconUrl((_a = _this.source) !== null && _a !== void 0 ? _a : _this.name)) {
    ...
    Icon.prototype.render = function () {
        ...
        var iconClasses = (_e = {},
            _e[prefix('icon')] = true,
            _e[prefix("icon--size-" + this.size)] = true,
            _e[prefix("icon--color-" + this.color)] = true,
            _e[prefix("icon--theme-" + this.theme)] = this.color !== 'inherit',
            _e);
...
var Text = /** @class */ (function () {
    ...
    Text.prototype.render = function () {
        ...
        var textClasses = Object.assign((_e = {}, _e[prefix('text')] = true, _e[prefix("text--weight-" + this.weight)] = true, _e[prefix("text--align-" + this.align)] = true, _e[prefix("text--color-" + this.color)] = true, _e[prefix('text--ellipsis')] = this.ellipsis, _e[prefix("text--theme-" + this.theme)] = this.color !== 'inherit', _e), mapBreakpointPropToPrefixedClasses('text--size', this.size));
