...
const createFocusEvent = (type, bubbles) => {
...
const improveFocusHandlingForCustomElement = (element) => {
    var _a;
    const childElementContainer = (_a = element.shadowRoot) !== null && _a !== void 0 ? _a : element;
    element.focus = () => {
    ...
    if (!element.shadowRoot || !element.shadowRoot.host) {
        ...
        if (firstChild) {
            firstChild.addEventListener('focusin', (event) => {
                const isRelatedTargetPartOfComponent = element.contains(event.relatedTarget);
            ...
            firstChild.addEventListener('focusout', (event) => {
                const isRelatedTargetPartOfComponent = element.contains(event.relatedTarget);
                if (!isRelatedTargetPartOfComponent) {
...
exports.improveFocusHandlingForCustomElement = improveFocusHandlingForCustomElement;
