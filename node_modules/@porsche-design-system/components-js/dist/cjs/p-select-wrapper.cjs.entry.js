...
require('./index.esm-21a5c361.js');
const transitionListener = require('./transition-listener-84eef3b3.js');
...
class SelectWrapper {
    ...
    render() {
        const labelClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__label'));
        const labelTextClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__label-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('select-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), { [breakpointCustomizable.prefix('select-wrapper__label-text--disabled')]: this.disabled });
        const descriptionTextClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__description-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), { [breakpointCustomizable.prefix('select-wrapper__description-text--disabled')]: this.disabled });
        const fakeSelectClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-select'), { [breakpointCustomizable.prefix('select-wrapper__fake-select--disabled')]: this.disabled }, { [breakpointCustomizable.prefix(`select-wrapper__fake-select--${this.state}`)]: this.state !== 'none' });
        const fakeOptionListClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-option-list'), {
            [breakpointCustomizable.prefix('select-wrapper__fake-option-list--hidden')]: this.fakeOptionListHidden
        });
        const iconClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__icon'), { [breakpointCustomizable.prefix('select-wrapper__icon--disabled')]: this.disabled }, { [breakpointCustomizable.prefix('select-wrapper__icon--opened')]: !this.fakeOptionListHidden });
        const messageClasses = index.classnames(breakpointCustomizable.prefix('select-wrapper__message'), {
            [breakpointCustomizable.prefix(`select-wrapper__message--${this.state}`)]: this.state !== 'none'
        });
        return (breakpointCustomizable.h(breakpointCustomizable.Host, null, breakpointCustomizable.h("div", { class: labelClasses }, breakpointCustomizable.h("label", null, this.isLabelVisible && (breakpointCustomizable.h("p-text", { class: labelTextClasses, tag: "span", color: "inherit", onClick: this.labelClick }, this.label || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "label" }))))), this.isDescriptionVisible && (breakpointCustomizable.h("p-text", { class: descriptionTextClasses, tag: "span", color: "inherit", size: "x-small", onClick: this.labelClick }, this.description || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "description" }))))), breakpointCustomizable.h("span", { class: fakeSelectClasses }, breakpointCustomizable.h("p-icon", { class: iconClasses, name: "arrow-head-down", color: "inherit" }), breakpointCustomizable.h("slot", null))), !this.isTouch && (breakpointCustomizable.h("div", { class: fakeOptionListClasses, role: "listbox", "aria-activedescendant": `option-${this.optionSelected}`, tabIndex: -1, "aria-expanded": this.fakeOptionListHidden ? 'false' : 'true', "aria-labelledby": this.label, ref: (el) => (this.fakeOptionListNode = el) }, this.createFakeOptionList()))), this.isMessageVisible && (breakpointCustomizable.h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
    ...
    bindStateListener() {
        transitionListener.transitionListener(this.select, 'border-top-color', this.setState);
    }
    /*
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            (option.parentElement.tagName === 'OPTGROUP' && option.previousElementSibling === null) && (breakpointCustomizable.h("span", { class: index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-optgroup-label')), role: "presentation" }, option.closest('optgroup').label)),
            breakpointCustomizable.h("div", { id: `option-${key}`, role: "option", color: "inherit", class: index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-option'), {
                    [breakpointCustomizable.prefix('select-wrapper__fake-option--selected')]: this.optionSelected === key,
                    [breakpointCustomizable.prefix('select-wrapper__fake-option--highlighted')]: this.optionHighlighted === key,
                    [breakpointCustomizable.prefix('select-wrapper__fake-option--disabled')]: this.optionDisabled.includes(key)
                }), onClick: () => (!this.optionDisabled.includes(key) ? this.setOptionSelected(key) : this.select.focus()), "aria-selected": this.optionSelected === key && 'true', "aria-disabled": this.optionDisabled.includes(key) && 'true' }, breakpointCustomizable.h("span", null, option.text), key === this.optionSelected && (breakpointCustomizable.h("p-icon", { class: index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-option-icon')), "aria-hidden": "true", name: "check", color: "inherit" })))
        ]);
    }
