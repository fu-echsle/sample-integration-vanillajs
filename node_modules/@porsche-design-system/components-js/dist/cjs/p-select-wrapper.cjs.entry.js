...
class SelectWrapper {
    ...
    render() {
        const labelClasses = breakpointCustomizable.prefix('select-wrapper__label');
        const labelTextClasses = Object.assign({ [breakpointCustomizable.prefix('select-wrapper__label-text')]: true, [breakpointCustomizable.prefix('select-wrapper__label-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('select-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const descriptionTextClasses = Object.assign({ [breakpointCustomizable.prefix('select-wrapper__description-text')]: true, [breakpointCustomizable.prefix('select-wrapper__description-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']));
        const fakeSelectClasses = {
            [breakpointCustomizable.prefix('select-wrapper__fake-select')]: true,
            [breakpointCustomizable.prefix('select-wrapper__fake-select--disabled')]: this.disabled,
            [breakpointCustomizable.prefix(`select-wrapper__fake-select--${this.state}`)]: this.state !== 'none'
        };
        const fakeOptionListClasses = {
            [breakpointCustomizable.prefix('select-wrapper__fake-option-list')]: true,
            [breakpointCustomizable.prefix('select-wrapper__fake-option-list--hidden')]: this.fakeOptionListHidden
        };
        const iconClasses = {
            [breakpointCustomizable.prefix('select-wrapper__icon')]: true,
            [breakpointCustomizable.prefix('select-wrapper__icon--disabled')]: this.disabled,
            [breakpointCustomizable.prefix('select-wrapper__icon--opened')]: !this.fakeOptionListHidden
        };
        const messageClasses = {
            [breakpointCustomizable.prefix('select-wrapper__message')]: true,
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            option.parentElement.tagName === 'OPTGROUP' && option.previousElementSibling === null && (breakpointCustomizable.h("span", { class: breakpointCustomizable.prefix('select-wrapper__fake-optgroup-label'), role: "presentation" }, option.closest('optgroup').label)),
            breakpointCustomizable.h("div", { id: `option-${key}`, role: "option", color: "inherit", class: {
                    [breakpointCustomizable.prefix('select-wrapper__fake-option')]: true,
