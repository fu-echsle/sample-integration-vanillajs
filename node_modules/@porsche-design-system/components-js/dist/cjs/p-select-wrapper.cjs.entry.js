...
class SelectWrapper {
    ...
    createFakeOptionList() {
        return Array.from(this.options).map((option, key) => [
            this.optgroups.length > 0 && option === option.parentNode.firstChild && (breakpointCustomizable.h("span", { class: index.classnames(breakpointCustomizable.prefix('select-wrapper__fake-optgroup-label')), role: "presentation" }, option.closest('optgroup').label)),
