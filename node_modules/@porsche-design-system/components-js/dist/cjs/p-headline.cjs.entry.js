...
class Headline {
    ...
    render() {
        ...
        const headlineClasses = index.classnames(breakpointCustomizable.prefix('headline'), breakpointCustomizable.prefix(`headline--variant-${this.variant}`), breakpointCustomizable.prefix(`headline--align-${this.align}`), breakpointCustomizable.prefix(`headline--color-${this.color}`), this.ellipsis && breakpointCustomizable.prefix('headline--ellipsis'), this.color !== 'inherit' && breakpointCustomizable.prefix(`headline--theme-${this.theme}`));
