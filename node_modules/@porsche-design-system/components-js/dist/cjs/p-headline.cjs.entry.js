...
const Headline = class {
    ...
    render() {
        ...
        const headlineClasses = index$1.cx(index.prefix('headline'), index.prefix(`headline--variant-${this.variant}`), index.prefix(`headline--align-${this.align}`), index.prefix(`headline--color-${this.color}`), this.ellipsis && index.prefix('headline--ellipsis'), this.color !== 'inherit' && index.prefix(`headline--theme-${this.theme}`));
