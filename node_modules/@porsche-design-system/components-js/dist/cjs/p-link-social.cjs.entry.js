...
const LinkSocial = class {
    ...
    render() {
        ...
        const linkClasses = index$1.cx(index.prefix('link-social'), index.mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']), index.prefix(`link-social--${this.icon}`), index.prefix(`link-social--theme-${this.theme}`));
        const iconClasses = index.prefix('link-social__icon');
        const labelClasses = index.prefix('link-social__label');
