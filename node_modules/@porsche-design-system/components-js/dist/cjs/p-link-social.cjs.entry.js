...
class LinkSocial {
    ...
    render() {
        ...
        const linkClasses = index.classnames(breakpointCustomizable.prefix('link-social'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']), breakpointCustomizable.prefix(`link-social--${this.icon}`), breakpointCustomizable.prefix(`link-social--theme-${this.theme}`));
        const iconClasses = breakpointCustomizable.prefix('link-social__icon');
        const labelClasses = breakpointCustomizable.prefix('link-social__label');
        return (breakpointCustomizable.h(TagType, Object.assign({ class: linkClasses }, (TagType === 'a' ? {
            href: this.href,
            target: this.target,
            rel: this.rel
        } : null)), breakpointCustomizable.h("p-icon", { class: iconClasses, size: 'inherit', name: this.icon, source: this.iconSource, color: 'inherit', "aria-hidden": 'true' }), breakpointCustomizable.h("p-text", { tag: 'span', color: 'inherit', class: labelClasses }, breakpointCustomizable.h("slot", null))));
    }
    addSlottedStyles() {
