...
class LinkSocial {
    ...
    render() {
        ...
        const linkClasses = Object.assign({ [breakpointCustomizable.prefix('link-social')]: true, [breakpointCustomizable.prefix(`link-social--${this.icon}`)]: true, [breakpointCustomizable.prefix(`link-social--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-social-', this.hideLabel, ['without-label', 'with-label']));
