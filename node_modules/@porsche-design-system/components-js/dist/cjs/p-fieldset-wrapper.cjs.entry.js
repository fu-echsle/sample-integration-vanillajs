...
class FieldsetWrapper {
    ...
    render() {
        const fieldsetClasses = index.classnames(breakpointCustomizable.prefix('fieldset-wrapper'));
        const labelClasses = index.classnames(breakpointCustomizable.prefix('fieldset-wrapper__label'));
        return (breakpointCustomizable.h("fieldset", { class: fieldsetClasses }, this.label && breakpointCustomizable.h("legend", { class: labelClasses }, this.label), breakpointCustomizable.h("slot", null)));
    }
}
