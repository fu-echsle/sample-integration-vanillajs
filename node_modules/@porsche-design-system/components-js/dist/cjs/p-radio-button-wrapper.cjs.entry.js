...
class RadioButtonWrapper {
    ...
    render() {
        const labelClasses = index.classnames(breakpointCustomizable.prefix('radio-button-wrapper__label'));
        const fakeRadioButtonClasses = index.classnames(breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button'), this.checked && breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button--checked'), this.disabled && breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button--disabled'), this.state !== 'none' && breakpointCustomizable.prefix(`radio-button-wrapper__fake-radio-button--${this.state}`));
        const labelTextClasses = index.classnames(breakpointCustomizable.prefix('radio-button-wrapper__label-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && breakpointCustomizable.prefix('radio-button-wrapper__label-text--disabled'));
        const messageClasses = index.classnames(breakpointCustomizable.prefix('radio-button-wrapper__message'), this.state !== 'none' && breakpointCustomizable.prefix(`radio-button-wrapper__message--${this.state}`));
        return (breakpointCustomizable.h(breakpointCustomizable.Host, null, breakpointCustomizable.h("label", { class: labelClasses }, this.isLabelVisible && (breakpointCustomizable.h("p-text", { class: labelTextClasses, tag: "span", color: "inherit", onClick: this.labelClick }, this.label || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "label" }))))), breakpointCustomizable.h("span", { class: fakeRadioButtonClasses }, breakpointCustomizable.h("slot", null))), this.isMessageVisible && (breakpointCustomizable.h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
