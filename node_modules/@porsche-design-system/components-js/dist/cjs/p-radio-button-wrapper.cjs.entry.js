...
const RadioButtonWrapper = class {
    ...
    render() {
        const labelClasses = index$1.cx(index.prefix('radio-button-wrapper__label'));
        const fakeRadioButtonClasses = index$1.cx(index.prefix('radio-button-wrapper__fake-radio-button'), this.checked && index.prefix('radio-button-wrapper__fake-radio-button--checked'), this.disabled && index.prefix('radio-button-wrapper__fake-radio-button--disabled'), this.state !== 'none' && index.prefix(`radio-button-wrapper__fake-radio-button--${this.state}`));
        const labelTextClasses = index$1.cx(index.prefix('radio-button-wrapper__label-text'), index.mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('radio-button-wrapper__label-text--disabled'));
        const messageClasses = index$1.cx(index.prefix('radio-button-wrapper__message'), this.state !== 'none' && index.prefix(`radio-button-wrapper__message--${this.state}`));
