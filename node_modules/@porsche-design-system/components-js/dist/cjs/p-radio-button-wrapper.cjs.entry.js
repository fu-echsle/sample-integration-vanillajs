...
class RadioButtonWrapper {
    ...
    render() {
        const labelClasses = breakpointCustomizable.prefix('radio-button-wrapper__label');
        const fakeRadioButtonClasses = {
            [breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button')]: true,
            [breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button--checked')]: this.checked,
            [breakpointCustomizable.prefix('radio-button-wrapper__fake-radio-button--disabled')]: this.disabled,
            [breakpointCustomizable.prefix(`radio-button-wrapper__fake-radio-button--${this.state}`)]: this.state !== 'none'
        };
        const labelTextClasses = Object.assign({ [breakpointCustomizable.prefix('radio-button-wrapper__label-text')]: true, [breakpointCustomizable.prefix('radio-button-wrapper__label-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('radio-button-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const messageClasses = {
            [breakpointCustomizable.prefix('radio-button-wrapper__message')]: true,
            [breakpointCustomizable.prefix(`radio-button-wrapper__message--${this.state}`)]: this.state !== 'none'
        };
