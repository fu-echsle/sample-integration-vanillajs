...
class Link {
    ...
    `;
        slottedStyles.insertSlottedStyles(this.element, style);
        focusHandling.improveFocusHandlingForCustomElement(this.element);
    }
    render() {
        const TagType = this.href === undefined ? 'span' : 'a';
        const linkClasses = Object.assign({ [breakpointCustomizable.prefix('link')]: true, [breakpointCustomizable.prefix(`link--${this.variant}`)]: true, [breakpointCustomizable.prefix(`link--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']));
        const iconClasses = breakpointCustomizable.prefix('link__icon');
        const labelClasses = breakpointCustomizable.prefix('link__label');
        return (breakpointCustomizable.h(TagType, Object.assign({ class: linkClasses }, (TagType === 'a' && {
            href: this.href,
            target: `${this.target}`,
            download: this.download,
            rel: this.rel
        })), breakpointCustomizable.h("p-icon", { class: iconClasses, size: "inherit", name: this.icon, source: this.iconSource, color: "inherit", "aria-hidden": "true" }), breakpointCustomizable.h("p-text", { tag: "span", color: "inherit", class: labelClasses }, breakpointCustomizable.h("slot", null))));
    }
