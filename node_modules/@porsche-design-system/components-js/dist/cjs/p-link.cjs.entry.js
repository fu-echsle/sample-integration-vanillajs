...
class Link {
    ...
    render() {
        ...
        const linkClasses = index.classnames(breakpointCustomizable.prefix('link'), breakpointCustomizable.prefix(`link--${this.variant}`), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-', this.hideLabel, ['without-label', 'with-label']), breakpointCustomizable.prefix(`link--theme-${this.theme}`));
