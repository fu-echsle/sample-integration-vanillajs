...
const focusHandling = require('./focusHandling-75924aa2.js');
...
const handleResize = index_esm.throttle(500, () => {
...
class Pagination {
    constructor(hostRef) {
        ...
        this.theme = 'light';
        this.pageChange = breakpointCustomizable.createEvent(this, "pageChange", 7);
    }
    ...
    render() {
        const breakpointClasses = breakpointCustomizable.mapBreakpointPropToPrefixedClasses('pagination--size', this.maxNumberOfPageLinks);
        const pageRange = this.breakpointMaxNumberOfPageLinks === 7 ? 1 : 0;
        const paginationClasses = index.classnames(breakpointClasses, breakpointCustomizable.prefix('pagination'), breakpointCustomizable.prefix(`pagination--theme-${this.theme}`));
        const paginationItemsClasses = index.classnames(breakpointCustomizable.prefix('pagination__items'));
        ...
        const createPaginationItems = () => {
            ...
            let prevItem;
            let nextItem;
            const paginationItemClasses = index.classnames(breakpointCustomizable.prefix('pagination__item'));
            paginationModel.forEach((pageModel) => {
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    const paginationPrevClasses = index.classnames(breakpointCustomizable.prefix('pagination__prev'), !pageModel.isActive && breakpointCustomizable.prefix('pagination__prev--disabled'));
                    return (prevItem = (breakpointCustomizable.h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), breakpointCustomizable.h("span", { class: paginationPrevClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: () => this.onClick(pageModel.value), onKeyDown: (e) => this.onKeyDown(e, pageModel.value), "aria-disabled": !pageModel.isActive && 'true', "aria-label": this.allyLabelPrev }, breakpointCustomizable.h("p-icon", { name: "arrow-head-left", color: "inherit" })))));
                }
                if (pageModel.type === itemTypes.ELLIPSIS) {
                    const paginationGoToClasses = index.classnames(breakpointCustomizable.prefix('pagination__goto'), breakpointCustomizable.prefix('pagination__goto--ellipsis'));
                    pageItems.push(breakpointCustomizable.h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), breakpointCustomizable.h("span", { class: paginationGoToClasses })));
                }
                if (pageModel.type === itemTypes.PAGE) {
                    const paginationGoToClasses = index.classnames(breakpointCustomizable.prefix('pagination__goto'), pageModel.isActive && breakpointCustomizable.prefix('pagination__goto--current'));
                    pageItems.push(breakpointCustomizable.h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), breakpointCustomizable.h("span", { class: paginationGoToClasses, role: 'button', tabIndex: pageModel.isActive ? null : 0, "aria-disabled": pageModel.isActive && 'true', onClick: () => this.onClick(pageModel.value), onKeyDown: (e) => this.onKeyDown(e, pageModel.value), "aria-label": `${this.allyLabelPage} ${pageModel.value}`, "aria-current": pageModel.isActive && 'page' }, pageModel.value)));
                }
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    const paginationNextClasses = index.classnames(breakpointCustomizable.prefix('pagination__next'), !pageModel.isActive && breakpointCustomizable.prefix('pagination__next--disabled'));
                    return (nextItem = (breakpointCustomizable.h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), breakpointCustomizable.h("span", { class: paginationNextClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: () => this.onClick(pageModel.value), onKeyDown: (e) => this.onKeyDown(e, pageModel.value), "aria-disabled": !pageModel.isActive && 'true', "aria-label": this.allyLabelNext }, breakpointCustomizable.h("p-icon", { name: "arrow-head-right", color: "inherit" })))));
                }
            });
            return {
                prevItem,
        ...
        return (breakpointCustomizable.h("nav", { class: paginationClasses, role: "navigation", "aria-label": this.allyLabel, ref: (el) => (this.navigationElement = el) }, breakpointCustomizable.h("ul", { class: paginationItemsClasses }, paginationItems.prevItem, paginationItems.pageItems, paginationItems.nextItem)));
    }
    ...
    get element() { return breakpointCustomizable.getElement(this); }
