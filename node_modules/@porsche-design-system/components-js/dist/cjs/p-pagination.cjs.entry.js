...
class Pagination {
    ...
    render() {
        ...
        const paginationClasses = Object.assign({ [breakpointCustomizable.prefix('pagination')]: true, [breakpointCustomizable.prefix(`pagination--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('pagination--size', this.maxNumberOfPageLinks));
        const paginationItemsClasses = breakpointCustomizable.prefix('pagination__items');
        ...
        const createPaginationItems = () => {
            ...
            let prevItem;
            let nextItem;
            const paginationItemClasses = breakpointCustomizable.prefix('pagination__item');
            paginationModel.forEach((pageModel) => {
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    const paginationPrevClasses = {
                        [breakpointCustomizable.prefix('pagination__prev')]: true,
                        [breakpointCustomizable.prefix('pagination__prev--disabled')]: !pageModel.isActive
                    };
                ...
                if (pageModel.type === itemTypes.ELLIPSIS) {
                    const paginationGoToClasses = {
                        [breakpointCustomizable.prefix('pagination__goto')]: true,
                        [breakpointCustomizable.prefix('pagination__goto--ellipsis')]: true
                    };
                ...
                if (pageModel.type === itemTypes.PAGE) {
                    const paginationGoToClasses = {
                        [breakpointCustomizable.prefix('pagination__goto')]: true,
                        [breakpointCustomizable.prefix('pagination__goto--current')]: pageModel.isActive
                    };
                ...
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    const paginationNextClasses = {
                        [breakpointCustomizable.prefix('pagination__next')]: true,
                        [breakpointCustomizable.prefix('pagination__next--disabled')]: !pageModel.isActive
                    };
