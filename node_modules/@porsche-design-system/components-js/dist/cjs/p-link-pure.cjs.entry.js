...
const LinkPure = class {
    ...
    componentDidLoad() {
        ...
        index.transitionListener(this.linkTag, 'font-size', () => {
            const size = index.calcLineHeightForElement(this.linkTag);
    ...
    render() {
        ...
        const linkPureClasses = index$1.cx(index.prefix('link-pure'), index.mapBreakpointPropToPrefixedClasses('link-pure--size', this.size), index.prefix(`link-pure--theme-${this.theme}`), this.active && index.prefix('link-pure--active'));
        const iconClasses = index$1.cx(index.prefix('link-pure__icon'));
        const labelClasses = index$1.cx(index.prefix('link-pure__label'), index.mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = index$1.cx(index.prefix('link-pure__subline'), index.mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
        return (index.h(index.Host, null, index.h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a'
            ? {
                href: this.href,
                target: this.target,
