...
class LinkPure {
    ...
    componentDidLoad() {
        ...
        transitionListener.transitionListener(this.linkTag, 'font-size', () => {
            const size = lineHeight.calcLineHeightForElement(this.linkTag);
    ...
    render() {
        ...
        const linkPureClasses = index.classnames(breakpointCustomizable.prefix('link-pure'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-pure--size', this.size), breakpointCustomizable.prefix(`link-pure--theme-${this.theme}`), this.active && breakpointCustomizable.prefix('link-pure--active'));
        const iconClasses = index.classnames(breakpointCustomizable.prefix('link-pure__icon'));
        const labelClasses = index.classnames(breakpointCustomizable.prefix('link-pure__label'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = index.classnames(breakpointCustomizable.prefix('link-pure__subline'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('link-pure__subline-', this.hideLabel, ['hidden', 'visible']));
        return (breakpointCustomizable.h(breakpointCustomizable.Host, null, breakpointCustomizable.h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a'
            ? {
                href: this.href,
                target: this.target,
            ...
            : null), { ref: (el) => (this.linkTag = el) }), breakpointCustomizable.h("p-icon", { class: iconClasses, color: "inherit", size: "inherit", name: this.icon, source: this.iconSource, ref: (el) => (this.iconTag = el), "aria-hidden": "true" }), breakpointCustomizable.h("p-text", { class: labelClasses, tag: "span", color: "inherit", size: "inherit", weight: this.weight }, breakpointCustomizable.h("slot", null))), this.subline && (breakpointCustomizable.h("p-text", { class: sublineClasses, color: "inherit", size: "inherit", tag: "div" }, breakpointCustomizable.h("slot", { name: "subline" })))));
    }
    setSubline() {
