...
class TextFieldWrapper {
    ...
    render() {
        const containerClasses = breakpointCustomizable.prefix('text-field-wrapper__container');
        const labelClasses = breakpointCustomizable.prefix('text-field-wrapper__label');
        const labelTextClasses = Object.assign({ [breakpointCustomizable.prefix('text-field-wrapper__label-text')]: true, [breakpointCustomizable.prefix('text-field-wrapper__label-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const descriptionTextClasses = Object.assign({ [breakpointCustomizable.prefix('text-field-wrapper__description-text')]: true, [breakpointCustomizable.prefix('text-field-wrapper__description-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]));
        const fakeInputClasses = {
            [breakpointCustomizable.prefix('text-field-wrapper__fake-input')]: true,
            [breakpointCustomizable.prefix(`text-field-wrapper__fake-input--${this.state}`)]: this.state !== 'none',
            [breakpointCustomizable.prefix('text-field-wrapper__fake-input--disabled')]: this.disabled,
            [breakpointCustomizable.prefix('text-field-wrapper__fake-input--readonly')]: this.readonly
        };
        const buttonClasses = breakpointCustomizable.prefix('text-field-wrapper__button');
        const messageClasses = {
            [breakpointCustomizable.prefix('text-field-wrapper__message')]: true,
            [breakpointCustomizable.prefix(`text-field-wrapper__message--${this.state}`)]: this.state !== 'none'
        };
