...
const TextFieldWrapper = class {
    ...
    render() {
        const containerClasses = index$1.cx(index.prefix('text-field-wrapper__container'));
        const labelClasses = index$1.cx(index.prefix('text-field-wrapper__label'));
        const labelTextClasses = index$1.cx(index.prefix('text-field-wrapper__label-text'), index.mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('text-field-wrapper__label-text--disabled'));
        const descriptionTextClasses = index$1.cx(index.prefix('text-field-wrapper__description-text'), index.mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('text-field-wrapper__description-text--disabled'));
        const fakeInputClasses = index$1.cx(index.prefix('text-field-wrapper__fake-input'), this.state !== 'none' && index.prefix(`text-field-wrapper__fake-input--${this.state}`), this.disabled && index.prefix('text-field-wrapper__fake-input--disabled'), this.readonly && index.prefix('text-field-wrapper__fake-input--readonly'));
        const buttonClasses = index$1.cx(index.prefix('text-field-wrapper__button'));
        const messageClasses = index$1.cx(index.prefix('text-field-wrapper__message'), this.state !== 'none' && index.prefix(`text-field-wrapper__message--${this.state}`));
    ...
    bindStateListener() {
        index.transitionListener(this.input, 'border-top-color', () => {
            this.setState();
        });
    }
    ...
    onSubmitHandler(event) {
        if (this.isInputTypeSearch) {
            index.handleButtonEvent(event, this.host, () => this.searchButtonType, () => this.disabled);
        }
    }
    addSlottedStyles() {
