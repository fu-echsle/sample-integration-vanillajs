...
const TextFieldWrapper = class {
    ...
    render() {
        const containerClasses = index$1.cx(index$1.prefix('text-field-wrapper__container'));
        const labelClasses = index$1.cx(index$1.prefix('text-field-wrapper__label'));
        const labelTextClasses = index$1.cx(index$1.prefix('text-field-wrapper__label-text'), index$1.mapBreakpointPropToPrefixedClasses('text-field-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index$1.prefix('text-field-wrapper__label-text--disabled'));
        const descriptionTextClasses = index$1.cx(index$1.prefix('text-field-wrapper__description-text'), index$1.mapBreakpointPropToPrefixedClasses('text-field-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index$1.prefix('text-field-wrapper__description-text--disabled'));
        const fakeInputClasses = index$1.cx(index$1.prefix('text-field-wrapper__fake-input'), this.state !== 'none' && index$1.prefix(`text-field-wrapper__fake-input--${this.state}`), this.disabled && index$1.prefix('text-field-wrapper__fake-input--disabled'), this.readonly && index$1.prefix('text-field-wrapper__fake-input--readonly'));
        const buttonClasses = index$1.cx(index$1.prefix('text-field-wrapper__button'));
        const messageClasses = index$1.cx(index$1.prefix('text-field-wrapper__message'), this.state !== 'none' && index$1.prefix(`text-field-wrapper__message--${this.state}`));
        return (index.h(index.Host, null, index.h("div", { class: containerClasses }, index.h("label", { class: labelClasses }, this.isLabelVisible &&
            ...
            index.h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description ? this.description : index.h("span", null, index.h("slot", { name: 'description' }))), index.h("span", { class: fakeInputClasses }, index.h("slot", null))), this.isPasswordToggleable &&
            index.h("button", { type: 'button', class: buttonClasses, onClick: () => this.togglePassword(), disabled: this.disabled }, index.h("p-icon", { name: this.showPassword ? 'view-off' : 'view', color: 'inherit' })), this.isInputTypeSearch &&
            index.h("button", { onClick: (event) => this.onSubmitHandler(event), type: 'submit', class: buttonClasses, disabled: this.disabled || this.readonly }, index.h("p-icon", { name: 'search', color: 'inherit' }))), this.isMessageVisible &&
    ...
    bindStateListener() {
        index$1.transitionListener(this.input, 'border-top-color', () => {
            this.setState();
        });
    }
    ...
    onSubmitHandler(event) {
        if (this.isInputTypeSearch) {
            index$1.handleButtonEvent(event, this.host, () => this.searchButtonType, () => this.disabled);
        }
    }
    addSlottedStyles() {
