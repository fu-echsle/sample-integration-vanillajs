...
const TextareaWrapper = class {
    ...
    render() {
        ...
        const descriptionTextClasses = index$1.cx(index$1.prefix('textarea-wrapper__description-text'), index$1.mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index$1.prefix('textarea-wrapper__description-text--disabled'));
        ...
        return (index.h(index.Host, null, index.h("label", { class: labelClasses }, this.isLabelVisible &&
            index.h("p-text", { class: labelTextClasses, color: 'inherit', tag: 'span', onClick: () => this.labelClick() }, this.label ? this.label : index.h("span", null, index.h("slot", { name: 'label' }))), this.isDescriptionVisible &&
            index.h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description ? this.description : index.h("span", null, index.h("slot", { name: 'description' }))), index.h("span", { class: fakeTextareaClasses }, index.h("slot", null))), this.isMessageVisible &&
