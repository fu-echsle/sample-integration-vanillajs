...
const TextareaWrapper = class {
    ...
    render() {
        const labelClasses = index$1.cx(index.prefix('textarea-wrapper__label'));
        const labelTextClasses = index$1.cx(index.prefix('textarea-wrapper__label-text'), index.mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('textarea-wrapper__label-text--disabled'));
        const descriptionTextClasses = index$1.cx(index.prefix('textarea-wrapper__description-text'), index.mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('textarea-wrapper__description-text--disabled'));
        const fakeTextareaClasses = index$1.cx(index.prefix('textarea-wrapper__fake-textarea'), index.prefix(`textarea-wrapper__fake-textarea--${this.state}`), this.disabled && index.prefix('textarea-wrapper__fake-textarea--disabled'), this.readonly && index.prefix('textarea-wrapper__fake-textarea--readonly'));
        const messageClasses = index$1.cx(index.prefix('textarea-wrapper__message'), index.prefix(`textarea-wrapper__message--${this.state}`));
    ...
    bindStateListener() {
        index.transitionListener(this.textarea, 'border-top-color', () => {
            this.setState();
        });
    }
    addSlottedStyles() {
