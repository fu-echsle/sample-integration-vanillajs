...
class TextareaWrapper {
    ...
    render() {
        const labelClasses = index.classnames(breakpointCustomizable.prefix('textarea-wrapper__label'));
        const labelTextClasses = index.classnames(breakpointCustomizable.prefix('textarea-wrapper__label-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && breakpointCustomizable.prefix('textarea-wrapper__label-text--disabled'));
        const descriptionTextClasses = index.classnames(breakpointCustomizable.prefix('textarea-wrapper__description-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && breakpointCustomizable.prefix('textarea-wrapper__description-text--disabled'));
        const fakeTextareaClasses = index.classnames(breakpointCustomizable.prefix('textarea-wrapper__fake-textarea'), breakpointCustomizable.prefix(`textarea-wrapper__fake-textarea--${this.state}`), this.disabled && breakpointCustomizable.prefix('textarea-wrapper__fake-textarea--disabled'), this.readonly && breakpointCustomizable.prefix('textarea-wrapper__fake-textarea--readonly'));
        const messageClasses = index.classnames(breakpointCustomizable.prefix('textarea-wrapper__message'), breakpointCustomizable.prefix(`textarea-wrapper__message--${this.state}`));
        return (breakpointCustomizable.h(breakpointCustomizable.Host, null, breakpointCustomizable.h("label", { class: labelClasses }, this.isLabelVisible && (breakpointCustomizable.h("p-text", { class: labelTextClasses, color: "inherit", tag: "span", onClick: this.labelClick }, this.label || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "label" }))))), this.isDescriptionVisible && (breakpointCustomizable.h("p-text", { class: descriptionTextClasses, tag: "span", color: "inherit", size: "x-small", onClick: this.labelClick }, this.description || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "description" }))))), breakpointCustomizable.h("span", { class: fakeTextareaClasses }, breakpointCustomizable.h("slot", null))), this.isMessageVisible && (breakpointCustomizable.h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
    ...
    bindStateListener() {
        transitionListener.transitionListener(this.textarea, 'border-top-color', this.setState);
    }
    addSlottedStyles() {
