...
class TextareaWrapper {
    ...
    render() {
        const labelClasses = breakpointCustomizable.prefix('textarea-wrapper__label');
        const labelTextClasses = Object.assign({ [breakpointCustomizable.prefix('textarea-wrapper__label-text')]: true, [breakpointCustomizable.prefix('textarea-wrapper__label-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('textarea-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const descriptionTextClasses = Object.assign({ [breakpointCustomizable.prefix('textarea-wrapper__description-text')]: true, [breakpointCustomizable.prefix('textarea-wrapper__description-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('textarea-wrapper__description-text-', this.hideLabel, [
            'hidden',
            'visible'
        ]));
        const fakeTextareaClasses = {
            [breakpointCustomizable.prefix('textarea-wrapper__fake-textarea')]: true,
            [breakpointCustomizable.prefix(`textarea-wrapper__fake-textarea--${this.state}`)]: true,
            [breakpointCustomizable.prefix('textarea-wrapper__fake-textarea--disabled')]: this.disabled,
            [breakpointCustomizable.prefix('textarea-wrapper__fake-textarea--readonly')]: this.readonly
        };
        const messageClasses = {
            [breakpointCustomizable.prefix('textarea-wrapper__message')]: true,
            [breakpointCustomizable.prefix(`textarea-wrapper__message--${this.state}`)]: true
        };
