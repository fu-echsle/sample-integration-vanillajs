...
class Divider {
    ...
    render() {
        const dividerClasses = index.classnames(breakpointCustomizable.prefix('divider'), breakpointCustomizable.prefix(`divider--color-${this.color}`), breakpointCustomizable.prefix(`divider--theme-${this.theme}`), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
