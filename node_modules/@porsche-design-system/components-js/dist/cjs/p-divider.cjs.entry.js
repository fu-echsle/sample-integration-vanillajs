...
class Divider {
    ...
    render() {
        const dividerClasses = Object.assign({ [breakpointCustomizable.prefix('divider')]: true, [breakpointCustomizable.prefix(`divider--color-${this.color}`)]: true, [breakpointCustomizable.prefix(`divider--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('divider--orientation', this.orientation));
        return (breakpointCustomizable.h("hr", { class: dividerClasses }));
    }
}
