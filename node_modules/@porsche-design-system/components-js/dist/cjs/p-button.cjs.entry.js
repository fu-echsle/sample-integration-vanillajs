...
class Button {
    ...
    render() {
        const buttonClasses = Object.assign({ [breakpointCustomizable.prefix('button')]: true, [breakpointCustomizable.prefix(`button--${this.variant}`)]: true, [breakpointCustomizable.prefix(`button--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('button-', this.hideLabel, ['without-label', 'with-label']));
