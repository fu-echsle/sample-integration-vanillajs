...
class Button {
    ...
    componentDidLoad() {
        ...
        buttonHandling.improveButtonHandlingForCustomElement(this.element, () => this.type, () => this.isDisabled());
    }
    render() {
        const buttonClasses = index.classnames(breakpointCustomizable.prefix('button'), breakpointCustomizable.prefix(`button--${this.variant}`), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('button-', this.hideLabel, ['without-label', 'with-label']), breakpointCustomizable.prefix(`button--theme-${this.theme}`));
        const iconClasses = breakpointCustomizable.prefix('button__icon');
        const labelClasses = breakpointCustomizable.prefix('button__label');
        return (breakpointCustomizable.h("button", { class: buttonClasses, type: this.type, disabled: this.isDisabled(), tabindex: this.tabbable ? 0 : -1, "aria-busy": this.loading && 'true' }, this.loading ? (breakpointCustomizable.h("p-spinner", { class: iconClasses, size: "inherit", theme: (this.variant === 'tertiary' && this.theme) || 'dark' })) : (breakpointCustomizable.h("p-icon", { class: iconClasses, size: "inherit", name: this.icon, source: this.iconSource, color: "inherit", "aria-hidden": "true" })), breakpointCustomizable.h("p-text", { class: labelClasses, tag: "span", color: "inherit" }, breakpointCustomizable.h("slot", null))));
    }
    isDisabled() {
