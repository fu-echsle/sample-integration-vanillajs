...
class ContentWrapper {
    ...
    render() {
        const contentWrapperClasses = index.classnames(breakpointCustomizable.prefix('content-wrapper'), breakpointCustomizable.prefix(`content-wrapper--${this.width}`));
        return (breakpointCustomizable.h("div", { class: contentWrapperClasses }, breakpointCustomizable.h("slot", null)));
    }
}
