...
class Spinner {
    ...
    render() {
        const spinnerClasses = Object.assign({ [breakpointCustomizable.prefix('spinner')]: true, [breakpointCustomizable.prefix(`spinner--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('spinner--size', this.size));
