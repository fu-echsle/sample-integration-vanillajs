...
const Spinner = class {
    ...
    render() {
        const spinnerClasses = index$1.cx(index$1.prefix('spinner'), index$1.mapBreakpointPropToPrefixedClasses('spinner--size', this.size), index$1.prefix(`spinner--theme-${this.theme}`));
        const imageClasses = index$1.prefix('spinner__image');
        const bgClasses = index$1.prefix('spinner__bg');
        const fgClasses = index$1.prefix('spinner__fg');
        return (index.h("span", { class: spinnerClasses, "aria-busy": 'true', "aria-live": 'polite' }, index.h("svg", { class: imageClasses, viewBox: '0 0 32 32', width: '100%', height: '100%', role: 'img', focusable: 'false' }, index.h("circle", { class: bgClasses, cx: '50%', cy: '50%', r: '9' }), index.h("circle", { class: fgClasses, cx: '50%', cy: '50%', r: '9' }))));
    }
};
