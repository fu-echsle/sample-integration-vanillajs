...
const Spinner = class {
    ...
    render() {
        const spinnerClasses = index$1.cx(index.prefix('spinner'), index.mapBreakpointPropToPrefixedClasses('spinner--size', this.size), index.prefix(`spinner--theme-${this.theme}`));
        const imageClasses = index.prefix('spinner__image');
        const bgClasses = index.prefix('spinner__bg');
        const fgClasses = index.prefix('spinner__fg');
