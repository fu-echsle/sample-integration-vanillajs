...
class Spinner {
    ...
    render() {
        const spinnerClasses = index.classnames(breakpointCustomizable.prefix('spinner'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('spinner--size', this.size), breakpointCustomizable.prefix(`spinner--theme-${this.theme}`));
        const imageClasses = breakpointCustomizable.prefix('spinner__image');
        const bgClasses = breakpointCustomizable.prefix('spinner__bg');
        const fgClasses = breakpointCustomizable.prefix('spinner__fg');
        return (breakpointCustomizable.h("span", { class: spinnerClasses, "aria-busy": 'true', "aria-live": 'polite' }, breakpointCustomizable.h("svg", { class: imageClasses, viewBox: '0 0 32 32', width: '100%', height: '100%', role: 'img', focusable: 'false' }, breakpointCustomizable.h("circle", { class: bgClasses, cx: '50%', cy: '50%', r: '9' }), breakpointCustomizable.h("circle", { class: fgClasses, cx: '50%', cy: '50%', r: '9' }))));
    }
}
