...
const index = require('./index-fc70b69d.js');
...
const buildIconUrl = (iconNameOrSource = DEFAULT_ICON_NAME) => {
    const cdnBaseUrl =  index.CDN_BASE_URL$1 ;
    ...
    else if (index.ICONS_MANIFEST[camelCase(iconNameOrSource)]) {
        // check if IconName exists
        return `${cdnBaseUrl}/${index.ICONS_MANIFEST[camelCase(iconNameOrSource)]}`;
    }
...
class Icon {
    ...
    loadIcon() {
        ...
        if ( this.isVisible) {
            ...
            getSvgContent(url).then((iconContent) => {
                ...
                if (url === buildIconUrl((_a = this.source) !== null && _a !== void 0 ? _a : this.name)) {
    ...
    render() {
        const iconClasses = {
            [breakpointCustomizable.prefix('icon')]: true,
            [breakpointCustomizable.prefix(`icon--size-${this.size}`)]: true,
            [breakpointCustomizable.prefix(`icon--color-${this.color}`)]: true,
            [breakpointCustomizable.prefix(`icon--theme-${this.theme}`)]: this.color !== 'inherit'
        };
...
class Text {
    ...
    render() {
        ...
        const textClasses = Object.assign({ [breakpointCustomizable.prefix('text')]: true, [breakpointCustomizable.prefix(`text--weight-${this.weight}`)]: true, [breakpointCustomizable.prefix(`text--align-${this.align}`)]: true, [breakpointCustomizable.prefix(`text--color-${this.color}`)]: true, [breakpointCustomizable.prefix('text--ellipsis')]: this.ellipsis, [breakpointCustomizable.prefix(`text--theme-${this.theme}`)]: this.color !== 'inherit' }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('text--size', this.size));
