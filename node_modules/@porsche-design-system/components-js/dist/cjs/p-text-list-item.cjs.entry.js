...
class TextListItem {
    ...
    render() {
        const textListItemClasses = index.classnames(breakpointCustomizable.prefix('text-list-item'), breakpointCustomizable.prefix(`text-list-item--${this.typeOfList}`), {
            [breakpointCustomizable.prefix(`text-list-item--ordered-${this.typeOfOrderedList}`)]: this.typeOfList === 'ordered',
            [breakpointCustomizable.prefix('text-list-item--nested')]: this.isNestedList
        });
        return (breakpointCustomizable.h(breakpointCustomizable.Host, { role: 'listitem', class: textListItemClasses }, breakpointCustomizable.h("slot", null)));
    }
    get typeOfList() {
        const list = this.host.closest(breakpointCustomizable.prefix('text-list'));
    ...
    get isNestedList() {
        return !!this.host.closest(breakpointCustomizable.prefix('text-list[nested]'));
    }
    addSlottedStyles() {
