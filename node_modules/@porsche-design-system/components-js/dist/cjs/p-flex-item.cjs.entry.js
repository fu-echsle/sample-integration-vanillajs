...
const FlexItem = class {
    ...
    render() {
        const flexItemClasses = index$1.cx(index$1.prefix('flex__item'), this.width !== 'auto' && index$1.mapBreakpointPropToPrefixedClasses('flex__item--width', this.width), this.offset !== 'none' && index$1.mapBreakpointPropToPrefixedClasses('flex__item--offset', this.offset), this.alignSelf !== 'auto' && index$1.mapBreakpointPropToPrefixedClasses('flex__item--align-self', this.alignSelf), this.grow !== 0 && index$1.mapBreakpointPropToPrefixedClasses('flex__item--grow', this.grow), this.shrink !== 1 && index$1.mapBreakpointPropToPrefixedClasses('flex__item--shrink', this.shrink), this.flex !== 'initial' && index$1.mapBreakpointPropToPrefixedClasses('flex__item-', this.flex));
