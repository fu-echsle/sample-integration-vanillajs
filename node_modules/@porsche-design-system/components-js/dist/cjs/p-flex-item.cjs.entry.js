...
const FlexItem = class {
    ...
    render() {
        const flexItemClasses = index$1.cx(index.prefix('flex__item'), this.width !== 'auto' && index.mapBreakpointPropToPrefixedClasses('flex__item--width', this.width), this.offset !== 'none' && index.mapBreakpointPropToPrefixedClasses('flex__item--offset', this.offset), this.alignSelf !== 'auto' && index.mapBreakpointPropToPrefixedClasses('flex__item--align-self', this.alignSelf), this.grow !== 0 && index.mapBreakpointPropToPrefixedClasses('flex__item--grow', this.grow), this.shrink !== 1 && index.mapBreakpointPropToPrefixedClasses('flex__item--shrink', this.shrink), this.flex !== 'initial' && index.mapBreakpointPropToPrefixedClasses('flex__item-', this.flex));
        return index.h(index.Host, { class: flexItemClasses });
    }
};
