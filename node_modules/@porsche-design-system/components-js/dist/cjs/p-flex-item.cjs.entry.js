...
class FlexItem {
    ...
    render() {
        const flexItemClasses = index.classnames(breakpointCustomizable.prefix('flex__item'), this.width !== 'auto' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item--width', this.width), this.offset !== 'none' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item--offset', this.offset), this.alignSelf !== 'auto' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item--align-self', this.alignSelf), this.grow !== 0 && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item--grow', this.grow), this.shrink !== 1 && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item--shrink', this.shrink), this.flex !== 'initial' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex__item-', this.flex));
        return breakpointCustomizable.h(breakpointCustomizable.Host, { class: flexItemClasses });
    }
}
