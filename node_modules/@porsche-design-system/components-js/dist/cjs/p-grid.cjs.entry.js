...
const Grid = class {
    ...
    render() {
        const gridClasses = index$1.cx(index.prefix('grid'), this.direction !== 'row' && index.mapBreakpointPropToPrefixedClasses('grid--direction', this.direction));
        return index.h(index.Host, { class: gridClasses });
    }
};
Grid.style = gridCss;
