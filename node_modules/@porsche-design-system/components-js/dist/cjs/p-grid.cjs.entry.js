...
class Grid {
    ...
    render() {
        const gridClasses = index.classnames(breakpointCustomizable.prefix('grid'), this.direction !== 'row' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('grid--direction', this.direction));
        return breakpointCustomizable.h(breakpointCustomizable.Host, { class: gridClasses });
    }
}
Grid.style = gridCss;
