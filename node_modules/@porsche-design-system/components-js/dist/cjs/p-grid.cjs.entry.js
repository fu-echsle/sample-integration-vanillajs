...
class Grid {
    ...
    render() {
        const gridClasses = Object.assign({ [breakpointCustomizable.prefix('grid')]: true }, (this.direction !== 'row' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('grid--direction', this.direction)));
