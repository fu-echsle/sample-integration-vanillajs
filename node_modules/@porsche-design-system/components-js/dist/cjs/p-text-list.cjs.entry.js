...
class TextList {
    ...
    render() {
        ...
        const textListClasses = {
            [breakpointCustomizable.prefix('text-list')]: true,
            [breakpointCustomizable.prefix(`text-list--${this.listType}`)]: true,
            [breakpointCustomizable.prefix(`text-list--theme-${this.theme}`)]: true,
            [breakpointCustomizable.prefix('text-list--nested')]: this.isNestedList
        };
