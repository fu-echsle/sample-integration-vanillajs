...
const lineHeight = require('./line-height-91df7d43.js');
...
class ButtonPure {
    ...
    render() {
        const buttonPureClasses = Object.assign({ [breakpointCustomizable.prefix('button-pure')]: true, [breakpointCustomizable.prefix(`button-pure--theme-${this.theme}`)]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('button-pure--size', this.size));
        const iconClasses = breakpointCustomizable.prefix('button-pure__icon');
        const labelClasses = Object.assign({ [breakpointCustomizable.prefix('button-pure__label')]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('button-pure__label-', this.hideLabel, ['hidden', 'visible']));
        const sublineClasses = Object.assign({ [breakpointCustomizable.prefix('button-pure__subline')]: true }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('button-pure__subline-', this.hideLabel, ['hidden', 'visible']));
