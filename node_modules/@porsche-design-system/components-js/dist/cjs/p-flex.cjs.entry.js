...
class Flex {
    ...
    render() {
        const flexClasses = index.classnames(breakpointCustomizable.prefix('flex'), this.inline !== false && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex-', this.inline, ['inline', 'default']), this.wrap !== 'nowrap' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex--wrap', this.wrap), this.direction !== 'row' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex--direction', this.direction), this.justifyContent !== 'flex-start' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex--justify-content', this.justifyContent), this.alignItems !== 'stretch' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex--align-items', this.alignItems), this.alignContent !== 'stretch' && breakpointCustomizable.mapBreakpointPropToPrefixedClasses('flex--align-content', this.alignContent));
        return (breakpointCustomizable.h(breakpointCustomizable.Host, { class: flexClasses }));
    }
}
Flex.style = flexCss;
