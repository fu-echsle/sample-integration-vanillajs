...
const Flex = class {
    ...
    render() {
        const flexClasses = index$1.cx(index$1.prefix('flex'), this.inline !== false && index$1.mapBreakpointPropToPrefixedClasses('flex-', this.inline, ['inline', 'default']), this.wrap !== 'nowrap' && index$1.mapBreakpointPropToPrefixedClasses('flex--wrap', this.wrap), this.direction !== 'row' && index$1.mapBreakpointPropToPrefixedClasses('flex--direction', this.direction), this.justifyContent !== 'flex-start' && index$1.mapBreakpointPropToPrefixedClasses('flex--justify-content', this.justifyContent), this.alignItems !== 'stretch' && index$1.mapBreakpointPropToPrefixedClasses('flex--align-items', this.alignItems), this.alignContent !== 'stretch' && index$1.mapBreakpointPropToPrefixedClasses('flex--align-content', this.alignContent));
