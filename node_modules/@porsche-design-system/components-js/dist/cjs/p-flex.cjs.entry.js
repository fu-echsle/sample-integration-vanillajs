...
const Flex = class {
    ...
    render() {
        const flexClasses = index$1.cx(index.prefix('flex'), this.inline !== false && index.mapBreakpointPropToPrefixedClasses('flex-', this.inline, ['inline', 'default']), this.wrap !== 'nowrap' && index.mapBreakpointPropToPrefixedClasses('flex--wrap', this.wrap), this.direction !== 'row' && index.mapBreakpointPropToPrefixedClasses('flex--direction', this.direction), this.justifyContent !== 'flex-start' && index.mapBreakpointPropToPrefixedClasses('flex--justify-content', this.justifyContent), this.alignItems !== 'stretch' && index.mapBreakpointPropToPrefixedClasses('flex--align-items', this.alignItems), this.alignContent !== 'stretch' && index.mapBreakpointPropToPrefixedClasses('flex--align-content', this.alignContent));
        return (index.h(index.Host, { class: flexClasses }));
    }
};
Flex.style = flexCss;
