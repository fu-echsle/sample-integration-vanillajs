...
const CheckboxWrapper = class {
    ...
    render() {
        const labelClasses = index$1.cx(index.prefix('checkbox-wrapper__label'));
        const fakeCheckboxClasses = index$1.cx(index.prefix('checkbox-wrapper__fake-checkbox'), (this.checked || this.indeterminate) && index.prefix('checkbox-wrapper__fake-checkbox--checked'), this.disabled && index.prefix('checkbox-wrapper__fake-checkbox--disabled'), this.state !== 'none' && index.prefix(`checkbox-wrapper__fake-checkbox--${this.state}`));
        const iconClasses = index$1.cx(index.prefix('checkbox-wrapper__icon'), (this.checked || this.indeterminate) && index.prefix('checkbox-wrapper__icon--checked'));
        const labelTextClasses = index$1.cx(index.prefix('checkbox-wrapper__label-text'), index.mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && index.prefix('checkbox-wrapper__label-text--disabled'));
        const messageClasses = index$1.cx(index.prefix('checkbox-wrapper__message'), this.state !== 'none' && index.prefix(`checkbox-wrapper__message--${this.state}`));
        return (index.h(index.Host, null, index.h("label", { class: labelClasses }, this.isLabelVisible &&
            index.h("p-text", { class: labelTextClasses, tag: 'span', color: 'inherit', onClick: (e) => this.labelClick(e) }, this.label ? this.label : index.h("span", null, index.h("slot", { name: 'label' }))), index.h("span", { class: fakeCheckboxClasses }, index.h("p-icon", { class: iconClasses, name: this.indeterminate ? 'minus' : 'check', theme: 'dark', size: 'inherit', "aria-hidden": 'true' }), index.h("slot", null))), this.isMessageVisible &&
