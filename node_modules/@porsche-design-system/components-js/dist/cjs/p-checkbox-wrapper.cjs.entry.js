...
class CheckboxWrapper {
    ...
    render() {
        const labelClasses = index.classnames(breakpointCustomizable.prefix('checkbox-wrapper__label'));
        const fakeCheckboxClasses = index.classnames(breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox'), (this.checked || this.indeterminate) && breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox--checked'), this.disabled && breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox--disabled'), this.state !== 'none' && breakpointCustomizable.prefix(`checkbox-wrapper__fake-checkbox--${this.state}`));
        const iconClasses = index.classnames(breakpointCustomizable.prefix('checkbox-wrapper__icon'), (this.checked || this.indeterminate) && breakpointCustomizable.prefix('checkbox-wrapper__icon--checked'));
        const labelTextClasses = index.classnames(breakpointCustomizable.prefix('checkbox-wrapper__label-text'), breakpointCustomizable.mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && breakpointCustomizable.prefix('checkbox-wrapper__label-text--disabled'));
        const messageClasses = index.classnames(breakpointCustomizable.prefix('checkbox-wrapper__message'), this.state !== 'none' && breakpointCustomizable.prefix(`checkbox-wrapper__message--${this.state}`));
        return (breakpointCustomizable.h(breakpointCustomizable.Host, null, breakpointCustomizable.h("label", { class: labelClasses }, this.isLabelVisible && (breakpointCustomizable.h("p-text", { class: labelTextClasses, tag: "span", color: "inherit", onClick: this.labelClick }, this.label || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "label" }))))), breakpointCustomizable.h("span", { class: fakeCheckboxClasses }, breakpointCustomizable.h("p-icon", { class: iconClasses, name: this.indeterminate ? 'minus' : 'check', theme: "dark", size: "inherit", "aria-hidden": "true" }), breakpointCustomizable.h("slot", null))), this.isMessageVisible && (breakpointCustomizable.h("p-text", { class: messageClasses, color: "inherit", role: this.state === 'error' && 'alert' }, this.message || (breakpointCustomizable.h("span", null, breakpointCustomizable.h("slot", { name: "message" })))))));
    }
    get isLabelVisible() {
