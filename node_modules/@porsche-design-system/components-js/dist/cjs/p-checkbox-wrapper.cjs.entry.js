...
class CheckboxWrapper {
    ...
    render() {
        const labelClasses = breakpointCustomizable.prefix('checkbox-wrapper__label');
        const fakeCheckboxClasses = {
            [breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox')]: true,
            [breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox--checked')]: this.checked || this.indeterminate,
            [breakpointCustomizable.prefix('checkbox-wrapper__fake-checkbox--disabled')]: this.disabled,
            [breakpointCustomizable.prefix(`checkbox-wrapper__fake-checkbox--${this.state}`)]: this.state !== 'none'
        };
        const iconClasses = {
            [breakpointCustomizable.prefix('checkbox-wrapper__icon')]: true,
            [breakpointCustomizable.prefix('checkbox-wrapper__icon--checked')]: this.checked || this.indeterminate
        };
        const labelTextClasses = Object.assign({ [breakpointCustomizable.prefix('checkbox-wrapper__label-text')]: true, [breakpointCustomizable.prefix('checkbox-wrapper__label-text--disabled')]: this.disabled }, breakpointCustomizable.mapBreakpointPropToPrefixedClasses('checkbox-wrapper__label-text-', this.hideLabel, ['hidden', 'visible']));
        const messageClasses = {
            [breakpointCustomizable.prefix('checkbox-wrapper__message')]: true,
            [breakpointCustomizable.prefix(`checkbox-wrapper__message--${this.state}`)]: this.state !== 'none'
        };
