...
const index = require('./index-f35b5e1a.js');
...
const EMPTY_ITEM = { Id: '', PhraseId: '', Text: '', IsLinkItem: false };
...
const StateTunnel = createProviderConsumer({
...
const BurgerButton = class {
    ...
    sendMoreClickAnalyticsEvent() {
        ...
        const moreClickEvent = new MoreClickEvent(analyticsSetup, this.menu[0]);
        const pagData = (window['pagData'] = window['pagData'] || []);
        pagData.push(moreClickEvent.event());
    }
    render() {
        const text = this.menu && this.menu.length > 0 ? this.menu[0].Text : '';
        return (index.h(index.Host, { class: "burger-button", onClick: () => this.sendMoreClickAnalyticsEvent() }, index.h("p-text", { size: "inherit", class: "burger-button-text" }, text), index.h("p-icon", { class: "burger-button-icon", size: "small", name: "menu-lines" })));
    }
};
...
const ButtonExtended = class {
    ...
    render() {
        return (index.h("button", null, index.h("p-text", { color: "inherit", size: "inherit", tag: "div" }, index.h("slot", null)), this.icon ? index.h("p-icon", { color: "inherit", size: "small", name: this.icon }) : null));
    }
};
...
const carFurtherLinksCss = "@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center}}.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{border-bottom:1px solid #c9cacb;margin-bottom:3.75rem}@media (min-width: 1300px){.car-further-links.sc-phn-car-further-links .car-further-links-wrapper.sc-phn-car-further-links{padding:0.875rem 0;border-top:1px solid #c9cacb;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;margin-bottom:unset}}.car-further-links-item.sc-phn-car-further-links{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;font-weight:normal;-ms-flex-align:center;align-items:center;border-top:1px solid #c9cacb;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:1rem;padding:15px 0}.car-further-links-item.sc-phn-car-further-links:first-child{border-top:0}@media (min-width: 760px) and (max-width: 999px){.car-further-links-item.sc-phn-car-further-links{font-size:1.125rem;padding:18px 0}}@media (min-width: 1300px){.car-further-links-item.sc-phn-car-further-links{height:1.5rem;padding:0 0.625rem;border-top:0;-webkit-box-sizing:unset;box-sizing:unset}.car-further-links-item.sc-phn-car-further-links:first-child{margin-right:0.25rem}}";
...
const CarModel = class {
    ...
    render() {
        const path = index.getAssetPath(`${config(this.env).ASSETS_URL}/model-assets`);
        return (index.h("a", { class: "car-model", href: this.link }, index.h("picture", { class: "model-pic" }, index.h("source", { type: "image/png", media: "(min-width: 1920px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), index.h("img", { src: `${path}/1366/${this.image}.png`, alt: this.text })), index.h("div", { class: "model-text" }, this.text)));
    }
...
const CarSeries = class {
    ...
    render() {
        const path = index.getAssetPath(`${config(this.env).ASSETS_URL}/series-assets`);
        return (index.h("div", { class: "car-series" }, index.h("picture", null, index.h("source", { type: "image/png", media: "(min-width: 1920px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1760px)", srcSet: `${path}/1920/${this.image}.png, ${path}/1920/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1300px)", srcSet: `${path}/1366/${this.image}.png, ${path}/1366/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 1000px)", srcSet: `${path}/1024/${this.image}.png, ${path}/1024/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 760px)", srcSet: `${path}/768/${this.image}.png, ${path}/768/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 375px)", srcSet: `${path}/375/${this.image}.png, ${path}/375/${this.image}@2x.png 2x` }), index.h("source", { type: "image/png", media: "(min-width: 0px)", srcSet: `${path}/320/${this.image}.png, ${path}/320/${this.image}@2x.png 2x` }), index.h("img", { src: `${path}/1366/${this.image}.png`, alt: this.text })), index.h("p", { class: "car-series-text" }, this.text)));
    }
...
const CloseButton = class {
    ...
    render() {
        return (index.h("div", { class: "close-button-wrapper", onClick: (e) => {
                this.closeEventfun(e);
            } }, index.h("p-icon", { class: "close-button close-button-icon", name: "close", size: "small" })));
    }
};
...
const Crest = class {
    ...
    render() {
        return (index.h("a", { class: "crest", onClick: () => this.sendCrestClickAnalyticsEvent(), href: "//www.porsche.com/swiss/de/" }, index.h("p-marque", { class: "marque" })));
    }
};
Crest.style = crestCss;

class LinkItem {
    constructor(_id, _text, _link) {
...
const DealerSearch = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-link-pure", { href: this.dealerSearchLink, size: "inherit", icon: "pin", onClick: () => {
                const linkItem = new LinkItem(DEALER_SEARCH_PHRASE_ID, this.dealerSearchText, this.dealerSearchLink);
...
const DrawerCarSeriesModelOverview = class {
    ...
    render() {
        const backButtonText = this.hasMenu() ? this.menu[0].Text : '';
        const backButtonId = this.hasMenu() ? this.menu[0].PhraseId : '';
    ...
    render() {
        ...
        return (index.h("div", { class: `drawer-shops-and-more drawer-level-${this.level}-item-scroll drawer-level-${this.level}-item` }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-back-and-close" }, index.h("phn-back-button", { class: "back-button", onClick: () => this.hideDrawer(), buttonId: buttonId, text: buttonText }), index.h("phn-close-button", { class: "close-button" })), index.h("phn-headline", { text: _headline, class: "drawer-headline" }), this.item.Items &&
            this.item.Items.map((item, index$1) => {
                let innerOverlayEl;
                return (index.h("div", null, index.h("phn-list-item", { item: item, onClick: () => {
                        if (!item.IsLinkItem) {
                            innerOverlayEl.style.display = 'block';
                            this.setActiveDrawer(innerOverlayEl, this.level + 1);
                        }
                    }, class: 'shops-and-more-item shops-and-more-item-' + index$1 }), item.IsLinkItem ? null : (index.h("phn-drawer-shops-and-more", { headline: item.Items && item.Items.length === 1 ? item.Text : '', ref: (el) => (innerOverlayEl = el), item: item, level: this.level + 1, class: 'drawer-level-2 drawer-level-2-' + index$1, backButtonText: this.item.Text, backButtonId: this.item.PhraseId, closeActiveDrawer: this.closeActiveDrawer, setActiveDrawer: this.setActiveDrawer }))));
            }))));
    }
...
const getLoggedInStatus = async (accessToken, locale, defaultLoggedInStatus, env) => {
...
const Header = class {
    ...
    async updateLoggedInStatus(newToken) {
        ...
        const userLoggedInStatus = await getLoggedInStatus(newToken, this.localeObject, LOGGED_IN_USER_NO_NAME_STATUS, this.env);
        if (!userLoggedInStatus) {
    ...
    render() {
        ...
        return (index.h("div", { class: "header-container" }, index.h("div", { class: "header limit-stretch" }, index.h("div", { class: "crest-burger-btn-container" }, index.h("phn-crest", { class: "crest" }), index.h("phn-burger-button", { class: "burger-button", onClick: () => menuDrawerLevel1.show() })), index.h(StateTunnel.Provider, { state: this.appData }, index.h("div", { class: "menu-container" }, index.h("phn-menu-desktop-level-1", { class: "menu-desktop-level-1" })), index.h("phn-menu-drawer-level-1", { ref: (el) => (menuDrawerLevel1 = el) }))), index.h("div", { class: "header-border" }), this.env === 'preview' && index.h("phn-preview-badge", { versionString: `Header ${VERSION} - PP content` }), this.isFeature1Enabled && (index.h("div", null, index.h("br", null), index.h("br", null), "Booyah!!! Enabled feature 1!!!"))));
    }
...
const ListItem = class {
    ...
    renderTextItem(textItem) {
        return (index.h("phn-button-extended", { class: "list-item-button", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(textItem) }, index.h("span", { class: "list-item-text" }, textItem.Text)));
    }
    render() {
...
const megaFlyOutOverlayCss = ".backdrop.sc-phn-mega-fly-out-overlay{position:fixed;z-index:200;left:0;right:0;background:rgba(0, 0, 0, 0.5);pointer-events:none;height:100vh;margin-top:1px}@media (min-width: 1300px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button.sc-phn-mega-fly-out-overlay{border-bottom:2px solid transparent}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay{border-bottom:2px solid #d5001c}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-button-active.sc-phn-mega-fly-out-overlay:hover{color:#d5001c}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{display:block;visibility:hidden;width:100%;position:absolute;left:0;z-index:300;max-height:0;overflow:hidden}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:117px}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay{top:123px}}.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{background-color:#fff;border-top:1px solid #c9cacb}@media (min-width: 1300px) and (max-width: 1759px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:5rem}}@media (min-width: 1760px){.mega-fly-out-overlay.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-container.sc-phn-mega-fly-out-overlay .mega-fly-out-overlay-content.sc-phn-mega-fly-out-overlay{padding-bottom:6rem}}";
...
const MegaFlyOutOverlay = class {
    ...
    render() {
        return (index.h(index.Host, { onKeyDown: this.handlePressEnterKey }, index.h("div", { class: "mega-fly-out-overlay" }, index.h("div", { tabindex: "0", onFocus: this.handleFocus, class: 'mega-fly-out-overlay-button mega-fly-out-overlay-button-' + this.active }, index.h("slot", { name: "button" })), index.h("div", { class: "mega-fly-out-overlay-container", ref: (el) => (this.containerElement = el) }, index.h("div", { class: "mega-fly-out-overlay-content" }, index.h("slot", { name: "content" }))), this.active && index.h("div", { class: "backdrop", ref: (el) => (this.backdropElement = el) }))));
    }
...
const MenuDesktopLevel1 = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "menu-desktop-level-1" }, index.h("div", { class: "menu-series-shop-and-more", onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave() }, index.h("phn-car-series-list", { carSeries: seriesList, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler, keyboardShowOverlayHandler: this.keyboardShowOverlayHandler, keyboardHideOverlayHandler: this.keyboardHideOverlayHandler }), index.h("phn-shops-and-more", { items: items, showOverlayHandler: this.showOverlayHandler, hideOverlayHandler: this.hideOverlayHandler })), index.h("div", { class: "menu-separator" }), index.h("phn-meta-functionalities", { class: "metafunctionalities" })));
    }
};
...
const MenuDrawerLevel1 = class {
    ...
    render() {
        const seriesList = !this.seriesList ? DEFAULT_SERIES_LIST : this.seriesList;
        const items = this.getItems();
        return (index.h("div", { class: "menu-drawer-level-1 drawer-level-1-item" }, index.h("div", { class: "drawer-level-1 drawer-level-1-item-scroll" }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-close" }, index.h("phn-close-button", { class: "close-button" })), index.h("div", { class: "drawer-content" }, index.h("phn-mobile-car-series-list", { ref: (el) => (this.mobileCarSeriesListElement = el), class: "mobile-car-series-list", carSeries: seriesList, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), index.h("phn-mobile-shops-and-more", { items: items, class: "mobile-shops-and-more", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }), index.h("phn-meta-functionalities", { class: "meta-functionalities", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return index.getElement(this); }
};
...
const metaFunctionalitiesCss = ".metafunctionalities.sc-phn-meta-functionalities{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-direction:column;flex-direction:column;font-size:1rem}@media (-ms-high-contrast: none) and (min-width: 1300px) and (max-width: 1759px){.metafunctionalities.sc-phn-meta-functionalities{float:right}}@media (min-width: 760px) and (max-width: 999px){.metafunctionalities.sc-phn-meta-functionalities{font-size:1.125rem}}@media (min-width: 1300px) and (max-width: 1759px){.metafunctionalities.sc-phn-meta-functionalities{-ms-flex-align:center;align-items:center;padding-top:0;height:4.0625rem;padding-left:1.25rem;-ms-flex-direction:row;flex-direction:row;font-size:1rem}}@media (min-width: 1760px){.metafunctionalities.sc-phn-meta-functionalities{-ms-flex-direction:row;flex-direction:row;font-size:1.25rem}}";
...
const MobileCarSeriesList = class {
    ...
    render() {
        return (index.h("div", { class: "mobile-car-series-list" }, this.carSeries.map((series, index$1) => (index.h("div", { class: "mobile-car-series" }, index.h("phn-car-series", { class: 'car-series car-series-' + index$1, text: series.Name, image: series.Image, onClick: () => this.showCarSubnavigation(index$1) }), index.h("phn-drawer-car-series-model-overview", { series: series, class: 'drawer-car-series-model-overview drawer-car-series-model-overview-' + index$1, closeActiveDrawer: this.closeActiveDrawer }))))));
    }
    get el() { return index.getElement(this); }
};
...
const MobileShopsAndMore = class {
    ...
    render() {
        return (index.h(index.Host, { class: "mobile-shops-and-more" }, this.items.map((item) => {
            let overlayRef;
            return (index.h("div", { class: "shops-and-more-container" }, index.h("phn-shops-and-more-item", { item: item, class: "shops-and-more-item", onClick: () => {
                    overlayRef.style.display = 'block';
                    this.setActiveDrawer(overlayRef, 2);
                } }), index.h("phn-drawer-shops-and-more", { headline: item.Items.length === 1 ? item.Text : '', item: item.Items.length === 1 ? item.Items[0] : item, class: "shops-and-more-overlay", setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer, ref: (el) => (overlayRef = el) })));
        })));
    }
};
MobileShopsAndMore.style = mobileShopsAndMoreCss;

const myporscheCss = ".sc-phn-myporsche-h p-link-pure.sc-phn-myporsche{border-bottom:1px solid #c9cacb;padding:0.875rem 0 0.875rem 0;width:100%}@media (min-width: 760px) and (max-width: 999px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche{padding:1.125rem 0 1.125rem 0}}@media (min-width: 1300px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche{border-bottom:0;padding:0}}.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche .login-status.sc-phn-myporsche{margin-top:-0.25rem;font-size:0.75rem}@media (min-width: 760px) and (max-width: 999px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche .login-status.sc-phn-myporsche{margin-top:-0.1875rem}}@media (min-width: 1300px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche .login-status.sc-phn-myporsche{margin-top:unset;position:absolute;top:0}}@media (min-width: 1300px) and (max-width: 1759px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche .login-status.sc-phn-myporsche{left:1.75rem;padding-top:1.1875rem}}@media (min-width: 1760px){.sc-phn-myporsche-h p-link-pure.sc-phn-myporsche .login-status.sc-phn-myporsche{left:2.1875rem;font-size:0.875rem;padding-top:1.6875rem}}.sc-phn-myporsche-h .myporsche-logged-in.sc-phn-myporsche{padding:0.875rem 0 0.875rem 0;border-bottom:1px solid #c9cacb}@media (min-width: 760px) and (max-width: 999px){.sc-phn-myporsche-h .myporsche-logged-in.sc-phn-myporsche{padding:1.125rem 0 1.125rem 0}}@media (min-width: 1300px){.sc-phn-myporsche-h .myporsche-logged-in.sc-phn-myporsche{display:none}}";
...
const Myporsche = class {
    ...
    renderLoggedOutComponent() {
        return (index.h("p-link-pure", { class: "myporsche-logged-out", href: this.myporscheLink, onClick: () => {
                ...
                this.sendMetaFunctionClickAnalyticsEvent(linkItem);
            }, size: "inherit", icon: "user" }, this.myporscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.subText)));
    }
    ...
    renderLoggedInComponent() {
        return [
            index.h("phn-myporsche-drawer", { class: "myporsche-logged-in", myPorscheText: this.myporscheText, loginStatus: this.subText, setActiveDrawer: this.setActiveDrawer, closeActiveDrawer: this.closeActiveDrawer }),
            index.h("phn-myporsche-flyout", { class: "myporsche-flyout", myPorscheText: this.myporscheText, loginStatus: this.subText })
        ];
    }
    render() {
        return (index.h(index.Host, null, this.loggedInState === LOGGED_OUT_USER_STATUS
...
const MyPorscheFlyout = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("p-link-pure", { class: "flyout-trigger", size: "inherit", icon: "user", active: this.isActive }, this.myPorscheText, index.h("p-text", { class: "login-status", color: "inherit", size: "inherit", ellipsis: "true", align: "left" }, this.loginStatus)), this.isActive ? (index.h("div", { class: "myporsche-items" }, index.h("phn-myporsche-items", null))) : null));
    }
};
...
const MyPorscheItemsDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { class: "drawer-level-2-item-scroll" }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-back-and-close" }, index.h("phn-back-button", { class: "back-button", buttonId: this.menu[0].PhraseId, text: this.menu[0].Text, onClick: () => this.hide() }), index.h("phn-close-button", { class: "close-button" })), index.h("phn-headline", { text: "My Porsche", class: "drawer-headline" }), index.h("phn-myporsche-items", null))));
    }
    get hostElement() { return index.getElement(this); }
};
...
const ShopsAndMoreItem = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("phn-button-extended", { class: "shops-and-more-item-drawer", icon: "arrow-head-right", onClick: () => this.sendNavigationClickAnalyticsEvent(this.item) }, this.item.Text), index.h("phn-button-extended", { class: "shops-and-more-item-mega-menu" }, this.item.Text)));
    }
};
