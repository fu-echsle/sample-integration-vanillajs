...
var LinkPure = /** @class */ (function () {
    ...
    LinkPure.prototype.render = function () {
        ...
        return (h(TagType, Object.assign({ class: linkPureClasses }, (TagType === 'a' ? {
            ...
            rel: this.rel
        } : null), { ref: function (el) { return _this.linkTag = el; } }), h("p-icon", { class: iconClasses, color: 'inherit', size: 'inherit', name: this.icon, source: this.iconSource, ref: function (el) { return _this.iconTag = el; }, "aria-hidden": 'true' }), h("p-text", { class: labelClasses, tag: 'span', color: 'inherit', size: 'inherit', weight: this.weight }, h("slot", null))));
    };
