...
const SelectWrapper = class {
    ...
    render() {
        ...
        const descriptionTextClasses = cx(prefix('select-wrapper__description-text'), mapBreakpointPropToPrefixedClasses('select-wrapper__description-text-', this.hideLabel, ['hidden', 'visible']), this.disabled && prefix('select-wrapper__description-text--disabled'));
        ...
        return (h(Host, null, h("label", { class: labelClasses }, this.isLabelVisible &&
            ...
            h("p-text", { class: descriptionTextClasses, tag: 'span', color: 'inherit', size: 'x-small', onClick: () => this.labelClick() }, this.description ? this.description : h("span", null, h("slot", { name: 'description' }))), h("span", { class: fakeSelectClasses }, h("p-icon", { class: iconClasses, name: 'arrow-head-down', color: 'inherit' }), h("slot", null))), this.isMessageVisible &&
