...
const Marque = class {
    ...
    render() {
        ...
        return (h("picture", { class: marqueClasses }, h("source", { media: '(min-width: 1300px)', srcSet: `
          ...
          ` }), h("img", { src: `${CDN_BASE_URL}/${this.trademark ? MARQUES_MANIFEST.porscheMarqueTrademark.medium['2x'] : MARQUES_MANIFEST.porscheMarque.medium['2x']}`, alt: 'Porsche' })));
    }
};
