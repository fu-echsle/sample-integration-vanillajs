...
const Headline = class {
    ...
    render() {
        const TagType = !this.tag ?
            ...
            : this.tag;
        const headlineClasses = index$1.cx(index$1.prefix('headline'), index$1.prefix(`headline--variant-${this.variant}`), index$1.prefix(`headline--align-${this.align}`), index$1.prefix(`headline--color-${this.color}`), this.ellipsis && index$1.prefix('headline--ellipsis'), this.color !== 'inherit' && index$1.prefix(`headline--theme-${this.theme}`));
        return (index.h(TagType, { class: headlineClasses }, index.h("slot", null)));
    }
