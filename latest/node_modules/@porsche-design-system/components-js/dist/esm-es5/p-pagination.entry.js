import { r as registerInstance, c as createEvent, h, g as getElement } from './index-381d535c.js';
import { d as throttle, m as mapBreakpointPropToPrefixedClasses, c as cx, p as prefix } from './index-0a27866a.js';
...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.render = function () {
        ...
        var paginationClasses = cx(breakpointClasses, prefix('pagination'), prefix("pagination--theme-" + this.theme));
        var paginationItemsClasses = cx(prefix('pagination__items'));
        ...
        var createPaginationItems = function () {
            ...
            var prevItem;
            var nextItem;
            var paginationItemClasses = cx(prefix('pagination__item'));
            paginationModel.forEach(function (pageModel) {
                if (pageModel.type === itemTypes.PREVIOUS_PAGE_LINK) {
                    var paginationPrevClasses = cx(prefix('pagination__prev'), !pageModel.isActive && prefix('pagination__prev--disabled'));
                    return (prevItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), h("span", { class: paginationPrevClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: function () {
                            _this.onClick(pageModel.value);
                        }, onKeyDown: function (e) {
                            _this.onKeyDown(e, pageModel.value);
                        }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": _this.allyLabelPrev }, h("p-icon", { name: 'arrow-head-left', color: 'inherit' })))));
                }
                if (pageModel.type === itemTypes.ELLIPSIS) {
                    var paginationGoToClasses = cx(prefix('pagination__goto'), prefix('pagination__goto--ellipsis'));
                ...
                if (pageModel.type === itemTypes.PAGE) {
                    var paginationGoToClasses = cx(prefix('pagination__goto'), pageModel.isActive && prefix('pagination__goto--current'));
                    pageItems.push(h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), h("span", { class: paginationGoToClasses, role: 'button', tabIndex: pageModel.isActive ? null : 0, "aria-disabled": pageModel.isActive && 'true', onClick: function () {
                            _this.onClick(pageModel.value);
                        }, onKeyDown: function (e) {
                            _this.onKeyDown(e, pageModel.value);
                ...
                if (pageModel.type === itemTypes.NEXT_PAGE_LINK) {
                    var paginationNextClasses = cx(prefix('pagination__next'), !pageModel.isActive && prefix('pagination__next--disabled'));
                    return (nextItem = (h("li", Object.assign({}, pageModel, { class: paginationItemClasses }), h("span", { class: paginationNextClasses, role: 'button', tabIndex: pageModel.isActive ? 0 : null, onClick: function () {
                            _this.onClick(pageModel.value);
                        }, onKeyDown: function (e) {
                            _this.onKeyDown(e, pageModel.value);
                        }, "aria-disabled": !pageModel.isActive && 'true', "aria-label": _this.allyLabelNext }, h("p-icon", { name: 'arrow-head-right', color: 'inherit' })))));
                }
            });
            return {
                prevItem: prevItem,
