...
Find the detailed [documentation](https://highway.porsche.com/confluence/display/HOMENAV/2.2.1+How-To+implement+me) in Highway Confluence. (Needs PPN Certificate). If you don't have Highway access, there is also a PDF documentation [here](header-v1.1.0-implementation-document.pdf)
